...
#define DIRECT_REG_WR(reg_addr, val) pete_writel("include/linux/qed/qed_if.h:441", (u32)val, \
					    (void __iomem *)(reg_addr))

#define DIRECT_REG_RD(reg_addr) pete_readl("include/linux/qed/qed_if.h:444", (void __iomem *)(reg_addr))

#define DIRECT_REG_WR64(reg_addr, val) pete_writeq("include/linux/qed/qed_if.h:446", (u64)val,	\
					      (void __iomem *)(reg_addr))
