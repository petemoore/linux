...
#define ufs_sys_ctrl_writel(host, val, reg)                                    \
	pete_writel("drivers/ufs/host/ufs-hisi.h:94", (val), (host)->ufs_sys_ctrl + (reg))
#define ufs_sys_ctrl_readl(host, reg) pete_readl("drivers/ufs/host/ufs-hisi.h:95", (host)->ufs_sys_ctrl + (reg))
