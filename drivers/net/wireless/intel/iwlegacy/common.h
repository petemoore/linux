...
{
	pete_writeb("drivers/net/wireless/intel/iwlegacy/common.h:1996", val, il->hw_base + ofs);
}
...
{
	pete_writel("drivers/net/wireless/intel/iwlegacy/common.h:2003", val, il->hw_base + ofs);
}

static inline u32
_il_rd(struct il_priv *il, u32 ofs)
{
	return pete_readl("drivers/net/wireless/intel/iwlegacy/common.h:2009", il->hw_base + ofs);
}
