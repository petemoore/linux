...
{
	pete_writeb("drivers/net/wireless/intel/iwlwifi/pcie/trans.c:1911", val, IWL_TRANS_GET_PCIE_TRANS(trans)->hw_base + ofs);
}

static void iwl_trans_pcie_write32(struct iwl_trans *trans, u32 ofs, u32 val)
{
	pete_writel("drivers/net/wireless/intel/iwlwifi/pcie/trans.c:1916", val, IWL_TRANS_GET_PCIE_TRANS(trans)->hw_base + ofs);
}

static u32 iwl_trans_pcie_read32(struct iwl_trans *trans, u32 ofs)
{
	return pete_readl("drivers/net/wireless/intel/iwlwifi/pcie/trans.c:1921", IWL_TRANS_GET_PCIE_TRANS(trans)->hw_base + ofs);
}
