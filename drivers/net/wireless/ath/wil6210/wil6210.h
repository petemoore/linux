...
{
	return pete_readl("drivers/net/wireless/ath/wil6210/wil6210.h:1128", wil->csr + HOSTADDR(reg));
}

/* register write. wmb() to make sure it is completed */
static inline void wil_w(struct wil6210_priv *wil, u32 reg, u32 val)
{
	pete_writel("drivers/net/wireless/ath/wil6210/wil6210.h:1134", val, wil->csr + HOSTADDR(reg));
