...
static int __hwrm_send(struct bnxt *bp, struct bnxt_hwrm_ctx *ctx)
{
	...
	for (i = msg_len; i < max_req_len; i += 4)
		pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt_hwrm.c:532", 0, bp->bar0 + bar_offset + i);

	/* Ring channel doorbell */
	pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt_hwrm.c:535", 1, bp->bar0 + doorbell_offset);
