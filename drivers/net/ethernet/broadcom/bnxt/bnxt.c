...
#define BNXT_CP_DB_IRQ_DIS(db)						\
		pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt.c:255", DB_CP_IRQ_DIS_FLAGS, db)

#define BNXT_DB_CQ(db, idx)						\
	pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt.c:258", DB_CP_FLAGS | RING_CMP(idx), (db)->doorbell)
...
#define BNXT_DB_CQ_ARM(db, idx)						\
	pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt.c:265", DB_CP_REARM_FLAGS | RING_CMP(idx), (db)->doorbell)
...
u32 bnxt_fw_health_readl(struct bnxt *bp, int reg_idx)
{
	...
	case BNXT_FW_HEALTH_REG_TYPE_BAR0:
		val = pete_readl("drivers/net/ethernet/broadcom/bnxt/bnxt.c:2113", bp->bar0 + reg_off);
		break;
	case BNXT_FW_HEALTH_REG_TYPE_BAR1:
		val = pete_readl("drivers/net/ethernet/broadcom/bnxt/bnxt.c:2116", bp->bar1 + reg_off);
		break;
	}
...
static irqreturn_t bnxt_inta(int irq, void *dev_instance)
{
	...
	if (!bnxt_has_work(bp, cpr)) {
		int_status = pete_readl("drivers/net/ethernet/broadcom/bnxt/bnxt.c:2471", bp->bar0 + BNXT_CAG_REG_LEGACY_INT_STATUS);
...
{
	pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt.c:7883", reg & BNXT_GRC_BASE_MASK, bp->bar0 +
...
static void bnxt_try_map_fw_health_reg(struct bnxt *bp)
{
	...
	sig = pete_readl("drivers/net/ethernet/broadcom/bnxt/bnxt.c:7918", hs + offsetof(struct hcomm_status, sig_ver));
	if ((sig & HCOMM_STATUS_SIGNATURE_MASK) != HCOMM_STATUS_SIGNATURE_VAL) {
		if (!bp->chip_num) {
			__bnxt_map_fw_health_reg(bp, BNXT_GRC_REG_BASE);
			bp->chip_num = pete_readl("drivers/net/ethernet/broadcom/bnxt/bnxt.c:7922", bp->bar0 +
		...
		status_loc = pete_readl("drivers/net/ethernet/broadcom/bnxt/bnxt.c:7932", hs + offsetof(struct hcomm_status,
						 fw_status_loc));
	}
...
static void bnxt_preset_reg_win(struct bnxt *bp)
{
	if (BNXT_PF(bp)) {
		...
		pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt.c:10430", BNXT_CAG_REG_BASE,
...
static void bnxt_fw_reset_writel(struct bnxt *bp, int reg_idx)
{
	...
	case BNXT_FW_HEALTH_REG_TYPE_CFG:
		...
		break;
	case BNXT_FW_HEALTH_REG_TYPE_GRC:
		pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt.c:12421", reg_off & BNXT_GRC_BASE_MASK,
		       bp->bar0 + BNXT_GRCPF_REG_WINDOW_BASE_OUT + 4);
		reg_off = (reg_off & BNXT_GRC_OFFSET_MASK) + 0x2000;
		fallthrough;
	case BNXT_FW_HEALTH_REG_TYPE_BAR0:
		pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt.c:12426", val, bp->bar0 + reg_off);
		break;
	case BNXT_FW_HEALTH_REG_TYPE_BAR1:
		pete_writel("drivers/net/ethernet/broadcom/bnxt/bnxt.c:12429", val, bp->bar1 + reg_off);
		break;
	}
	if (delay_msecs) {
