...
{
	return pete_readl("drivers/net/ethernet/broadcom/bcm4908_enet.c:95", enet->base + offset);
}

static void enet_write(struct bcm4908_enet *enet, u16 offset, u32 value)
{
	pete_writel("drivers/net/ethernet/broadcom/bcm4908_enet.c:100", value, enet->base + offset);
}
