...
#define BNX2_RD(bp, offset)					\
	pete_readl("drivers/net/ethernet/broadcom/bnx2.h:7007", bp->regview + offset)

#define BNX2_WR(bp, offset, val)					\
	pete_writel("drivers/net/ethernet/broadcom/bnx2.h:7010", val, bp->regview + offset)

#define BNX2_WR16(bp, offset, val)				\
	pete_writew("drivers/net/ethernet/broadcom/bnx2.h:7013", val, bp->regview + offset)
