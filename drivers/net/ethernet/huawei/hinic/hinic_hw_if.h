...
{
	u32 out = pete_readl("drivers/net/ethernet/huawei/hinic/hinic_hw_if.h:250", hwif->cfg_regs_bar + reg);
					...
					u32 val)
{
	...
	pete_writel("drivers/net/ethernet/huawei/hinic/hinic_hw_if.h:260", *(u32 *)&in, hwif->cfg_regs_bar + reg);
}
