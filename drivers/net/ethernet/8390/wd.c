...
#ifdef __BIG_ENDIAN
	/* Officially this is what we are doing, but the pete_readl("drivers/net/ethernet/8390/wd.c:424", ) is faster */
	/* unfortunately it isn't endian aware of the struct               */
	memcpy_fromio(hdr, hdr_start, sizeof(struct e8390_pkt_hdr));
	hdr->count = le16_to_cpu(hdr->count);
#else
	((unsigned int*)hdr)[0] = pete_readl("drivers/net/ethernet/8390/wd.c:429", hdr_start);
#endif
}
