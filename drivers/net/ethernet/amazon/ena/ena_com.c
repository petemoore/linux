				   ...
				   struct ena_aenq_handlers *aenq_handlers)
{
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:150", addr_low, ena_dev->reg_bar + ENA_REGS_AENQ_BASE_LO_OFF);
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:151", addr_high, ena_dev->reg_bar + ENA_REGS_AENQ_BASE_HI_OFF);
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:158", aenq_caps, ena_dev->reg_bar + ENA_REGS_AENQ_CAPS_OFF);
						       ...
						       size_t comp_size_in_bytes)
{
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:258", admin_queue->sq.tail, admin_queue->sq.db_addr);
...
static u32 ena_com_reg_bar_read32(struct ena_com_dev *ena_dev, u16 offset)
{
	...
	if (!mmio_read->readless_supported)
		return pete_readl("drivers/net/ethernet/amazon/ena/ena_com.c:813", ena_dev->reg_bar + offset);
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:824", mmio_read_reg, ena_dev->reg_bar + ENA_REGS_MMIO_REG_READ_OFF);
...
void ena_com_admin_aenq_enable(struct ena_com_dev *ena_dev)
{
	 ...
	 */
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1496", depth, ena_dev->reg_bar + ENA_REGS_AENQ_HEAD_DB_OFF);
}
...
void ena_com_set_admin_polling_mode(struct ena_com_dev *ena_dev, bool polling)
{
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1657", mask_value, ena_dev->reg_bar + ENA_REGS_INTR_MASK_OFF);
...
void ena_com_mmio_reg_read_request_destroy(struct ena_com_dev *ena_dev)
{
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1701", 0x0, ena_dev->reg_bar + ENA_REGS_MMIO_RESP_LO_OFF);
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1702", 0x0, ena_dev->reg_bar + ENA_REGS_MMIO_RESP_HI_OFF);
...
void ena_com_mmio_reg_read_request_write_dev_addr(struct ena_com_dev *ena_dev)
{
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1718", addr_low, ena_dev->reg_bar + ENA_REGS_MMIO_RESP_LO_OFF);
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1719", addr_high, ena_dev->reg_bar + ENA_REGS_MMIO_RESP_HI_OFF);
}
		       ...
		       struct ena_aenq_handlers *aenq_handlers)
{
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1769", addr_low, ena_dev->reg_bar + ENA_REGS_AQ_BASE_LO_OFF);
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1770", addr_high, ena_dev->reg_bar + ENA_REGS_AQ_BASE_HI_OFF);

	addr_low = ENA_DMA_ADDR_TO_UINT32_LOW(admin_queue->cq.dma_addr);
	addr_high = ENA_DMA_ADDR_TO_UINT32_HIGH(admin_queue->cq.dma_addr);

	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1775", addr_low, ena_dev->reg_bar + ENA_REGS_ACQ_BASE_LO_OFF);
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1776", addr_high, ena_dev->reg_bar + ENA_REGS_ACQ_BASE_HI_OFF);
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1790", aq_caps, ena_dev->reg_bar + ENA_REGS_AQ_CAPS_OFF);
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:1791", acq_caps, ena_dev->reg_bar + ENA_REGS_ACQ_CAPS_OFF);
		      ...
		      enum ena_regs_reset_reason_types reset_reason)
{
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:2084", reset_val, ena_dev->reg_bar + ENA_REGS_DEV_CTL_OFF);
	...
	/* reset done */
	pete_writel("drivers/net/ethernet/amazon/ena/ena_com.c:2097", 0, ena_dev->reg_bar + ENA_REGS_DEV_CTL_OFF);
