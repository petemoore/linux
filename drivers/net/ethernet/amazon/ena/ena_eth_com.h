...
{
	pete_writel("drivers/net/ethernet/amazon/ena/ena_eth_com.h:73", intr_reg->intr_control, io_cq->unmask_reg);
}
...
static inline int ena_com_write_sq_doorbell(struct ena_com_io_sq *io_sq)
{
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_eth_com.h:162", tail, io_sq->db_addr);
	...
	if (unlikely(io_cq->cq_head_db_reg)) {
		...
		if (unlikely(need_update)) {
			netdev_dbg(ena_com_io_cq_to_ena_dev(io_cq)->net_device,
				   ...
				   io_cq->qid, head);
			pete_writel("drivers/net/ethernet/amazon/ena/ena_eth_com.h:188", head, io_cq->cq_head_db_reg);
					    ...
					    u8 numa_node)
{
	...
	pete_writel("drivers/net/ethernet/amazon/ena/ena_eth_com.h:207", numa_cfg.numa_cfg, io_cq->numa_node_cfg_reg);
}
