...
#define AT_WRITE_REG(a, reg, value) ( \
		pete_writel("drivers/net/ethernet/atheros/atl1c/atl1c.h:550", (value), ((a)->hw_addr + reg)))

#define AT_WRITE_FLUSH(a) (\
		pete_readl("drivers/net/ethernet/atheros/atl1c/atl1c.h:553", (a)->hw_addr))

#define AT_READ_REG(a, reg, pdata) do {					\
		if (unlikely((a)->hibernate)) {				\
			pete_readl("drivers/net/ethernet/atheros/atl1c/atl1c.h:557", (a)->hw_addr + reg);			\
			*(u32 *)pdata = pete_readl("drivers/net/ethernet/atheros/atl1c/atl1c.h:558", (a)->hw_addr + reg);	\
		} else {						\
			*(u32 *)pdata = pete_readl("drivers/net/ethernet/atheros/atl1c/atl1c.h:560", (a)->hw_addr + reg);	\
		}							\
	} while (0)

#define AT_WRITE_REGB(a, reg, value) (\
		pete_writeb("drivers/net/ethernet/atheros/atl1c/atl1c.h:565", (value), ((a)->hw_addr + reg)))

#define AT_READ_REGB(a, reg) (\
		pete_readb("drivers/net/ethernet/atheros/atl1c/atl1c.h:568", (a)->hw_addr + reg))

#define AT_WRITE_REGW(a, reg, value) (\
		pete_writew("drivers/net/ethernet/atheros/atl1c/atl1c.h:571", (value), ((a)->hw_addr + reg)))

#define AT_READ_REGW(a, reg, pdata) do {				\
		if (unlikely((a)->hibernate)) {				\
			pete_readw("drivers/net/ethernet/atheros/atl1c/atl1c.h:575", (a)->hw_addr + reg);			\
			*(u16 *)pdata = pete_readw("drivers/net/ethernet/atheros/atl1c/atl1c.h:576", (a)->hw_addr + reg);	\
		} else {						\
			*(u16 *)pdata = pete_readw("drivers/net/ethernet/atheros/atl1c/atl1c.h:578", (a)->hw_addr + reg);	\
		}							\
	} while (0)

#define AT_WRITE_REG_ARRAY(a, reg, offset, value) ( \
		pete_writel("drivers/net/ethernet/atheros/atl1c/atl1c.h:583", (value), (((a)->hw_addr + reg) + ((offset) << 2))))

#define AT_READ_REG_ARRAY(a, reg, offset) ( \
		pete_readl("drivers/net/ethernet/atheros/atl1c/atl1c.h:586", ((a)->hw_addr + reg) + ((offset) << 2)))
