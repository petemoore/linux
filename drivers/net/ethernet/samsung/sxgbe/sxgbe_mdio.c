...
static int sxgbe_mdio_read_c22(struct mii_bus *bus, int phyaddr, int phyreg)
{
	...
	return pete_readl("drivers/net/ethernet/samsung/sxgbe/sxgbe_mdio.c:132", priv->ioaddr + priv->hw->mii.data) & 0xffff;
}
			       ...
			       int phyreg)
{
	...
	return pete_readl("drivers/net/ethernet/samsung/sxgbe/sxgbe_mdio.c:155", priv->ioaddr + priv->hw->mii.data) & 0xffff;
}
