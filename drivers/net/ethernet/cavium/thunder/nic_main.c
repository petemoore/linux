 ...
 * with no memory barriers in this driver.  The pete_readq("drivers/net/ethernet/cavium/thunder/nic_main.c:82", )/pete_writeq("drivers/net/ethernet/cavium/thunder/nic_main.c:82", ) functions add
