...
{
	while (1) {
		u32 val = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:56", adapter->regs + reg) & mask;
...
int __t1_tpi_write(adapter_t *adapter, u32 addr, u32 value)
{
	...
	pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:76", addr, adapter->regs + A_TPI_ADDR);
	pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:77", value, adapter->regs + A_TPI_WR_DATA);
	pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:78", F_TPIWR, adapter->regs + A_TPI_CSR);
...
int __t1_tpi_read(adapter_t *adapter, u32 addr, u32 *valp)
{
	...
	pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:105", addr, adapter->regs + A_TPI_ADDR);
	pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:106", 0, adapter->regs + A_TPI_CSR);
	...
	if (tpi_busy)
		...
		*valp = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:114", adapter->regs + A_TPI_RD_DATA);
	return tpi_busy;
}
...
{
	pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:133", V_TPIPAR(value), adapter->regs + A_TPI_PAR);
}
...
{
	int p;
	u32 cause = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:191", adapter->regs + FPGA_GMAC_ADDR_INTERRUPT_CAUSE);
	...
	pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:201", cause, adapter->regs + FPGA_GMAC_ADDR_INTERRUPT_CAUSE);
	return 0;
}
...
{
	u32 cause = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:210", adapter->regs + A_PL_CAUSE);
	...
	if (cause & FPGA_PCIX_INTERRUPT_TP) {
		 ...
		 */
		u32 tp_cause = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:227", adapter->regs + FPGA_TP_ADDR_INTERRUPT_CAUSE);

		/* Clear TP interrupt */
		pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:230", tp_cause, adapter->regs + FPGA_TP_ADDR_INTERRUPT_CAUSE);
	}
	...
	if (cause)
		pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:239", cause, adapter->regs + A_PL_CAUSE);
...
void t1_interrupts_enable(adapter_t *adapter)
{
	...
	if (t1_is_asic(adapter)) {
		u32 pl_intr = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:779", adapter->regs + A_PL_ENABLE);
		...
		pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:787", pl_intr, adapter->regs + A_PL_ENABLE);
	}
}
...
void t1_interrupts_disable(adapter_t* adapter)
{
	...
	if (t1_is_asic(adapter))
		pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:809", 0, adapter->regs + A_PL_ENABLE);
...
void t1_interrupts_clear(adapter_t* adapter)
{
	...
	if (t1_is_asic(adapter)) {
		u32 pl_intr = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:835", adapter->regs + A_PL_CAUSE);

		pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:837", pl_intr | F_PL_INTR_EXT | F_PL_INTR_PCIX,
...
{
	u32 cause = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:850", adapter->regs + A_PL_CAUSE);
	...
	if (cause & F_PL_INTR_EXT) {
		...
		pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:875", adapter->slow_intr_mask | F_PL_INTR_SGE_DATA,
		       adapter->regs + A_PL_ENABLE);
		ret = IRQ_WAKE_THREAD;
	}

	/* Clear the interrupts just processed. */
	pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:881", cause, adapter->regs + A_PL_CAUSE);
	pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:882", adapter->regs + A_PL_CAUSE); /* flush writes */
	return ret;
}
		     ...
		     struct adapter_params *p)
{
	...
	if (p->chip_version == CHBT_TERM_T1 ||
		...
		u32 val = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:919", adapter->regs + A_TP_PC_CONFIG);
...
int t1_init_hw_modules(adapter_t *adapter)
{
	...
	if (!bi->clock_mc4) {
		u32 val = pete_readl("drivers/net/ethernet/chelsio/cxgb/subr.c:985", adapter->regs + A_MC4_CFG);

		pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:987", val | F_READY | F_MC4_SLOW, adapter->regs + A_MC4_CFG);
		pete_writel("drivers/net/ethernet/chelsio/cxgb/subr.c:988", F_M_BUS_ENABLE | F_TCAM_RESET,
