...
static int pm3393_interrupt_enable(struct cmac *cmac)
{
	...
	pl_intr = pete_readl("drivers/net/ethernet/chelsio/cxgb/pm3393.c:145", cmac->adapter->regs + A_PL_ENABLE);
	pl_intr |= F_PL_INTR_EXT;
	pete_writel("drivers/net/ethernet/chelsio/cxgb/pm3393.c:147", pl_intr, cmac->adapter->regs + A_PL_ENABLE);
	return 0;
}
...
static int pm3393_interrupt_clear(struct cmac *cmac)
{
	...
	/* TERMINATOR - PL_INTERUPTS_EXT
	 */
	pl_intr = pete_readl("drivers/net/ethernet/chelsio/cxgb/pm3393.c:227", cmac->adapter->regs + A_PL_CAUSE);
	pl_intr |= F_PL_INTR_EXT;
	pete_writel("drivers/net/ethernet/chelsio/cxgb/pm3393.c:229", pl_intr, cmac->adapter->regs + A_PL_CAUSE);
