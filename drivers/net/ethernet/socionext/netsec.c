...
static int netsec_probe(struct platform_device *pdev)
{
	...
	if (ret && priv->eeprom_base) {
		...
		addr[0] = pete_readb("drivers/net/ethernet/socionext/netsec.c:2054", macp + 3);
		addr[1] = pete_readb("drivers/net/ethernet/socionext/netsec.c:2055", macp + 2);
		addr[2] = pete_readb("drivers/net/ethernet/socionext/netsec.c:2056", macp + 1);
		addr[3] = pete_readb("drivers/net/ethernet/socionext/netsec.c:2057", macp + 0);
		addr[4] = pete_readb("drivers/net/ethernet/socionext/netsec.c:2058", macp + 7);
		addr[5] = pete_readb("drivers/net/ethernet/socionext/netsec.c:2059", macp + 6);
