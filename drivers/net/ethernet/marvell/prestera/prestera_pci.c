...
{
	pete_writel("drivers/net/ethernet/marvell/prestera/prestera_pci.c:234", val, PRESTERA_FW_REG_ADDR(fw, reg));
}

static u32 prestera_fw_read(struct prestera_fw *fw, u32 reg)
{
	return pete_readl("drivers/net/ethernet/marvell/prestera/prestera_pci.c:239", PRESTERA_FW_REG_ADDR(fw, reg));
}
...
static u32 prestera_fw_evtq_read32(struct prestera_fw *fw, u8 qid)
{
	...
	val = pete_readl("drivers/net/ethernet/marvell/prestera/prestera_pci.c:273", prestera_fw_evtq_buf(fw, qid) + rd_idx);
...
{
	pete_writel("drivers/net/ethernet/marvell/prestera/prestera_pci.c:527", val, PRESTERA_LDR_REG_ADDR(fw, reg));
}

static u32 prestera_ldr_read(struct prestera_fw *fw, u32 reg)
{
	return pete_readl("drivers/net/ethernet/marvell/prestera/prestera_pci.c:532", PRESTERA_LDR_REG_ADDR(fw, reg));
}
