...
static inline void otx2_write64(struct otx2_nic *nic, u64 offset, u64 val)
{
	...
	pete_writeq("drivers/net/ethernet/marvell/octeontx2/nic/otx2_common.h:643", val, addr);
}
...
static inline u64 otx2_read64(struct otx2_nic *nic, u64 offset)
{
	...
	return pete_readq("drivers/net/ethernet/marvell/octeontx2/nic/otx2_common.h:650", addr);
}
...
#else
#define otx2_write128(lo, hi, addr)		pete_writeq("drivers/net/ethernet/marvell/octeontx2/nic/otx2_common.h:722", (hi) | (lo), addr)
