				...
				u64 offset, int lbkid, u16 chans)
{
	...
	cfg = pete_readq("drivers/net/ethernet/marvell/octeontx2/af/rvu_cn10k.c:359", base + offset);
	...
	pete_writeq("drivers/net/ethernet/marvell/octeontx2/af/rvu_cn10k.c:366", cfg, base + offset);
}
...
static void rvu_lbk_set_channels(struct rvu *rvu)
{
	...
	while (true) {
		...
		lbk_const = pete_readq("drivers/net/ethernet/marvell/octeontx2/af/rvu_cn10k.c:401", base + LBK_CONST);
