				      ...
				      const u8 *dev_addr)
{
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:146", mac_hi, slave->port_base + AM65_CPSW_PORTN_REG_SA_H);
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:147", mac_lo, slave->port_base + AM65_CPSW_PORTN_REG_SA_L);
}
...
static void am65_cpsw_sl_ctl_reset(struct am65_cpsw_port *port)
{
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:154", AM65_CPSW_MAX_PACKET_SIZE,
	       port->port_base + AM65_CPSW_PORT_REG_RX_MAXLEN);
}

static void am65_cpsw_nuss_get_ver(struct am65_cpsw_common *common)
{
	common->nuss_ver = pete_readl("drivers/net/ethernet/ti/am65-cpsw-nuss.c:160", common->ss_base);
	common->cpsw_ver = pete_readl("drivers/net/ethernet/ti/am65-cpsw-nuss.c:161", common->cpsw_base);
	dev_info(common->dev,
...
void am65_cpsw_nuss_set_p0_ptype(struct am65_cpsw_common *common)
{
	...
	val = pete_readl("drivers/net/ethernet/ti/am65-cpsw-nuss.c:347", host_p->port_base + AM65_CPSW_PORT_REG_PRI_CTL);
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:361", pri_map, host_p->port_base + AM65_CPSW_PORT_REG_RX_PRI_MAP);
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:362", val, host_p->port_base + AM65_CPSW_PORT_REG_PRI_CTL);
}
...
static int am65_cpsw_nuss_common_open(struct am65_cpsw_common *common)
{
	...
	/* Control register */
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:381", AM65_CPSW_CTL_P0_ENABLE | AM65_CPSW_CTL_P0_TX_CRC_REMOVE |
	       AM65_CPSW_CTL_VLAN_AWARE | AM65_CPSW_CTL_P0_RX_PAD,
	       common->cpsw_base + AM65_CPSW_REG_CTL);
	/* Max length register */
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:385", AM65_CPSW_MAX_PACKET_SIZE,
	       host_p->port_base + AM65_CPSW_PORT_REG_RX_MAXLEN);
	/* set base flow_id */
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:388", common->rx_flow_id_base,
	       host_p->port_base + AM65_CPSW_PORT0_REG_FLOW_ID_OFFSET);
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:390", AM65_CPSW_P0_REG_CTL_RX_CHECKSUM_EN | AM65_CPSW_P0_REG_CTL_RX_REMAP_VLAN,
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:403", val, common->cpsw_base + AM65_CPSW_REG_STAT_PORT_EN);

	/* disable priority elevation */
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:406", 0, common->cpsw_base + AM65_CPSW_REG_PTYPE);
...
static int am65_cpsw_nuss_common_stop(struct am65_cpsw_common *common)
{
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:529", 0, common->cpsw_base + AM65_CPSW_REG_CTL);
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:530", 0, common->cpsw_base + AM65_CPSW_REG_STAT_PORT_EN);
				       ...
				       struct ifreq *ifr)
{
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:1340", seq_id, port->port_base + AM65_CPSW_PORTN_REG_TS_SEQ_LTYPE_REG);
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:1341", ts_vlan_ltype, port->port_base +
	       AM65_CPSW_PORTN_REG_TS_VLAN_LTYPE_REG);
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:1343", ts_ctrl_ltype2, port->port_base +
	       AM65_CPSW_PORTN_REG_TS_CTL_LTYPE2);
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:1345", ts_ctrl, port->port_base + AM65_CPSW_PORTN_REG_TS_CTL);
				      ...
				      const struct phylink_link_state *state)
{
	...
	if (common->pdata.extra_modes & BIT(state->interface)) {
		if (state->interface == PHY_INTERFACE_MODE_SGMII) {
			pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:1511", ADVERTISE_SGMII,
		...
		pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:1526", AM65_CPSW_SGMII_CONTROL_MR_AN_ENABLE,
...
static void am65_cpsw_init_host_port_switch(struct am65_cpsw_common *common)
{
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:2427", common->default_vlan, host->port_base + AM65_CPSW_PORT_VLAN_REG_OFFSET);
...
static void am65_cpsw_init_host_port_emac(struct am65_cpsw_common *common)
{
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:2440", 0, host->port_base + AM65_CPSW_PORT_VLAN_REG_OFFSET);
...
static void am65_cpsw_init_port_emac_ale(struct  am65_cpsw_port *port)
{
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:2471", slave->port_vlan, port->port_base + AM65_CPSW_PORT_VLAN_REG_OFFSET);
...
static void am65_cpsw_init_port_switch_ale(struct am65_cpsw_port *port)
{
	...
	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:2507", slave->port_vlan, port->port_base + AM65_CPSW_PORT_VLAN_REG_OFFSET);
...
static int am65_cpsw_nuss_suspend(struct device *dev)
{
	...
	host_p->vid_context = pete_readl("drivers/net/ethernet/ti/am65-cpsw-nuss.c:3061", host_p->port_base + AM65_CPSW_PORT_VLAN_REG_OFFSET);
	for (i = 0; i < common->port_num; i++) {
		port = &common->ports[i];
		ndev = port->ndev;
		...
		port->vid_context = pete_readl("drivers/net/ethernet/ti/am65-cpsw-nuss.c:3069", port->port_base + AM65_CPSW_PORT_VLAN_REG_OFFSET);
...
static int am65_cpsw_nuss_resume(struct device *dev)
{
	...
	for (i = 0; i < common->port_num; i++) {
		...
		pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:3129", port->vid_context, port->port_base + AM65_CPSW_PORT_VLAN_REG_OFFSET);
	}

	pete_writel("drivers/net/ethernet/ti/am65-cpsw-nuss.c:3132", host_p->vid_context, host_p->port_base + AM65_CPSW_PORT_VLAN_REG_OFFSET);
