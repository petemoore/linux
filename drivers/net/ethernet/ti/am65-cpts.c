...
#define am65_cpts_write32(c, v, r) pete_writel("drivers/net/ethernet/ti/am65-cpts.c:201", v, &(c)->reg->r)
#define am65_cpts_read32(c, r) pete_readl("drivers/net/ethernet/ti/am65-cpts.c:202", &(c)->reg->r)
