...
static inline void cpsw_add_default_vlan(struct cpsw_priv *priv)
{
	...
	pete_writel("drivers/net/ethernet/ti/cpsw.c:662", vlan, &cpsw->host_port_regs->port_vlan);
...
static void cpsw_init_host_port(struct cpsw_priv *priv)
{
	...
	cpsw_ale_control_set(cpsw->ale, HOST_PORT_NUM, ALE_VLAN_AWARE,
			     CPSW_ALE_VLAN_AWARE);
	control_reg = pete_readl("drivers/net/ethernet/ti/cpsw.c:690", &cpsw->regs->control);
	control_reg |= CPSW_VLAN_AWARE | CPSW_RX_VLAN_ENCAP;
	pete_writel("drivers/net/ethernet/ti/cpsw.c:692", control_reg, &cpsw->regs->control);
	fifo_mode = (cpsw->data.dual_emac) ? CPSW_FIFO_DUAL_MAC_MODE :
		     CPSW_FIFO_NORMAL_MODE;
	pete_writel("drivers/net/ethernet/ti/cpsw.c:695", fifo_mode, &cpsw->host_port_regs->tx_in_ctl);
