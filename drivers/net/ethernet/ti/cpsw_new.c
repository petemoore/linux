...
static void cpsw_init_host_port_switch(struct cpsw_common *cpsw)
{
	...
	pete_writel("drivers/net/ethernet/ti/cpsw_new.c:517", CPSW_FIFO_NORMAL_MODE, &cpsw->host_port_regs->tx_in_ctl);

	pete_writel("drivers/net/ethernet/ti/cpsw_new.c:519", vlan, &cpsw->host_port_regs->port_vlan);
...
static void cpsw_init_host_port_dual_mac(struct cpsw_common *cpsw)
{
	...
	pete_writel("drivers/net/ethernet/ti/cpsw_new.c:536", CPSW_FIFO_DUAL_MAC_MODE, &cpsw->host_port_regs->tx_in_ctl);

	cpsw_ale_control_set(cpsw->ale, HOST_PORT_NUM, ALE_P0_UNI_FLOOD, 0);
	dev_dbg(cpsw->dev, "unset P0_UNI_FLOOD\n");

	pete_writel("drivers/net/ethernet/ti/cpsw_new.c:541", vlan, &cpsw->host_port_regs->port_vlan);
...
static void cpsw_init_host_port(struct cpsw_priv *priv)
{
	...
	cpsw_ale_control_set(cpsw->ale, HOST_PORT_NUM, ALE_VLAN_AWARE,
			     CPSW_ALE_VLAN_AWARE);
	control_reg = pete_readl("drivers/net/ethernet/ti/cpsw_new.c:560", &cpsw->regs->control);
	control_reg |= CPSW_VLAN_AWARE | CPSW_RX_VLAN_ENCAP;
	pete_writel("drivers/net/ethernet/ti/cpsw_new.c:562", control_reg, &cpsw->regs->control);
	...
	pete_writel("drivers/net/ethernet/ti/cpsw_new.c:576", 0x7, &cpsw->regs->flow_control);
	...
	if (!cpsw->usage_count) {
		...
		if (cpsw->cpts) {
			if (cpts_register(cpsw->cpts))
				...
				pete_writel("drivers/net/ethernet/ti/cpsw_new.c:875", 0x10, &cpsw->wr_regs->misc_en);
		}
