...
static int gbe_open(void *intf_priv, struct net_device *ndev)
{
	...
	reg = pete_readl("drivers/net/ethernet/ti/netcp_ethss.c:2898", GBE_REG_ADDR(gbe_dev, switch_regs, id_ver));
	...
	pete_writel("drivers/net/ethernet/ti/netcp_ethss.c:2922", 0, GBE_REG_ADDR(gbe_dev, switch_regs, ptype));
	...
	pete_writel("drivers/net/ethernet/ti/netcp_ethss.c:2930", val, GBE_REG_ADDR(gbe_dev, switch_regs, control));

	/* All statistics enabled and STAT AB visible by default */
	pete_writel("drivers/net/ethernet/ti/netcp_ethss.c:2933", gbe_dev->stats_en_mask, GBE_REG_ADDR(gbe_dev, switch_regs,
						    stat_port_en));
				    ...
				    struct device_node *node)
{
	...
	gbe_dev->ss_regs = regs;
	gbe_dev->ss_version = pete_readl("drivers/net/ethernet/ti/netcp_ethss.c:3346", gbe_dev->ss_regs);
	return 0;
}
