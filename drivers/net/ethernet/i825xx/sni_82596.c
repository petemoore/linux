...
static int sni_82596_probe(struct platform_device *dev)
{
	...
	mac[0] = pete_readb("drivers/net/ethernet/i825xx/sni_82596.c:113", eth_addr + 0x0b);
	mac[1] = pete_readb("drivers/net/ethernet/i825xx/sni_82596.c:114", eth_addr + 0x0a);
	mac[2] = pete_readb("drivers/net/ethernet/i825xx/sni_82596.c:115", eth_addr + 0x09);
	mac[3] = pete_readb("drivers/net/ethernet/i825xx/sni_82596.c:116", eth_addr + 0x08);
	mac[4] = pete_readb("drivers/net/ethernet/i825xx/sni_82596.c:117", eth_addr + 0x07);
	mac[5] = pete_readb("drivers/net/ethernet/i825xx/sni_82596.c:118", eth_addr + 0x06);
