			   ...
			   u32 sub_second_inc, u32 systime_flags)
{
	...
	val |= PPSEN0;
	pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:546", val, ioaddr + MAC_PPS_CONTROL);
	...
	pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:572", val, ioaddr + MAC_PPS_CONTROL);
	return 0;
}
...
static int dwmac5_est_write(void __iomem *ioaddr, u32 reg, u32 val, bool gcl)
{
	...
	pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:580", val, ioaddr + MTL_EST_GCL_DATA);

	ctrl = (reg << ADDR_SHIFT);
	ctrl |= gcl ? 0 : GCRR;

	pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:585", ctrl, ioaddr + MTL_EST_GCL_CONTROL);

	ctrl |= SRWO;
	pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:588", ctrl, ioaddr + MTL_EST_GCL_CONTROL);
			 ...
			 unsigned int ptp_rate)
{
	...
	ctrl = pete_readl("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:615", ioaddr + MTL_EST_CONTROL);
	ctrl &= ~PTOV;
	...
	pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:623", ctrl, ioaddr + MTL_EST_CONTROL);
	...
	pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:631", ctrl, ioaddr + MTL_EST_INT_EN);
			  ...
			  struct stmmac_extra_stats *x, u32 txqcnt)
{
	...
	status = pete_readl("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:642", ioaddr + MTL_EST_STATUS);
	...
	if (status & CGCE) {
		/* Clear Interrupt */
		pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:652", CGCE, ioaddr + MTL_EST_STATUS);

		x->mtl_est_cgce++;
	}

	if (status & HLBS) {
		value = pete_readl("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:658", ioaddr + MTL_EST_SCH_ERR);
		value &= txqcnt_mask;

		x->mtl_est_hlbs++;

		/* Clear Interrupt */
		pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:664", value, ioaddr + MTL_EST_SCH_ERR);
	...
	if (status & HLBF) {
		value = pete_readl("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:675", ioaddr + MTL_EST_FRM_SZ_ERR);
		feqn = value & txqcnt_mask;

		value = pete_readl("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:678", ioaddr + MTL_EST_FRM_SZ_CAP);
		...
		/* Clear Interrupt */
		pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:685", feqn, ioaddr + MTL_EST_FRM_SZ_ERR);
	...
	if (status & BTRE) {
		...
		pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:704", BTRE, ioaddr + MTL_EST_STATUS);
	}

	if (status & SWLC) {
		pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:708", SWLC, ioaddr + MTL_EST_STATUS);
			  ...
			  bool enable)
{
	...
	if (enable) {
		cfg->fpe_csr = EFPE;
		value = pete_readl("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:721", ioaddr + GMAC_RXQ_CTRL1);
		value &= ~GMAC_RXQCTRL_FPRQ;
		value |= (num_rxq - 1) << GMAC_RXQCTRL_FPRQ_SHIFT;
		pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:724", value, ioaddr + GMAC_RXQ_CTRL1);
	} else {
		cfg->fpe_csr = 0;
	}
	pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:728", cfg->fpe_csr, ioaddr + MAC_FPE_CTRL_STS);
}
...
int dwmac5_fpe_irq_status(void __iomem *ioaddr, struct net_device *dev)
{
	 ...
	 */
	value = pete_readl("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:741", ioaddr + MAC_FPE_CTRL_STS);
			     ...
			     enum stmmac_mpacket_type type)
{
	...
	pete_writel("drivers/net/ethernet/stmicro/stmmac/dwmac5.c:776", value, ioaddr + MAC_FPE_CTRL_STS);
}
