				 ...
				 u16 *phy_data)
{
	...
	if (hw->mac_type > e1000_82543) {
		...
		if (hw->mac_type == e1000_ce4100) {
			...
			pete_writel("drivers/net/ethernet/intel/e1000/e1000_hw.c:2831", mdic, E1000_MDIO_CMD);
			...
			for (i = 0; i < 64; i++) {
				udelay(50);
				mdic = pete_readl("drivers/net/ethernet/intel/e1000/e1000_hw.c:2838", E1000_MDIO_CMD);
			...
			mdic = pete_readl("drivers/net/ethernet/intel/e1000/e1000_hw.c:2848", E1000_MDIO_STS);
				  ...
				  u16 phy_data)
{
	...
	if (hw->mac_type > e1000_82543) {
		...
		if (hw->mac_type == e1000_ce4100) {
			...
			pete_writel("drivers/net/ethernet/intel/e1000/e1000_hw.c:2971", mdic, E1000_MDIO_CMD);
			...
			for (i = 0; i < 640; i++) {
				udelay(5);
				mdic = pete_readl("drivers/net/ethernet/intel/e1000/e1000_hw.c:2978", E1000_MDIO_CMD);
				if (!(mdic & INTEL_CE_GBE_MDIC_GO))
					break;
			}
			if (mdic & INTEL_CE_GBE_MDIC_GO) {
