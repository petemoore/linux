				...
				struct e1000_tx_ring *tx_ring)
{
	...
	pete_writel("drivers/net/ethernet/intel/e1000/e1000_main.c:2009", 0, hw->hw_addr + tx_ring->tdh);
	pete_writel("drivers/net/ethernet/intel/e1000/e1000_main.c:2010", 0, hw->hw_addr + tx_ring->tdt);
}
				...
				struct e1000_rx_ring *rx_ring)
{
	...
	pete_writel("drivers/net/ethernet/intel/e1000/e1000_main.c:2132", 0, hw->hw_addr + rx_ring->rdh);
	pete_writel("drivers/net/ethernet/intel/e1000/e1000_main.c:2133", 0, hw->hw_addr + rx_ring->rdt);
}
				    ...
				    struct net_device *netdev)
{
	...
	if (count) {
		...
		if (!netdev_xmit_more() ||
			...
			pete_writel("drivers/net/ethernet/intel/e1000/e1000_main.c:3274", tx_ring->next_to_use, hw->hw_addr + tx_ring->tdt);
		}
	} else {
		dev_kfree_skb_any(skb);
...
rx_ring_summary:
	...
	for (i = 0x6000; i <= 0x63FF ; i += 0x10) {
		pr_info("R%04X: %08X|%08X %08X|%08X\n",
			i,
			pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3471", adapter->hw.hw_addr + i+4),
			pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3472", adapter->hw.hw_addr + i),
			pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3473", adapter->hw.hw_addr + i+12),
			pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3474", adapter->hw.hw_addr + i+8));
	}
	/* tx */
	...
	for (i = 0x7000; i <= 0x73FF ; i += 0x10) {
		pr_info("T%04X: %08X|%08X %08X|%08X\n",
			i,
			pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3481", adapter->hw.hw_addr + i+4),
			pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3482", adapter->hw.hw_addr + i),
			pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3483", adapter->hw.hw_addr + i+12),
			pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3484", adapter->hw.hw_addr + i+8));
	}
exit:
	return;
}
	...
	if (adapter->detect_tx_hung) {
		...
		if (tx_ring->buffer_info[eop].time_stamp &&
			...
			e_err(drv, "Detected Tx Unit Hang\n"
				...
				pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3917", hw->hw_addr + tx_ring->tdh),
				pete_readl("drivers/net/ethernet/intel/e1000/e1000_main.c:3918", hw->hw_addr + tx_ring->tdt),
				tx_ring->next_to_use,
			     ...
			     struct e1000_rx_ring *rx_ring, int cleaned_count)
{
	...
	if (likely(rx_ring->next_to_use != i)) {
		 ...
		 */
		dma_wmb();
		pete_writel("drivers/net/ethernet/intel/e1000/e1000_main.c:4550", i, adapter->hw.hw_addr + rx_ring->rdt);
	}
}
				   ...
				   int cleaned_count)
{
 ...
 skip:
	...
	if (likely(rx_ring->next_to_use != i)) {
		 ...
		 */
		dma_wmb();
		pete_writel("drivers/net/ethernet/intel/e1000/e1000_main.c:4667", i, hw->hw_addr + rx_ring->rdt);
	}
}
