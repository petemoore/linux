...
{
	return pete_readl("drivers/net/ethernet/intel/e1000e/e1000.h:601", hw->hw_addr + reg);
}
...
#define E1000_READ_REG_ARRAY(a, reg, offset) \
	(pete_readl("drivers/net/ethernet/intel/e1000e/e1000.h:616", (a)->hw_addr + reg + ((offset) << 2)))
