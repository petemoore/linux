...
u32 igb_rd32(struct e1000_hw *hw, u32 reg)
{
	...
	value = pete_readl("drivers/net/ethernet/intel/igb/igb_main.c:743", &hw_addr[reg]);

	/* reads should not return all F's */
	if (!(~value) && (!reg || !(~pete_readl("drivers/net/ethernet/intel/igb/igb_main.c:746", hw_addr)))) {
...
static void igb_xdp_ring_update_tail(struct igb_ring *ring)
{
	 ...
	 */
	wmb();
	pete_writel("drivers/net/ethernet/intel/igb/igb_main.c:2956", ring->next_to_use, ring->tail);
}
			   ...
			   struct igb_ring *ring)
{
	...
	pete_writel("drivers/net/ethernet/intel/igb/igb_main.c:4400", 0, ring->tail);
			   ...
			   struct igb_ring *ring)
{
	...
	pete_writel("drivers/net/ethernet/intel/igb/igb_main.c:4801", 0, ring->tail);
		      ...
		      const u8 hdr_len)
{
	...
	if (netif_xmit_stopped(txring_txq(tx_ring)) || !netdev_xmit_more()) {
		pete_writel("drivers/net/ethernet/intel/igb/igb_main.c:6324", i, tx_ring->tail);
	}
	return 0;
		      ...
		      struct xdp_frame *xdpf)
{
	...
	if (netif_xmit_stopped(txring_txq(tx_ring)) || !netdev_xmit_more())
		pete_writel("drivers/net/ethernet/intel/igb/igb_main.c:6445", index, tx_ring->tail);
...
static void igb_write_itr(struct igb_q_vector *q_vector)
{
	...
	pete_writel("drivers/net/ethernet/intel/igb/igb_main.c:7089", itr_val, q_vector->itr_register);
	q_vector->set_itr = 0;
}
	...
	if (test_bit(IGB_RING_FLAG_TX_DETECT_HANG, &tx_ring->flags)) {
		...
		if (tx_buffer->next_to_watch &&
			...
			dev_err(tx_ring->dev,
				...
				pete_readl("drivers/net/ethernet/intel/igb/igb_main.c:8390", tx_ring->tail),
				tx_ring->next_to_use,
...
void igb_alloc_rx_buffers(struct igb_ring *rx_ring, u16 cleaned_count)
{
	...
	if (rx_ring->next_to_use != i) {
		 ...
		 */
		dma_wmb();
		pete_writel("drivers/net/ethernet/intel/igb/igb_main.c:9162", i, rx_ring->tail);
	}
}
