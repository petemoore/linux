...
#define RTL_W8(tp, reg, val8)	pete_writeb("drivers/net/ethernet/realtek/r8169_main.c:79", (val8), tp->mmio_addr + (reg))
#define RTL_W16(tp, reg, val16)	pete_writew("drivers/net/ethernet/realtek/r8169_main.c:80", (val16), tp->mmio_addr + (reg))
#define RTL_W32(tp, reg, val32)	pete_writel("drivers/net/ethernet/realtek/r8169_main.c:81", (val32), tp->mmio_addr + (reg))
#define RTL_R8(tp, reg)		pete_readb("drivers/net/ethernet/realtek/r8169_main.c:82", tp->mmio_addr + (reg))
#define RTL_R16(tp, reg)		pete_readw("drivers/net/ethernet/realtek/r8169_main.c:83", tp->mmio_addr + (reg))
