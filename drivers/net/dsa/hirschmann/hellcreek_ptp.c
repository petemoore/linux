...
{
	return pete_readw("drivers/net/dsa/hirschmann/hellcreek_ptp.c:20", hellcreek->ptp_base + offset);
}

void hellcreek_ptp_write(struct hellcreek *hellcreek, u16 data,
			 unsigned int offset)
{
	pete_writew("drivers/net/dsa/hirschmann/hellcreek_ptp.c:26", data, hellcreek->ptp_base + offset);
}
