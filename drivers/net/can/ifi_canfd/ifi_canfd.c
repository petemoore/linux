...
static void ifi_canfd_read_fifo(struct net_device *ndev)
{
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:318", IFI_CANFD_RXSTCMD_REMOVE_MSG, priv->base + IFI_CANFD_RXSTCMD);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:319", rx_irq_mask, priv->base + IFI_CANFD_INTERRUPT);
...
static int ifi_canfd_handle_lec_err(struct net_device *ndev)
{
	...
	struct can_frame *cf;
	struct sk_buff *skb;
	u32 errctr = pete_readl("drivers/net/can/ifi_canfd/ifi_canfd.c:380", priv->base + IFI_CANFD_ERROR_CTR);
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:444", IFI_CANFD_ERROR_CTR_ER_RESET, priv->base + IFI_CANFD_ERROR_CTR);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:445", IFI_CANFD_INTERRUPT_ERROR_COUNTER,
	       priv->base + IFI_CANFD_INTERRUPT);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:447", IFI_CANFD_ERROR_CTR_ER_ENABLE, priv->base + IFI_CANFD_ERROR_CTR);
				      ...
				      struct can_berr_counter *bec)
{
	...
	err = pete_readl("drivers/net/can/ifi_canfd/ifi_canfd.c:463", priv->base + IFI_CANFD_ERROR);
...
{
	struct ifi_canfd_priv *priv = netdev_priv(ndev);
	u32 stcmd = pete_readl("drivers/net/can/ifi_canfd/ifi_canfd.c:549", priv->base + IFI_CANFD_STCMD);
	int work_done = 0;
...
static int ifi_canfd_poll(struct napi_struct *napi, int quota)
{
	...
	struct ifi_canfd_priv *priv = netdev_priv(ndev);
	u32 rxstcmd = pete_readl("drivers/net/can/ifi_canfd/ifi_canfd.c:587", priv->base + IFI_CANFD_RXSTCMD);
	int work_done = 0;
...
static irqreturn_t ifi_canfd_isr(int irq, void *dev_id)
{
	...
	isr = pete_readl("drivers/net/can/ifi_canfd/ifi_canfd.c:629", priv->base + IFI_CANFD_INTERRUPT);
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:636", clr_irq_mask, priv->base + IFI_CANFD_INTERRUPT);
...
static void ifi_canfd_set_bittiming(struct net_device *ndev)
{
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:680", (tseg2 << IFI_CANFD_TIME_TIMEB_OFF) |
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:691", (tseg2 << IFI_CANFD_TIME_TIMEB_OFF) |
	       (tseg1 << IFI_CANFD_TIME_TIMEA_OFF) |
	       (brp << IFI_CANFD_TIME_PRESCALE_OFF) |
	       (sjw << IFI_CANFD_TIME_SJW_OFF_7_9_8_8),
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:700", IFI_CANFD_TDELAY_EN | tdc, priv->base + IFI_CANFD_TDELAY);
}
				 ...
				 const u32 mask, const u32 ident)
{
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:708", mask, priv->base + IFI_CANFD_FILTER_MASK(id));
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:709", ident, priv->base + IFI_CANFD_FILTER_IDENT(id));
}
...
static void ifi_canfd_start(struct net_device *ndev)
{
	...
	/* Reset the IP */
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:743", IFI_CANFD_STCMD_HARDRESET, priv->base + IFI_CANFD_STCMD);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:744", IFI_CANFD_STCMD_ENABLE_7_9_8_8_TIMING,
	...
	/* Reset FIFOs */
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:751", IFI_CANFD_RXSTCMD_RESET, priv->base + IFI_CANFD_RXSTCMD);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:752", 0, priv->base + IFI_CANFD_RXSTCMD);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:753", IFI_CANFD_TXSTCMD_RESET, priv->base + IFI_CANFD_TXSTCMD);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:754", 0, priv->base + IFI_CANFD_TXSTCMD);

	/* Repeat transmission until successful */
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:757", 0, priv->base + IFI_CANFD_REPEAT);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:758", 0, priv->base + IFI_CANFD_SUSPEND);

	/* Clear all pending interrupts */
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:761", (u32)(~IFI_CANFD_INTERRUPT_SET_IRQ),
	       priv->base + IFI_CANFD_INTERRUPT);
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:785", IFI_CANFD_ERROR_CTR_UNLOCK_MAGIC,
	       priv->base + IFI_CANFD_ERROR_CTR);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:787", IFI_CANFD_ERROR_CTR_ER_RESET, priv->base + IFI_CANFD_ERROR_CTR);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:788", IFI_CANFD_ERROR_CTR_ER_ENABLE, priv->base + IFI_CANFD_ERROR_CTR);

	/* Enable controller */
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:791", stcmd, priv->base + IFI_CANFD_STCMD);
}
...
static void ifi_canfd_stop(struct net_device *ndev)
{
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:799", IFI_CANFD_ERROR_CTR_ER_RESET, priv->base + IFI_CANFD_ERROR_CTR);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:800", 0, priv->base + IFI_CANFD_ERROR_CTR);

	/* Reset the IP */
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:803", IFI_CANFD_STCMD_HARDRESET, priv->base + IFI_CANFD_STCMD);

	/* Mask all interrupts */
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:806", ~0, priv->base + IFI_CANFD_IRQMASK);

	/* Clear all pending interrupts */
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:809", (u32)(~IFI_CANFD_INTERRUPT_SET_IRQ),
	       priv->base + IFI_CANFD_INTERRUPT);
					...
					struct net_device *ndev)
{
	...
	txst = pete_readl("drivers/net/can/ifi_canfd/ifi_canfd.c:888", priv->base + IFI_CANFD_TXSTCMD);
	...
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:924", txid, priv->base + IFI_CANFD_TXFIFO_ID);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:925", txdlc, priv->base + IFI_CANFD_TXFIFO_DLC);

	for (i = 0; i < cf->len; i += 4) {
		pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:928", *(u32 *)(cf->data + i),
		       priv->base + IFI_CANFD_TXFIFO_DATA + i);
	}

	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:932", 0, priv->base + IFI_CANFD_TXFIFO_REPEATCOUNT);
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:933", 0, priv->base + IFI_CANFD_TXFIFO_SUSPEND_US);

	can_put_echo_skb(skb, ndev, 0, 0);

	/* Start the transmission */
	pete_writel("drivers/net/can/ifi_canfd/ifi_canfd.c:938", IFI_CANFD_TXSTCMD_ADD_MSG, priv->base + IFI_CANFD_TXSTCMD);
...
static int ifi_canfd_plat_probe(struct platform_device *pdev)
{
	...
	id = pete_readl("drivers/net/can/ifi_canfd/ifi_canfd.c:971", addr + IFI_CANFD_IP_ID);
	if (id != IFI_CANFD_IP_ID_VALUE) {
		dev_err(dev, "This block is not IFI CANFD, id=%08x\n", id);
		return -EINVAL;
	}

	rev = pete_readl("drivers/net/can/ifi_canfd/ifi_canfd.c:977", addr + IFI_CANFD_VER) & IFI_CANFD_VER_REV_MASK;
	...
	priv->can.clock.freq = pete_readl("drivers/net/can/ifi_canfd/ifi_canfd.c:1001", addr + IFI_CANFD_CANCLOCK);
