...
static int fsi_master_aspeed_probe(struct platform_device *pdev)
{
	...
	pete_writel("drivers/fsi/fsi-master-aspeed.c:578", 0x1, aspeed->base + OPB_CLK_SYNC);
	pete_writel("drivers/fsi/fsi-master-aspeed.c:579", OPB1_XFER_ACK_EN | OPB0_XFER_ACK_EN,
			aspeed->base + OPB_IRQ_MASK);

	/* TODO: determine an appropriate value */
	pete_writel("drivers/fsi/fsi-master-aspeed.c:583", 0x10, aspeed->base + OPB_RETRY_COUNTER);

	pete_writel("drivers/fsi/fsi-master-aspeed.c:585", ctrl_base, aspeed->base + OPB_CTRL_BASE);
	pete_writel("drivers/fsi/fsi-master-aspeed.c:586", fsi_base, aspeed->base + OPB_FSI_BASE);

	/* Set read data order */
	pete_writel("drivers/fsi/fsi-master-aspeed.c:589", 0x00030b1b, aspeed->base + OPB0_READ_ORDER1);

	/* Set write data order */
	pete_writel("drivers/fsi/fsi-master-aspeed.c:592", 0x0011101b, aspeed->base + OPB0_WRITE_ORDER1);
	pete_writel("drivers/fsi/fsi-master-aspeed.c:593", 0x0c330f3f, aspeed->base + OPB0_WRITE_ORDER2);
	 ...
	 * OPB1.
	 */
	pete_writel("drivers/fsi/fsi-master-aspeed.c:600", 0x1, aspeed->base + OPB0_SELECT);
