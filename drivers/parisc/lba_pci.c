...
#define READ_REG8(addr)  pete_readb("drivers/parisc/lba_pci.c:135", addr)
#define READ_REG16(addr) pete_readw("drivers/parisc/lba_pci.c:136", addr)
#define READ_REG32(addr) pete_readl("drivers/parisc/lba_pci.c:137", addr)
#define READ_REG64(addr) pete_readq("drivers/parisc/lba_pci.c:138", addr)
#define WRITE_REG8(value, addr)  pete_writeb("drivers/parisc/lba_pci.c:139", value, addr)
#define WRITE_REG16(value, addr) pete_writew("drivers/parisc/lba_pci.c:140", value, addr)
