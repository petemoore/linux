...
static void tegra_ahci_handle_quirks(struct ahci_host_priv *hpriv)
{
	...
	if (tegra->sata_aux_regs && !tegra->soc->supports_devslp) {
		val = pete_readl("drivers/ata/ahci_tegra.c:188", tegra->sata_aux_regs + SATA_AUX_MISC_CNTL_1_0);
		val &= ~SATA_AUX_MISC_CNTL_1_0_SDS_SUPPORT;
		pete_writel("drivers/ata/ahci_tegra.c:190", val, tegra->sata_aux_regs + SATA_AUX_MISC_CNTL_1_0);
	}
}
...
static int tegra124_ahci_init(struct ahci_host_priv *hpriv)
{
	...
	pete_writel("drivers/ata/ahci_tegra.c:208", BIT(0), tegra->sata_regs + SCFG_OFFSET + T_SATA0_INDEX);

	val = pete_readl("drivers/ata/ahci_tegra.c:210", tegra->sata_regs +
		    SCFG_OFFSET + T_SATA0_CHX_PHY_CTRL1_GEN1);
	val &= ~T_SATA0_CHX_PHY_CTRL1_GEN1_TX_AMP_MASK;
	val &= ~T_SATA0_CHX_PHY_CTRL1_GEN1_TX_PEAK_MASK;
	val |= calib.gen1_tx_amp << T_SATA0_CHX_PHY_CTRL1_GEN1_TX_AMP_SHIFT;
	val |= calib.gen1_tx_peak << T_SATA0_CHX_PHY_CTRL1_GEN1_TX_PEAK_SHIFT;
	pete_writel("drivers/ata/ahci_tegra.c:216", val, tegra->sata_regs + SCFG_OFFSET +
	       T_SATA0_CHX_PHY_CTRL1_GEN1);

	val = pete_readl("drivers/ata/ahci_tegra.c:219", tegra->sata_regs +
	...
	pete_writel("drivers/ata/ahci_tegra.c:225", val, tegra->sata_regs + SCFG_OFFSET +
	       T_SATA0_CHX_PHY_CTRL1_GEN2);

	pete_writel("drivers/ata/ahci_tegra.c:228", T_SATA0_CHX_PHY_CTRL11_GEN2_RX_EQ,
	       tegra->sata_regs + SCFG_OFFSET + T_SATA0_CHX_PHY_CTRL11);
	pete_writel("drivers/ata/ahci_tegra.c:230", T_SATA0_CHX_PHY_CTRL2_CDR_CNTL_GEN1,
	       tegra->sata_regs + SCFG_OFFSET + T_SATA0_CHX_PHY_CTRL2);

	pete_writel("drivers/ata/ahci_tegra.c:233", 0, tegra->sata_regs + SCFG_OFFSET + T_SATA0_INDEX);
...
static int tegra_ahci_controller_init(struct ahci_host_priv *hpriv)
{
	 ...
	 */
	val = pete_readl("drivers/ata/ahci_tegra.c:314", tegra->sata_regs + SATA_FPCI_BAR5);
	val &= ~(SATA_FPCI_BAR5_START_MASK | SATA_FPCI_BAR5_ACCESS_TYPE);
	val |= SATA_FPCI_BAR5_START | SATA_FPCI_BAR5_ACCESS_TYPE;
	pete_writel("drivers/ata/ahci_tegra.c:317", val, tegra->sata_regs + SATA_FPCI_BAR5);

	/* Program the following SATA IPFS register to enable the SATA */
	val = pete_readl("drivers/ata/ahci_tegra.c:320", tegra->sata_regs + SATA_CONFIGURATION_0);
	val |= SATA_CONFIGURATION_0_EN_FPCI;
	pete_writel("drivers/ata/ahci_tegra.c:322", val, tegra->sata_regs + SATA_CONFIGURATION_0);

	/* Electrical settings for better link stability */
	val = T_SATA0_CHX_PHY_CTRL17_0_RX_EQ_CTRL_L_GEN1;
	pete_writel("drivers/ata/ahci_tegra.c:326", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CHX_PHY_CTRL17_0);
	val = T_SATA0_CHX_PHY_CTRL18_0_RX_EQ_CTRL_L_GEN2;
	pete_writel("drivers/ata/ahci_tegra.c:328", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CHX_PHY_CTRL18_0);
	val = T_SATA0_CHX_PHY_CTRL20_0_RX_EQ_CTRL_H_GEN1;
	pete_writel("drivers/ata/ahci_tegra.c:330", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CHX_PHY_CTRL20_0);
	val = T_SATA0_CHX_PHY_CTRL21_0_RX_EQ_CTRL_H_GEN2;
	pete_writel("drivers/ata/ahci_tegra.c:332", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CHX_PHY_CTRL21_0);

	/* For SQUELCH Filter & Gen3 drive getting detected as Gen1 drive */

	val = pete_readl("drivers/ata/ahci_tegra.c:336", tegra->sata_regs + SCFG_OFFSET + T_SATA_CFG_PHY_0);
	val |= T_SATA_CFG_PHY_0_MASK_SQUELCH;
	val &= ~T_SATA_CFG_PHY_0_USE_7BIT_ALIGN_DET_FOR_SPD;
	pete_writel("drivers/ata/ahci_tegra.c:339", val, tegra->sata_regs + SCFG_OFFSET + T_SATA_CFG_PHY_0);

	val = pete_readl("drivers/ata/ahci_tegra.c:341", tegra->sata_regs + SCFG_OFFSET + T_SATA0_NVOOB);
	...
	pete_writel("drivers/ata/ahci_tegra.c:348", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_NVOOB);

	/*
	 * Change CFG2NVOOB_2_COMWAKE_IDLE_CNT_LOW from 83.3 ns to 58.8ns
	 */
	val = pete_readl("drivers/ata/ahci_tegra.c:353", tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG2NVOOB_2);
	val &= ~T_SATA0_CFG2NVOOB_2_COMWAKE_IDLE_CNT_LOW_MASK;
	val |= T_SATA0_CFG2NVOOB_2_COMWAKE_IDLE_CNT_LOW;
	pete_writel("drivers/ata/ahci_tegra.c:356", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG2NVOOB_2);
	 ...
	 * initialize SATA
	 */
	val = pete_readl("drivers/ata/ahci_tegra.c:365", tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_1);
	val |= (T_SATA0_CFG_1_IO_SPACE | T_SATA0_CFG_1_MEMORY_SPACE |
		T_SATA0_CFG_1_BUS_MASTER | T_SATA0_CFG_1_SERR);
	pete_writel("drivers/ata/ahci_tegra.c:368", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_1);
	val = T_SATA0_CFG_9_BASE_ADDRESS;
	pete_writel("drivers/ata/ahci_tegra.c:370", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_9);

	/* Program Class Code and Programming interface for SATA */
	val = pete_readl("drivers/ata/ahci_tegra.c:373", tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_SATA);
	val |= T_SATA0_CFG_SATA_BACKDOOR_PROG_IF_EN;
	pete_writel("drivers/ata/ahci_tegra.c:375", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_SATA);

	val = pete_readl("drivers/ata/ahci_tegra.c:377", tegra->sata_regs + SCFG_OFFSET + T_SATA0_BKDOOR_CC);
	val &=
	...
	pete_writel("drivers/ata/ahci_tegra.c:382", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_BKDOOR_CC);

	val = pete_readl("drivers/ata/ahci_tegra.c:384", tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_SATA);
	val &= ~T_SATA0_CFG_SATA_BACKDOOR_PROG_IF_EN;
	pete_writel("drivers/ata/ahci_tegra.c:386", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_SATA);

	/* Enabling LPM capabilities through Backdoor Programming */
	val = pete_readl("drivers/ata/ahci_tegra.c:389", tegra->sata_regs + SCFG_OFFSET + T_SATA0_AHCI_HBA_CAP_BKDR);
	val |= (T_SATA0_AHCI_HBA_CAP_BKDR_PARTIAL_ST_CAP |
		T_SATA0_AHCI_HBA_CAP_BKDR_SLUMBER_ST_CAP |
		T_SATA0_AHCI_HBA_CAP_BKDR_SALP |
		T_SATA0_AHCI_HBA_CAP_BKDR_SUPP_PM);
	pete_writel("drivers/ata/ahci_tegra.c:394", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_AHCI_HBA_CAP_BKDR);

	/* SATA Second Level Clock Gating configuration
	 * Enabling Gating of Tx/Rx clocks and driving Pad IDDQ and Lane
	 * IDDQ Signals
	 */
	val = pete_readl("drivers/ata/ahci_tegra.c:400", tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_35);
	val &= ~T_SATA0_CFG_35_IDP_INDEX_MASK;
	val |= T_SATA0_CFG_35_IDP_INDEX;
	pete_writel("drivers/ata/ahci_tegra.c:403", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_35);

	val = T_SATA0_AHCI_IDP1_DATA;
	pete_writel("drivers/ata/ahci_tegra.c:406", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_AHCI_IDP1);

	val = pete_readl("drivers/ata/ahci_tegra.c:408", tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_PHY_1);
	val |= (T_SATA0_CFG_PHY_1_PADS_IDDQ_EN |
		T_SATA0_CFG_PHY_1_PAD_PLL_IDDQ_EN);
	pete_writel("drivers/ata/ahci_tegra.c:411", val, tegra->sata_regs + SCFG_OFFSET + T_SATA0_CFG_PHY_1);

	/* Enabling IPFS Clock Gating */
	val = pete_readl("drivers/ata/ahci_tegra.c:414", tegra->sata_regs + SATA_CONFIGURATION_0);
	val &= ~SATA_CONFIGURATION_0_CLK_OVERRIDE;
	pete_writel("drivers/ata/ahci_tegra.c:416", val, tegra->sata_regs + SATA_CONFIGURATION_0);

	tegra_ahci_handle_quirks(hpriv);

	/* Unmask SATA interrupts */

	val = pete_readl("drivers/ata/ahci_tegra.c:422", tegra->sata_regs + SATA_INTR_MASK);
	val |= SATA_INTR_MASK_IP_INT_MASK;
	pete_writel("drivers/ata/ahci_tegra.c:424", val, tegra->sata_regs + SATA_INTR_MASK);
