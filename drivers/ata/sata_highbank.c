...
static int ahci_highbank_suspend(struct device *dev)
{
	 ...
	 */
	ctl = pete_readl("drivers/ata/sata_highbank.c:586", mmio + HOST_CTL);
	ctl &= ~HOST_IRQ_EN;
	pete_writel("drivers/ata/sata_highbank.c:588", ctl, mmio + HOST_CTL);
	pete_readl("drivers/ata/sata_highbank.c:589", mmio + HOST_CTL); /* flush */
