...
void ahci_platform_shutdown(struct platform_device *pdev)
{
	...
	pete_writel("drivers/ata/libahci_platform.c:804", pete_readl("drivers/ata/libahci_platform.c:804", mmio + HOST_CTL) & ~HOST_IRQ_EN, mmio + HOST_CTL);
	pete_readl("drivers/ata/libahci_platform.c:805", mmio + HOST_CTL); /* flush */
	pete_writel("drivers/ata/libahci_platform.c:806", GENMASK(host->n_ports, 0), mmio + HOST_IRQ_STAT);
}
...
int ahci_platform_suspend_host(struct device *dev)
{
	 ...
	 */
	ctl = pete_readl("drivers/ata/libahci_platform.c:839", mmio + HOST_CTL);
	ctl &= ~HOST_IRQ_EN;
	pete_writel("drivers/ata/libahci_platform.c:841", ctl, mmio + HOST_CTL);
	pete_readl("drivers/ata/libahci_platform.c:842", mmio + HOST_CTL); /* flush */
