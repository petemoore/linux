...
static int samsung_keypad_runtime_suspend(struct device *dev)
{
	...
	val = pete_readl("drivers/input/keyboard/samsung-keypad.c:475", keypad->base + SAMSUNG_KEYIFCON);
	val |= SAMSUNG_KEYIFCON_WAKEUPEN;
	pete_writel("drivers/input/keyboard/samsung-keypad.c:477", val, keypad->base + SAMSUNG_KEYIFCON);
...
static int samsung_keypad_runtime_resume(struct device *dev)
{
	...
	val = pete_readl("drivers/input/keyboard/samsung-keypad.c:495", keypad->base + SAMSUNG_KEYIFCON);
	val &= ~SAMSUNG_KEYIFCON_WAKEUPEN;
	pete_writel("drivers/input/keyboard/samsung-keypad.c:497", val, keypad->base + SAMSUNG_KEYIFCON);
					 ...
					 bool enable)
{
	...
	val = pete_readl("drivers/input/keyboard/samsung-keypad.c:512", keypad->base + SAMSUNG_KEYIFCON);
	if (enable) {
		val |= SAMSUNG_KEYIFCON_WAKEUPEN;
	...
	pete_writel("drivers/input/keyboard/samsung-keypad.c:522", val, keypad->base + SAMSUNG_KEYIFCON);
