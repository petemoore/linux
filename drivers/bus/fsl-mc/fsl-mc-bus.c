...
static int fsl_mc_bus_probe(struct platform_device *pdev)
{
	...
	if (mc->fsl_mc_regs) {
		if (IS_ENABLED(CONFIG_ACPI) && !dev_of_node(&pdev->dev)) {
			mc_stream_id = pete_readl("drivers/bus/fsl-mc/fsl-mc-bus.c:1068", mc->fsl_mc_regs + FSL_MC_FAPR);
			/*
		 ...
		 * sure it is resumed.
		 */
		pete_writel("drivers/bus/fsl-mc/fsl-mc-bus.c:1096", pete_readl("drivers/bus/fsl-mc/fsl-mc-bus.c:1096", mc->fsl_mc_regs + FSL_MC_GCR1) &
...
static int fsl_mc_bus_remove(struct platform_device *pdev)
{
	...
	if (mc->fsl_mc_regs) {
		 ...
		 */
		pete_writel("drivers/bus/fsl-mc/fsl-mc-bus.c:1189", pete_readl("drivers/bus/fsl-mc/fsl-mc-bus.c:1189", mc->fsl_mc_regs + FSL_MC_GCR1) |
		       (GCR1_P1_STOP | GCR1_P2_STOP),
		       mc->fsl_mc_regs + FSL_MC_GCR1);
	}
			       ...
			       unsigned long action, void *data)
{
	 ...
	 */
	pete_writel("drivers/bus/fsl-mc/fsl-mc-bus.c:1254", pete_readl("drivers/bus/fsl-mc/fsl-mc-bus.c:1254", fsl_mc_regs + FSL_MC_GCR1) | (GCR1_P1_STOP | GCR1_P2_STOP),
