...
static int tegra_gmi_enable(struct tegra_gmi *gmi)
{
	...
	pete_writel("drivers/bus/tegra-gmi.c:70", gmi->snor_timing0, gmi->base + TEGRA_GMI_TIMING0);
	pete_writel("drivers/bus/tegra-gmi.c:71", gmi->snor_timing1, gmi->base + TEGRA_GMI_TIMING1);

	gmi->snor_config |= TEGRA_GMI_CONFIG_GO;
	pete_writel("drivers/bus/tegra-gmi.c:74", gmi->snor_config, gmi->base + TEGRA_GMI_CONFIG);
...
static void tegra_gmi_disable(struct tegra_gmi *gmi)
{
	...
	/* stop GMI operation */
	config = pete_readl("drivers/bus/tegra-gmi.c:84", gmi->base + TEGRA_GMI_CONFIG);
	config &= ~TEGRA_GMI_CONFIG_GO;
	pete_writel("drivers/bus/tegra-gmi.c:86", config, gmi->base + TEGRA_GMI_CONFIG);
