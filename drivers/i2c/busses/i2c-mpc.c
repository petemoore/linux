...
{
	pete_writeb("drivers/i2c/busses/i2c-mpc.c:117", x, i2c->base + MPC_I2C_CR);
}
...
static void mpc_i2c_fixup(struct mpc_i2c *i2c)
{
	...
	for (k = 9; k; k--) {
		writeccr(i2c, 0);
		pete_writeb("drivers/i2c/busses/i2c-mpc.c:132", 0, i2c->base + MPC_I2C_SR); /* clear any status bits */
		writeccr(i2c, CCR_MEN | CCR_MSTA); /* START */
		pete_readb("drivers/i2c/busses/i2c-mpc.c:134", i2c->base + MPC_I2C_DR); /* init xfer */
		udelay(15); /* let it hit the bus */
		local_irq_save(flags); /* should not be delayed further */
		writeccr(i2c, CCR_MEN | CCR_MSTA | CCR_RSTA); /* delay SDA */
		pete_readb("drivers/i2c/busses/i2c-mpc.c:138", i2c->base + MPC_I2C_DR);
		if (k != 1)
			udelay(5);
		local_irq_restore(flags);
	}
	writeccr(i2c, CCR_MEN); /* Initiate STOP */
	pete_readb("drivers/i2c/busses/i2c-mpc.c:144", i2c->base + MPC_I2C_DR);
...
static void mpc_i2c_fixup_A004447(struct mpc_i2c *i2c)
{
	...
	val = pete_readb("drivers/i2c/busses/i2c-mpc.c:189", i2c->base + MPC_I2C_SR);
	...
	if (val & CSR_MAL) {
		...
		val = pete_readb("drivers/i2c/busses/i2c-mpc.c:200", i2c->base + MPC_I2C_DR);
		...
		val = pete_readb("drivers/i2c/busses/i2c-mpc.c:208", i2c->base + MPC_I2C_DR);
		ret = i2c_mpc_wait_sr(i2c, CSR_MIF);
		if (ret) {
			dev_err(i2c->dev, "timeout waiting for CSR_MIF\n");
			return;
					 ...
					 u32 clock)
{
	...
	if (clock == MPC_I2C_CLOCK_PRESERVE) {
		dev_dbg(i2c->dev, "using fdr %d\n",
			pete_readb("drivers/i2c/busses/i2c-mpc.c:283", i2c->base + MPC_I2C_FDR));
		return;
	}
	...
	pete_writeb("drivers/i2c/busses/i2c-mpc.c:290", fdr & 0xff, i2c->base + MPC_I2C_FDR);
					 ...
					 u32 clock)
{
	...
	if (clock == MPC_I2C_CLOCK_PRESERVE) {
		dev_dbg(i2c->dev, "using dfsrr %d, fdr %d\n",
			pete_readb("drivers/i2c/busses/i2c-mpc.c:469", i2c->base + MPC_I2C_DFSRR),
			pete_readb("drivers/i2c/busses/i2c-mpc.c:470", i2c->base + MPC_I2C_FDR));
		return;
	}
	...
	pete_writeb("drivers/i2c/busses/i2c-mpc.c:477", fdr & 0xff, i2c->base + MPC_I2C_FDR);
	pete_writeb("drivers/i2c/busses/i2c-mpc.c:478", (fdr >> 8) & 0xff, i2c->base + MPC_I2C_DFSRR);
...
static void mpc_i2c_do_action(struct mpc_i2c *i2c)
{
	...
	case MPC_I2C_ACTION_START:
		...
		writeccr(i2c, i2c->cntl_bits);
		pete_writeb("drivers/i2c/busses/i2c-mpc.c:529", (msg->addr << 1) | dir, i2c->base + MPC_I2C_DR);
		i2c->expect_rxack = 1;
	...
	case MPC_I2C_ACTION_READ_BEGIN:
		if (msg->len) {
			...
			writeccr(i2c, i2c->cntl_bits);
			/* Dummy read */
			pete_readb("drivers/i2c/busses/i2c-mpc.c:541", i2c->base + MPC_I2C_DR);
		}
	...
	case MPC_I2C_ACTION_READ_BYTE:
		...
		byte = pete_readb("drivers/i2c/busses/i2c-mpc.c:558", i2c->base + MPC_I2C_DR);
	...
	case MPC_I2C_ACTION_WRITE:
		...
		pete_writeb("drivers/i2c/busses/i2c-mpc.c:583", msg->buf[i2c->byte_posn++], i2c->base + MPC_I2C_DR);
		i2c->expect_rxack = 1;
		break;
...
static irqreturn_t mpc_i2c_isr(int irq, void *dev_id)
{
	...
	status = pete_readb("drivers/i2c/busses/i2c-mpc.c:648", i2c->base + MPC_I2C_SR);
	if (status & CSR_MIF) {
		/* Wait up to 100us for transfer to properly complete */
		readb_poll_timeout_atomic(i2c->base + MPC_I2C_SR, status, status & CSR_MCF, 0, 100);
		pete_writeb("drivers/i2c/busses/i2c-mpc.c:652", 0, i2c->base + MPC_I2C_SR);
...
static int mpc_i2c_execute_msg(struct mpc_i2c *i2c)
{
	...
	pete_writeb("drivers/i2c/busses/i2c-mpc.c:687", 0, i2c->base + MPC_I2C_SR);
	writeccr(i2c, i2c->cntl_bits);
	...
	while (pete_readb("drivers/i2c/busses/i2c-mpc.c:703", i2c->base + MPC_I2C_SR) & CSR_MBB) {
		if (time_after(jiffies, orig_jiffies + HZ)) {
			u8 status = pete_readb("drivers/i2c/busses/i2c-mpc.c:705", i2c->base + MPC_I2C_SR);

			dev_dbg(i2c->dev, "timeout\n");
			if ((status & (CSR_MCF | CSR_MBB | CSR_RXAK)) != 0) {
				pete_writeb("drivers/i2c/busses/i2c-mpc.c:709", status & ~CSR_MAL,
				       i2c->base + MPC_I2C_SR);
				i2c_recover_bus(&i2c->adap);
			}
			return -EIO;
...
static int __maybe_unused mpc_i2c_suspend(struct device *dev)
{
	...
	i2c->fdr = pete_readb("drivers/i2c/busses/i2c-mpc.c:907", i2c->base + MPC_I2C_FDR);
	i2c->dfsrr = pete_readb("drivers/i2c/busses/i2c-mpc.c:908", i2c->base + MPC_I2C_DFSRR);
...
static int __maybe_unused mpc_i2c_resume(struct device *dev)
{
	...
	pete_writeb("drivers/i2c/busses/i2c-mpc.c:917", i2c->fdr, i2c->base + MPC_I2C_FDR);
	pete_writeb("drivers/i2c/busses/i2c-mpc.c:918", i2c->dfsrr, i2c->base + MPC_I2C_DFSRR);
