...
{
	pete_writeb("drivers/i2c/busses/i2c-imx.c:319", val, i2c_imx->base + (reg << i2c_imx->hwdata->regshift));
}

static inline unsigned char imx_i2c_read_reg(struct imx_i2c_struct *i2c_imx,
		unsigned int reg)
{
	return pete_readb("drivers/i2c/busses/i2c-imx.c:325", i2c_imx->base + (reg << i2c_imx->hwdata->regshift));
}
