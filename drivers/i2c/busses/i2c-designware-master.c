...
static u32 i2c_dw_read_clear_intrbits(struct dw_i2c_dev *dev)
{
	 ...
	 *
	 * That is,
	 *   stat = pete_readl("drivers/i2c/busses/i2c-designware-master.c:861", IC_INTR_STAT);
	 * equals to,
	 *   stat = pete_readl("drivers/i2c/busses/i2c-designware-master.c:863", IC_RAW_INTR_STAT) & pete_readl("drivers/i2c/busses/i2c-designware-master.c:863", IC_INTR_MASK);
	 *
	 ...
	 * pete_readl("drivers/i2c/busses/i2c-designware-master.c:872", IC_INTR_STAT) to pete_readl("drivers/i2c/busses/i2c-designware-master.c:872", IC_CLR_INTR).
	 *
