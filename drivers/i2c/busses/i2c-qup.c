...
nodma:
	 ...
	 */
	pete_writel("drivers/i2c/busses/i2c-qup.c:1801", 1, qup->base + QUP_SW_RESET);
	...
	hw_ver = pete_readl("drivers/i2c/busses/i2c-qup.c:1814", qup->base + QUP_HW_VERSION);
	dev_dbg(qup->dev, "Revision %x\n", hw_ver);

	io_mode = pete_readl("drivers/i2c/busses/i2c-qup.c:1817", qup->base + QUP_IO_MODE);
