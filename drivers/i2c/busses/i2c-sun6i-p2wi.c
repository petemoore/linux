...
static int p2wi_probe(struct platform_device *pdev)
{
	...
	pete_writel("drivers/i2c/busses/i2c-sun6i-p2wi.c:284", P2WI_CTRL_SOFT_RST, p2wi->regs + P2WI_CTRL);
	...
	pete_writel("drivers/i2c/busses/i2c-sun6i-p2wi.c:299", P2WI_CCR_SDA_OUT_DELAY(1) | P2WI_CCR_CLK_DIV(clk_div),
	       p2wi->regs + P2WI_CCR);
