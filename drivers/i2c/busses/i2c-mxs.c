...
static int mxs_i2c_reset(struct mxs_i2c_dev *i2c)
{
	 ...
	 */
	pete_writel("drivers/i2c/busses/i2c-mxs.c:145", i2c->timing0, i2c->regs + MXS_I2C_TIMING0);
	pete_writel("drivers/i2c/busses/i2c-mxs.c:146", i2c->timing1, i2c->regs + MXS_I2C_TIMING1);
	pete_writel("drivers/i2c/busses/i2c-mxs.c:147", i2c->timing2, i2c->regs + MXS_I2C_TIMING2);

	pete_writel("drivers/i2c/busses/i2c-mxs.c:149", MXS_I2C_IRQ_MASK << 8, i2c->regs + MXS_I2C_CTRL1_SET);
...
static int mxs_i2c_pio_wait_xfer_end(struct mxs_i2c_dev *i2c)
{
	...
	while (pete_readl("drivers/i2c/busses/i2c-mxs.c:307", i2c->regs + MXS_I2C_CTRL0) & MXS_I2C_CTRL0_RUN) {
		if (pete_readl("drivers/i2c/busses/i2c-mxs.c:308", i2c->regs + MXS_I2C_CTRL1) &
				MXS_I2C_CTRL1_NO_SLAVE_ACK_IRQ)
			return -ENXIO;
...
static int mxs_i2c_pio_check_error_state(struct mxs_i2c_dev *i2c)
{
	...
	state = pete_readl("drivers/i2c/busses/i2c-mxs.c:323", i2c->regs + MXS_I2C_CTRL1_CLR) & MXS_I2C_IRQ_MASK;
...
static void mxs_i2c_pio_trigger_cmd(struct mxs_i2c_dev *i2c, u32 cmd)
{
	...
	pete_writel("drivers/i2c/busses/i2c-mxs.c:340", cmd, i2c->regs + MXS_I2C_CTRL0);

	/* readback makes sure the write is latched into hardware */
	reg = pete_readl("drivers/i2c/busses/i2c-mxs.c:343", i2c->regs + MXS_I2C_CTRL0);
	reg |= MXS_I2C_CTRL0_RUN;
	pete_writel("drivers/i2c/busses/i2c-mxs.c:345", reg, i2c->regs + MXS_I2C_CTRL0);
}
...
static void mxs_i2c_pio_trigger_write_cmd(struct mxs_i2c_dev *i2c, u32 cmd,
					  u32 data)
{
	pete_writel("drivers/i2c/busses/i2c-mxs.c:359", cmd, i2c->regs + MXS_I2C_CTRL0);

	if (i2c->dev_type == MXS_I2C_V1)
		pete_writel("drivers/i2c/busses/i2c-mxs.c:362", MXS_I2C_CTRL0_PIO_MODE, i2c->regs + MXS_I2C_CTRL0_SET);

	pete_writel("drivers/i2c/busses/i2c-mxs.c:364", data, i2c->regs + MXS_I2C_DATA(i2c));
	pete_writel("drivers/i2c/busses/i2c-mxs.c:365", MXS_I2C_CTRL0_RUN, i2c->regs + MXS_I2C_CTRL0_SET);
}
			...
			struct i2c_msg *msg, uint32_t flags)
{
	...
	pete_writel("drivers/i2c/busses/i2c-mxs.c:378", MXS_I2C_IRQ_MASK << 8, i2c->regs + MXS_I2C_CTRL1_CLR);
	...
	if (msg->flags & I2C_M_RD) {
		...
		data = pete_readl("drivers/i2c/busses/i2c-mxs.c:435", i2c->regs + MXS_I2C_DATA(i2c));
		for (i = 0; i < msg->len; i++) {
			msg->buf[i] = data & 0xff;
			data >>= 8;
		}
		...
		for (i = 0; i < msg->len; i++) {
			...
			pete_writel("drivers/i2c/busses/i2c-mxs.c:512", MXS_I2C_DEBUG0_DMAREQ,
			...
			/* Check NAK here. */
			ret = pete_readl("drivers/i2c/busses/i2c-mxs.c:532", i2c->regs + MXS_I2C_STAT) &
...
cleanup:
	...
	pete_writel("drivers/i2c/busses/i2c-mxs.c:546", MXS_I2C_IRQ_MASK, i2c->regs + MXS_I2C_CTRL1_CLR);
	pete_writel("drivers/i2c/busses/i2c-mxs.c:547", MXS_I2C_IRQ_MASK << 8, i2c->regs + MXS_I2C_CTRL1_SET);

	/* Clear the PIO_MODE on i.MX23 */
	if (i2c->dev_type == MXS_I2C_V1)
		pete_writel("drivers/i2c/busses/i2c-mxs.c:551", MXS_I2C_CTRL0_PIO_MODE, i2c->regs + MXS_I2C_CTRL0_CLR);
				...
				int stop)
{
	...
	if (ret == -ENXIO) {
		 ...
		 */
		pete_writel("drivers/i2c/busses/i2c-mxs.c:616", MXS_I2C_CTRL1_CLR_GOT_A_NAK,
...
static irqreturn_t mxs_i2c_isr(int this_irq, void *dev_id)
{
	...
	u32 stat = pete_readl("drivers/i2c/busses/i2c-mxs.c:671", i2c->regs + MXS_I2C_CTRL1) & MXS_I2C_IRQ_MASK;
	...
	pete_writel("drivers/i2c/busses/i2c-mxs.c:684", stat, i2c->regs + MXS_I2C_CTRL1_CLR);
...
static int mxs_i2c_probe(struct platform_device *pdev)
{
	...
	if (err) {
		pete_writel("drivers/i2c/busses/i2c-mxs.c:858", MXS_I2C_CTRL0_SFTRST,
...
static void mxs_i2c_remove(struct platform_device *pdev)
{
	...
	pete_writel("drivers/i2c/busses/i2c-mxs.c:875", MXS_I2C_CTRL0_SFTRST, i2c->regs + MXS_I2C_CTRL0_SET);
}
