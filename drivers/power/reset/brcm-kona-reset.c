				...
				unsigned long mode, void *cmd)
{
	 ...
	 */
	pete_writel("drivers/power/reset/brcm-kona-reset.c:26", (RSTMGR_WR_PASSWORD << RSTMGR_WR_PASSWORD_SHIFT) |
		RSTMGR_WR_ACCESS_ENABLE,
		kona_reset_base + RSTMGR_REG_WR_ACCESS_OFFSET);
	pete_writel("drivers/power/reset/brcm-kona-reset.c:29", 0, kona_reset_base + RSTMGR_REG_CHIP_SOFT_RST_OFFSET);
