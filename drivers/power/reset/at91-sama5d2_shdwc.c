...
static int __init at91_shdwc_probe(struct platform_device *pdev)
{
	...
	if (at91_shdwc->rcfg->ddrc.type_mask) {
		...
		ddr_type = pete_readl("drivers/power/reset/at91-sama5d2_shdwc.c:402", at91_shdwc->mpddrc_base +
...
static int __exit at91_shdwc_remove(struct platform_device *pdev)
{
	...
	pete_writel("drivers/power/reset/at91-sama5d2_shdwc.c:432", 0, shdw->shdwc_base + AT91_SHDW_MR);
	pete_writel("drivers/power/reset/at91-sama5d2_shdwc.c:433", 0, shdw->shdwc_base + AT91_SHDW_WUIR);
