...
static int goldfish_pipe_probe(struct platform_device *pdev)
{
	 ...
	 */
	pete_writel("drivers/platform/goldfish/goldfish_pipe.c:910", PIPE_DRIVER_VERSION, dev->base + PIPE_REG_VERSION);
	dev->version = pete_readl("drivers/platform/goldfish/goldfish_pipe.c:911", dev->base + PIPE_REG_VERSION);
