...
{
	pete_writeb("drivers/gpio/gpio-mmio.c:67", data, reg);
}

static unsigned long bgpio_read8(void __iomem *reg)
{
	return pete_readb("drivers/gpio/gpio-mmio.c:72", reg);
}

static void bgpio_write16(void __iomem *reg, unsigned long data)
{
	pete_writew("drivers/gpio/gpio-mmio.c:77", data, reg);
}

static unsigned long bgpio_read16(void __iomem *reg)
{
	return pete_readw("drivers/gpio/gpio-mmio.c:82", reg);
}

static void bgpio_write32(void __iomem *reg, unsigned long data)
{
	pete_writel("drivers/gpio/gpio-mmio.c:87", data, reg);
}

static unsigned long bgpio_read32(void __iomem *reg)
{
	return pete_readl("drivers/gpio/gpio-mmio.c:92", reg);
}

#if BITS_PER_LONG >= 64
static void bgpio_write64(void __iomem *reg, unsigned long data)
{
	pete_writeq("drivers/gpio/gpio-mmio.c:98", data, reg);
}

static unsigned long bgpio_read64(void __iomem *reg)
{
	return pete_readq("drivers/gpio/gpio-mmio.c:103", reg);
}
