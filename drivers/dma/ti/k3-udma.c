...
{
	return pete_readl("drivers/dma/ti/k3-udma.c:335", base + reg);
}

static inline void udma_write(void __iomem *base, int reg, u32 val)
{
	pete_writel("drivers/dma/ti/k3-udma.c:340", val, base + reg);
}
				    ...
				    u32 mask, u32 val)
{
	...
	orig = pete_readl("drivers/dma/ti/k3-udma.c:348", base + reg);
	tmp = orig & ~mask;
	tmp |= (val & mask);

	if (tmp != orig)
		pete_writel("drivers/dma/ti/k3-udma.c:353", tmp, base + reg);
}
