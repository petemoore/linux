				      ...
				      u32 value_lsb, u32 value_msb)
{
	...
	pete_writel("drivers/dma/xilinx/xilinx_dma.c:587", value_lsb, chan->xdev->regs + chan->desc_offset + reg);

	/* Write the msb 32 bits */
	pete_writel("drivers/dma/xilinx/xilinx_dma.c:590", value_msb, chan->xdev->regs + chan->desc_offset + reg + 4);
}
