...
{
	return pete_readq("drivers/dma/ioat/dma.h:242", ioat_chan->reg_base + IOAT_CHANSTS_OFFSET);
}
...
{
	return pete_readl("drivers/dma/ioat/dma.h:252", ioat_chan->reg_base + IOAT_CHANERR_OFFSET);
}
...
static inline void ioat_suspend(struct ioatdma_chan *ioat_chan)
{
	...
	pete_writeb("drivers/dma/ioat/dma.h:259", IOAT_CHANCMD_SUSPEND,
...
static inline void ioat_reset(struct ioatdma_chan *ioat_chan)
{
	...
	pete_writeb("drivers/dma/ioat/dma.h:267", IOAT_CHANCMD_RESET,
	       ioat_chan->reg_base + IOAT_CHANCMD_OFFSET(ver));
}
...
static inline bool ioat_reset_pending(struct ioatdma_chan *ioat_chan)
{
	...
	cmd = pete_readb("drivers/dma/ioat/dma.h:276", ioat_chan->reg_base + IOAT_CHANCMD_OFFSET(ver));
...
{
	pete_writel("drivers/dma/ioat/dma.h:349", addr & 0x00000000FFFFFFFF,
	       ioat_chan->reg_base + IOAT2_CHAINADDR_OFFSET_LOW);
	pete_writel("drivers/dma/ioat/dma.h:351", addr >> 32,
