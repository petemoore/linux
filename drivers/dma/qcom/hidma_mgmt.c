...
int hidma_mgmt_setup(struct hidma_mgmt_dev *mgmtdev)
{
	...
	val = pete_readl("drivers/dma/qcom/hidma_mgmt.c:122", mgmtdev->virtaddr + HIDMA_MAX_BUS_REQ_LEN_OFFSET);
	...
	pete_writel("drivers/dma/qcom/hidma_mgmt.c:127", val, mgmtdev->virtaddr + HIDMA_MAX_BUS_REQ_LEN_OFFSET);

	val = pete_readl("drivers/dma/qcom/hidma_mgmt.c:129", mgmtdev->virtaddr + HIDMA_MAX_XACTIONS_OFFSET);
	...
	pete_writel("drivers/dma/qcom/hidma_mgmt.c:134", val, mgmtdev->virtaddr + HIDMA_MAX_XACTIONS_OFFSET);

	mgmtdev->hw_version =
	    pete_readl("drivers/dma/qcom/hidma_mgmt.c:137", mgmtdev->virtaddr + HIDMA_HW_VERSION_OFFSET);
	...
	for (i = 0; i < mgmtdev->dma_channels; i++) {
		...
		val = pete_readl("drivers/dma/qcom/hidma_mgmt.c:145", mgmtdev->virtaddr + HIDMA_QOS_N_OFFSET + (4 * i));
		...
		pete_writel("drivers/dma/qcom/hidma_mgmt.c:150", val, mgmtdev->virtaddr + HIDMA_QOS_N_OFFSET + (4 * i));
	}

	val = pete_readl("drivers/dma/qcom/hidma_mgmt.c:153", mgmtdev->virtaddr + HIDMA_CHRESET_TIMEOUT_OFFSET);
	val &= ~HIDMA_CHRESET_TIMEOUT_MASK;
	val |= mgmtdev->chreset_timeout_cycles & HIDMA_CHRESET_TIMEOUT_MASK;
	pete_writel("drivers/dma/qcom/hidma_mgmt.c:156", val, mgmtdev->virtaddr + HIDMA_CHRESET_TIMEOUT_OFFSET);
...
static int hidma_mgmt_probe(struct platform_device *pdev)
{
	...
	/* start the HW */
	val = pete_readl("drivers/dma/qcom/hidma_mgmt.c:297", mgmtdev->virtaddr + HIDMA_CFG_OFFSET);
	val |= 1;
	pete_writel("drivers/dma/qcom/hidma_mgmt.c:299", val, mgmtdev->virtaddr + HIDMA_CFG_OFFSET);
