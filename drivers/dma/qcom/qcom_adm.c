...
static void adm_start_dma(struct adm_chan *achan)
{
	...
	if (!achan->initialized) {
		/* enable interrupts */
		pete_writel("drivers/dma/qcom/qcom_adm.c:536", ADM_CH_CONF_SHADOW_EN |
		       ADM_CH_CONF_PERM_MPU_CONF |
		       ADM_CH_CONF_MPU_DISABLE |
		       ADM_CH_CONF_SEC_DOMAIN(adev->ee),
		       adev->regs + ADM_CH_CONF(achan->id));

		pete_writel("drivers/dma/qcom/qcom_adm.c:542", ADM_CH_RSLT_CONF_IRQ_EN | ADM_CH_RSLT_CONF_FLUSH_EN,
	...
	if (async_desc->crci) {
		pete_writel("drivers/dma/qcom/qcom_adm.c:550", async_desc->mux | async_desc->blk_size,
	...
	/* write next command list out to the CMD FIFO */
	pete_writel("drivers/dma/qcom/qcom_adm.c:558", ALIGN(async_desc->dma_addr, ADM_DESC_ALIGN) >> 3,
...
static int adm_dma_probe(struct platform_device *pdev)
{
	...
	/* reset CRCIs */
	for (i = 0; i < 16; i++)
		pete_writel("drivers/dma/qcom/qcom_adm.c:844", ADM_CRCI_CTL_RST, adev->regs +
			ADM_CRCI_CTL(i, adev->ee));

	/* configure client interfaces */
	pete_writel("drivers/dma/qcom/qcom_adm.c:848", ADM_CI_RANGE_START(0x40) | ADM_CI_RANGE_END(0xb0) |
	       ADM_CI_BURST_8_WORDS, adev->regs + ADM_CI_CONF(0));
	pete_writel("drivers/dma/qcom/qcom_adm.c:850", ADM_CI_RANGE_START(0x2a) | ADM_CI_RANGE_END(0x2c) |
	       ADM_CI_BURST_8_WORDS, adev->regs + ADM_CI_CONF(1));
	pete_writel("drivers/dma/qcom/qcom_adm.c:852", ADM_CI_RANGE_START(0x12) | ADM_CI_RANGE_END(0x28) |
	       ADM_CI_BURST_8_WORDS, adev->regs + ADM_CI_CONF(2));
	pete_writel("drivers/dma/qcom/qcom_adm.c:854", ADM_GP_CTL_LP_EN | ADM_GP_CTL_LP_CNT(0xf),
...
static int adm_dma_remove(struct platform_device *pdev)
{
	...
	for (i = 0; i < ADM_MAX_CHANNELS; i++) {
		...
		pete_writel("drivers/dma/qcom/qcom_adm.c:920", 0, adev->regs + ADM_CH_RSLT_CONF(achan->id, adev->ee));
