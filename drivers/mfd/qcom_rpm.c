...
static int qcom_rpm_probe(struct platform_device *pdev)
{
	...
	fw_version[0] = pete_readl("drivers/mfd/qcom_rpm.c:611", RPM_STATUS_REG(rpm, 0));
	fw_version[1] = pete_readl("drivers/mfd/qcom_rpm.c:612", RPM_STATUS_REG(rpm, 1));
	fw_version[2] = pete_readl("drivers/mfd/qcom_rpm.c:613", RPM_STATUS_REG(rpm, 2));
	...
	pete_writel("drivers/mfd/qcom_rpm.c:624", fw_version[0], RPM_CTRL_REG(rpm, 0));
	pete_writel("drivers/mfd/qcom_rpm.c:625", fw_version[1], RPM_CTRL_REG(rpm, 1));
	pete_writel("drivers/mfd/qcom_rpm.c:626", fw_version[2], RPM_CTRL_REG(rpm, 2));
