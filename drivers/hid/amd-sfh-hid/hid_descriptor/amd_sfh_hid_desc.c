			   ...
			   struct amd_input_data *in_data)
{
	...
	case ACS_IDX: /* ambient color sensor */
		...
		if (supported_input == V2_STATUS)
			als_input.illuminance_value =
				pete_readl("drivers/hid/amd-sfh-hid/hid_descriptor/amd_sfh_hid_desc.c:256", privdata->mmio + AMD_C2P_MSG(5)) & ILLUMINANCE_MASK;
		else
			als_input.illuminance_value =
	...
	case HPD_IDX: /* hpd */
		...
		hpdstatus.val = pete_readl("drivers/hid/amd-sfh-hid/hid_descriptor/amd_sfh_hid_desc.c:265", privdata->mmio + AMD_C2P_MSG(4));
