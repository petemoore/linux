...
sli_bmbx_wait(struct sli4 *sli4, u32 msec)
{
	...
	do {
		val = pete_readl("drivers/scsi/elx/libefc_sli/sli4.c:2873", sli4->reg[0] + SLI4_BMBX_REG);
...
sli_bmbx_write(struct sli4 *sli4)
{
	...
	pete_writel("drivers/scsi/elx/libefc_sli/sli4.c:2890", val, (sli4->reg[0] + SLI4_BMBX_REG));
	...
	pete_writel("drivers/scsi/elx/libefc_sli/sli4.c:2897", val, (sli4->reg[0] + SLI4_BMBX_REG));
...
sli_bmbx_command(struct sli4 *sli4)
{
	...
	if (sli_bmbx_write(sli4)) {
		efc_log_crit(sli4, "bmbx write fail phys=%pad reg=%#x\n",
			     &sli4->bmbx.phys, pete_readl("drivers/scsi/elx/libefc_sli/sli4.c:2920", sli4->reg[0] + SLI4_BMBX_REG));
		return -EIO;
	}
...
sli_sliport_reset(struct sli4 *sli4)
{
	...
	pete_writel("drivers/scsi/elx/libefc_sli/sli4.c:4063", val, (sli4->reg[0] + SLI4_PORT_CTRL_REG));
...
sli_fw_reset(struct sli4 *sli4)
{
	...
	pete_writel("drivers/scsi/elx/libefc_sli/sli4.c:4761", SLI4_PHYDEV_CTRL_FRST, (sli4->reg[0] + SLI4_PHYDEV_CTRL_REG));
...
int sli_raise_ue(struct sli4 *sli4, u8 dump)
{
	...
	if (dump == SLI4_FUNC_DESC_DUMP) {
		...
		pete_writel("drivers/scsi/elx/libefc_sli/sli4.c:4959", val, (sli4->reg[0] + SLI4_PORT_CTRL_REG));
	} else {
		val = SLI4_PHYDEV_CTRL_FRST;

		if (dump == SLI4_CHIP_LEVEL_DUMP)
			val |= SLI4_PHYDEV_CTRL_DD;
		pete_writel("drivers/scsi/elx/libefc_sli/sli4.c:4965", val, (sli4->reg[0] + SLI4_PHYDEV_CTRL_REG));
	}
...
int sli_dump_is_ready(struct sli4 *sli4)
{
	...
	bmbx_val = pete_readl("drivers/scsi/elx/libefc_sli/sli4.c:4982", sli4->reg[0] + SLI4_BMBX_REG);
