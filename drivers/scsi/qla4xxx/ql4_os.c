...
static int qla4xxx_isp_check_reg(struct scsi_qla_host *ha)
{
	...
	if (is_qla8022(ha))
		reg_val = pete_readl("drivers/scsi/qla4xxx/ql4_os.c:305", &ha->qla4_82xx_reg->host_status);
	else if (is_qla8032(ha) || is_qla8042(ha))
		reg_val = qla4_8xxx_rd_direct(ha, QLA8XXX_PEG_ALIVE_COUNTER);
	else
		reg_val = pete_readw("drivers/scsi/qla4xxx/ql4_os.c:309", &ha->reg->ctrl_status);
...
int qla4xxx_hw_reset(struct scsi_qla_host *ha)
{
	 ...
	 */
	ctrl_status = pete_readw("drivers/scsi/qla4xxx/ql4_os.c:4684", &ha->reg->ctrl_status);
	if ((ctrl_status & CSR_SCSI_RESET_INTR) != 0)
		pete_writel("drivers/scsi/qla4xxx/ql4_os.c:4686", set_rmask(CSR_SCSI_RESET_INTR), &ha->reg->ctrl_status);

	/* Issue Soft Reset */
	pete_writel("drivers/scsi/qla4xxx/ql4_os.c:4689", set_rmask(CSR_SOFT_RESET), &ha->reg->ctrl_status);
	pete_readl("drivers/scsi/qla4xxx/ql4_os.c:4690", &ha->reg->ctrl_status);
...
int qla4xxx_soft_reset(struct scsi_qla_host *ha)
{
	...
	do {
		spin_lock_irqsave(&ha->hardware_lock, flags);
		ctrl_status = pete_readw("drivers/scsi/qla4xxx/ql4_os.c:4716", &ha->reg->ctrl_status);
		spin_unlock_irqrestore(&ha->hardware_lock, flags);
	...
	if ((ctrl_status & CSR_NET_RESET_INTR) != 0) {
		DEBUG2(printk(KERN_WARNING
			      ...
			      ha->host_no));
		spin_lock_irqsave(&ha->hardware_lock, flags);
		pete_writel("drivers/scsi/qla4xxx/ql4_os.c:4731", set_rmask(CSR_NET_RESET_INTR), &ha->reg->ctrl_status);
		pete_readl("drivers/scsi/qla4xxx/ql4_os.c:4732", &ha->reg->ctrl_status);
		spin_unlock_irqrestore(&ha->hardware_lock, flags);
	}
	...
	do {
		spin_lock_irqsave(&ha->hardware_lock, flags);
		ctrl_status = pete_readw("drivers/scsi/qla4xxx/ql4_os.c:4740", &ha->reg->ctrl_status);
		spin_unlock_irqrestore(&ha->hardware_lock, flags);
	 ...
	 */
	spin_lock_irqsave(&ha->hardware_lock, flags);
	ctrl_status = pete_readw("drivers/scsi/qla4xxx/ql4_os.c:4756", &ha->reg->ctrl_status);
	if ((ctrl_status & CSR_SCSI_RESET_INTR) != 0) {
		pete_writel("drivers/scsi/qla4xxx/ql4_os.c:4758", set_rmask(CSR_SCSI_RESET_INTR), &ha->reg->ctrl_status);
		pete_readl("drivers/scsi/qla4xxx/ql4_os.c:4759", &ha->reg->ctrl_status);
	}
	spin_unlock_irqrestore(&ha->hardware_lock, flags);
	...
	if (max_wait_time == 0) {
		...
		spin_lock_irqsave(&ha->hardware_lock, flags);
		pete_writel("drivers/scsi/qla4xxx/ql4_os.c:4772", set_rmask(CSR_FORCE_SOFT_RESET), &ha->reg->ctrl_status);
		pete_readl("drivers/scsi/qla4xxx/ql4_os.c:4773", &ha->reg->ctrl_status);
		spin_unlock_irqrestore(&ha->hardware_lock, flags);
		/* Wait until the firmware tells us the Soft Reset is done */
		max_wait_time = SOFT_RESET_TOV;
		do {
			spin_lock_irqsave(&ha->hardware_lock, flags);
			ctrl_status = pete_readw("drivers/scsi/qla4xxx/ql4_os.c:4779", &ha->reg->ctrl_status);
			spin_unlock_irqrestore(&ha->hardware_lock, flags);
...
static void qla4xxx_do_dpc(struct work_struct *work)
{
	...
	if (!test_bit(DPC_RESET_ACTIVE, &ha->dpc_flags) &&
		...
		if (test_bit(DPC_RESET_HA_INTR, &ha->dpc_flags)) {
			...
			while ((pete_readw("drivers/scsi/qla4xxx/ql4_os.c:5409", &ha->reg->ctrl_status) &
...
static void qla4xxx_free_adapter(struct scsi_qla_host *ha)
{
	...
	if (is_qla40XX(ha)) {
		pete_writel("drivers/scsi/qla4xxx/ql4_os.c:5485", set_rmask(CSR_SCSI_PROCESSOR_INTR),
		       &ha->reg->ctrl_status);
		pete_readl("drivers/scsi/qla4xxx/ql4_os.c:5487", &ha->reg->ctrl_status);
	} else if (is_qla8022(ha)) {
		pete_writel("drivers/scsi/qla4xxx/ql4_os.c:5489", 0, &ha->qla4_82xx_reg->host_int);
		pete_readl("drivers/scsi/qla4xxx/ql4_os.c:5490", &ha->qla4_82xx_reg->host_int);
	} else if (is_qla8032(ha) || is_qla8042(ha)) {
		pete_writel("drivers/scsi/qla4xxx/ql4_os.c:5492", 0, &ha->qla4_83xx_reg->risc_intr);
		pete_readl("drivers/scsi/qla4xxx/ql4_os.c:5493", &ha->qla4_83xx_reg->risc_intr);
	}
...
{
	return (uint16_t)le32_to_cpu(pete_readl("drivers/scsi/qla4xxx/ql4_os.c:5725", &ha->qla4_82xx_reg->req_q_out));
}
...
{
	return (uint16_t)le32_to_cpu(pete_readl("drivers/scsi/qla4xxx/ql4_os.c:5735", &ha->qla4_82xx_reg->rsp_q_in));
}
