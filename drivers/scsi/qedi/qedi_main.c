...
retry_probe:
	...
	QEDI_INFO(&qedi->dbg_ctx, QEDI_LOG_DISC,
		  ...
		  qedi->bdq_prod_idx);
	pete_writew("drivers/scsi/qedi/qedi_main.c:2655", qedi->bdq_prod_idx, qedi->bdq_primary_prod);
	pete_readw("drivers/scsi/qedi/qedi_main.c:2656", qedi->bdq_primary_prod);
	pete_writew("drivers/scsi/qedi/qedi_main.c:2657", qedi->bdq_prod_idx, qedi->bdq_secondary_prod);
	pete_readw("drivers/scsi/qedi/qedi_main.c:2658", qedi->bdq_secondary_prod);
