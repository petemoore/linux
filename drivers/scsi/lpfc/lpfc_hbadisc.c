...
lpfc_work_done(struct lpfc_hba *phba)
{
	...
	if (pring && (status & HA_RXMASK ||
		...
		if (phba->sli_rev <= LPFC_SLI_REV3) {
			spin_lock_irq(&phba->hbalock);
			control = pete_readl("drivers/scsi/lpfc/lpfc_hbadisc.c:1064", phba->HCregaddr);
			if (!(control & (HC_R0INT_ENA << LPFC_ELS_RING))) {
				...
				pete_writel("drivers/scsi/lpfc/lpfc_hbadisc.c:1071", control, phba->HCregaddr);
				pete_readl("drivers/scsi/lpfc/lpfc_hbadisc.c:1072", phba->HCregaddr); /* flush */
			} else {
				lpfc_debugfs_slow_ring_trc(phba,
...
lpfc_mbx_cmpl_clear_la(struct lpfc_hba *phba, LPFC_MBOXQ_t *pmb)
{
	...
	control = pete_readl("drivers/scsi/lpfc/lpfc_hbadisc.c:1467", phba->HCregaddr);
	control |= HC_LAINT_ENA;
	pete_writel("drivers/scsi/lpfc/lpfc_hbadisc.c:1469", control, phba->HCregaddr);
	pete_readl("drivers/scsi/lpfc/lpfc_hbadisc.c:1470", phba->HCregaddr); /* flush */
	spin_unlock_irq(&phba->hbalock);
...
out:
	...
	spin_lock_irq(&phba->hbalock);
	psli->sli_flag |= LPFC_PROCESS_LA;
	control = pete_readl("drivers/scsi/lpfc/lpfc_hbadisc.c:1491", phba->HCregaddr);
	control |= HC_LAINT_ENA;
	pete_writel("drivers/scsi/lpfc/lpfc_hbadisc.c:1493", control, phba->HCregaddr);
	pete_readl("drivers/scsi/lpfc/lpfc_hbadisc.c:1494", phba->HCregaddr); /* flush */
	spin_unlock_irq(&phba->hbalock);
...
lpfc_enable_la(struct lpfc_hba *phba)
{
	...
	psli->sli_flag |= LPFC_PROCESS_LA;
	if (phba->sli_rev <= LPFC_SLI_REV3) {
		control = pete_readl("drivers/scsi/lpfc/lpfc_hbadisc.c:3726", phba->HCregaddr);
		control |= HC_LAINT_ENA;
		pete_writel("drivers/scsi/lpfc/lpfc_hbadisc.c:3728", control, phba->HCregaddr);
		pete_readl("drivers/scsi/lpfc/lpfc_hbadisc.c:3729", phba->HCregaddr); /* flush */
	}
	spin_unlock_irq(&phba->hbalock);
}
