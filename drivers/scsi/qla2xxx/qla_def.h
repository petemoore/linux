...
{
	return pete_readb("drivers/scsi/qla2xxx/qla_def.h:160", addr);
}

static inline u16 rd_reg_word(const volatile __le16 __iomem *addr)
{
	return pete_readw("drivers/scsi/qla2xxx/qla_def.h:165", addr);
}

static inline u32 rd_reg_dword(const volatile __le32 __iomem *addr)
{
	return pete_readl("drivers/scsi/qla2xxx/qla_def.h:170", addr);
}
...
{
	return pete_writeb("drivers/scsi/qla2xxx/qla_def.h:190", data, addr);
}

static inline void wrt_reg_word(volatile __le16 __iomem *addr, u16 data)
{
	return pete_writew("drivers/scsi/qla2xxx/qla_def.h:195", data, addr);
}

static inline void wrt_reg_dword(volatile __le32 __iomem *addr, u32 data)
{
	return pete_writel("drivers/scsi/qla2xxx/qla_def.h:200", data, addr);
}
