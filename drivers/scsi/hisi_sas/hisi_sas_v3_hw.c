...
static u32 hisi_sas_read32(struct hisi_hba *hisi_hba, u32 off)
{
	...
	return pete_readl("drivers/scsi/hisi_sas/hisi_sas_v3_hw.c:567", regs);
}
...
static void hisi_sas_write32(struct hisi_hba *hisi_hba, u32 off, u32 val)
{
	...
	pete_writel("drivers/scsi/hisi_sas/hisi_sas_v3_hw.c:574", val, regs);
}
				 ...
				 u32 off, u32 val)
{
	...
	pete_writel("drivers/scsi/hisi_sas/hisi_sas_v3_hw.c:582", val, regs);
}
				      ...
				      int phy_no, u32 off)
{
	...
	return pete_readl("drivers/scsi/hisi_sas/hisi_sas_v3_hw.c:590", regs);
}
