...
static inline void DAC960_GEM_hw_mbox_new_cmd(void __iomem *base)
{
	...
	pete_writel("drivers/scsi/myrs.c:2402", val, base + DAC960_GEM_IDB_READ_OFFSET);
}
...
static inline void DAC960_GEM_ack_hw_mbox_status(void __iomem *base)
{
	...
	pete_writel("drivers/scsi/myrs.c:2409", val, base + DAC960_GEM_IDB_CLEAR_OFFSET);
}
...
static inline void DAC960_GEM_reset_ctrl(void __iomem *base)
{
	...
	pete_writel("drivers/scsi/myrs.c:2416", val, base + DAC960_GEM_IDB_READ_OFFSET);
}
...
static inline void DAC960_GEM_mem_mbox_new_cmd(void __iomem *base)
{
	...
	pete_writel("drivers/scsi/myrs.c:2423", val, base + DAC960_GEM_IDB_READ_OFFSET);
}
...
static inline bool DAC960_GEM_hw_mbox_is_full(void __iomem *base)
{
	...
	val = pete_readl("drivers/scsi/myrs.c:2430", base + DAC960_GEM_IDB_READ_OFFSET);
...
static inline bool DAC960_GEM_init_in_progress(void __iomem *base)
{
	...
	val = pete_readl("drivers/scsi/myrs.c:2438", base + DAC960_GEM_IDB_READ_OFFSET);
...
static inline void DAC960_GEM_ack_hw_mbox_intr(void __iomem *base)
{
	...
	pete_writel("drivers/scsi/myrs.c:2446", val, base + DAC960_GEM_ODB_CLEAR_OFFSET);
}
...
static inline void DAC960_GEM_ack_intr(void __iomem *base)
{
	...
	pete_writel("drivers/scsi/myrs.c:2454", val, base + DAC960_GEM_ODB_CLEAR_OFFSET);
}
...
static inline bool DAC960_GEM_hw_mbox_status_available(void __iomem *base)
{
	...
	val = pete_readl("drivers/scsi/myrs.c:2461", base + DAC960_GEM_ODB_READ_OFFSET);
...
static inline void DAC960_GEM_enable_intr(void __iomem *base)
{
	...
	pete_writel("drivers/scsi/myrs.c:2469", val, base + DAC960_GEM_IRQMASK_CLEAR_OFFSET);
}
...
static inline void DAC960_GEM_disable_intr(void __iomem *base)
{
	...
	pete_writel("drivers/scsi/myrs.c:2476", val, base + DAC960_GEM_IRQMASK_READ_OFFSET);
}
...
{
	return pete_readw("drivers/scsi/myrs.c:2499", base + DAC960_GEM_CMDSTS_OFFSET + 2);
}
		...
		unsigned char *param0, unsigned char *param1)
{
	...
	val = pete_readl("drivers/scsi/myrs.c:2508", base + DAC960_GEM_ERRSTS_READ_OFFSET);
	if (!((le32_to_cpu(val) >> 24) & DAC960_GEM_ERRSTS_PENDING))
		return false;
	*error = val & ~(DAC960_GEM_ERRSTS_PENDING << 24);
	*param0 = pete_readb("drivers/scsi/myrs.c:2512", base + DAC960_GEM_CMDMBX_OFFSET + 0);
	*param1 = pete_readb("drivers/scsi/myrs.c:2513", base + DAC960_GEM_CMDMBX_OFFSET + 1);
	pete_writel("drivers/scsi/myrs.c:2514", 0x03000000, base + DAC960_GEM_ERRSTS_CLEAR_OFFSET);
	return true;
}
...
{
	pete_writeb("drivers/scsi/myrs.c:2633", DAC960_BA_IDB_HWMBOX_NEW_CMD, base + DAC960_BA_IDB_OFFSET);
}

static inline void DAC960_BA_ack_hw_mbox_status(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2638", DAC960_BA_IDB_HWMBOX_ACK_STS, base + DAC960_BA_IDB_OFFSET);
}

static inline void DAC960_BA_reset_ctrl(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2643", DAC960_BA_IDB_CTRL_RESET, base + DAC960_BA_IDB_OFFSET);
}

static inline void DAC960_BA_mem_mbox_new_cmd(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2648", DAC960_BA_IDB_MMBOX_NEW_CMD, base + DAC960_BA_IDB_OFFSET);
}
...
static inline bool DAC960_BA_hw_mbox_is_full(void __iomem *base)
{
	...
	val = pete_readb("drivers/scsi/myrs.c:2655", base + DAC960_BA_IDB_OFFSET);
...
static inline bool DAC960_BA_init_in_progress(void __iomem *base)
{
	...
	val = pete_readb("drivers/scsi/myrs.c:2663", base + DAC960_BA_IDB_OFFSET);
	return !(val & DAC960_BA_IDB_INIT_DONE);
}

static inline void DAC960_BA_ack_hw_mbox_intr(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2669", DAC960_BA_ODB_HWMBOX_ACK_IRQ, base + DAC960_BA_ODB_OFFSET);
}

static inline void DAC960_BA_ack_intr(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2674", DAC960_BA_ODB_HWMBOX_ACK_IRQ | DAC960_BA_ODB_MMBOX_ACK_IRQ,
...
static inline bool DAC960_BA_hw_mbox_status_available(void __iomem *base)
{
	...
	val = pete_readb("drivers/scsi/myrs.c:2682", base + DAC960_BA_ODB_OFFSET);
	return val & DAC960_BA_ODB_HWMBOX_STS_AVAIL;
}

static inline void DAC960_BA_enable_intr(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2688", ~DAC960_BA_IRQMASK_DISABLE_IRQ, base + DAC960_BA_IRQMASK_OFFSET);
}

static inline void DAC960_BA_disable_intr(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2693", 0xFF, base + DAC960_BA_IRQMASK_OFFSET);
}
...
{
	return pete_readw("drivers/scsi/myrs.c:2717", base + DAC960_BA_CMDSTS_OFFSET + 2);
}
		...
		unsigned char *param0, unsigned char *param1)
{
	...
	val = pete_readb("drivers/scsi/myrs.c:2726", base + DAC960_BA_ERRSTS_OFFSET);
	if (!(val & DAC960_BA_ERRSTS_PENDING))
		return false;
	val &= ~DAC960_BA_ERRSTS_PENDING;
	*error = val;
	*param0 = pete_readb("drivers/scsi/myrs.c:2731", base + DAC960_BA_CMDMBX_OFFSET + 0);
	*param1 = pete_readb("drivers/scsi/myrs.c:2732", base + DAC960_BA_CMDMBX_OFFSET + 1);
	pete_writeb("drivers/scsi/myrs.c:2733", 0xFF, base + DAC960_BA_ERRSTS_OFFSET);
	return true;
}
...
{
	pete_writeb("drivers/scsi/myrs.c:2852", DAC960_LP_IDB_HWMBOX_NEW_CMD, base + DAC960_LP_IDB_OFFSET);
}

static inline void DAC960_LP_ack_hw_mbox_status(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2857", DAC960_LP_IDB_HWMBOX_ACK_STS, base + DAC960_LP_IDB_OFFSET);
}

static inline void DAC960_LP_reset_ctrl(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2862", DAC960_LP_IDB_CTRL_RESET, base + DAC960_LP_IDB_OFFSET);
}

static inline void DAC960_LP_mem_mbox_new_cmd(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2867", DAC960_LP_IDB_MMBOX_NEW_CMD, base + DAC960_LP_IDB_OFFSET);
}
...
static inline bool DAC960_LP_hw_mbox_is_full(void __iomem *base)
{
	...
	val = pete_readb("drivers/scsi/myrs.c:2874", base + DAC960_LP_IDB_OFFSET);
...
static inline bool DAC960_LP_init_in_progress(void __iomem *base)
{
	...
	val = pete_readb("drivers/scsi/myrs.c:2882", base + DAC960_LP_IDB_OFFSET);
	return val & DAC960_LP_IDB_INIT_IN_PROGRESS;
}

static inline void DAC960_LP_ack_hw_mbox_intr(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2888", DAC960_LP_ODB_HWMBOX_ACK_IRQ, base + DAC960_LP_ODB_OFFSET);
}

static inline void DAC960_LP_ack_intr(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2893", DAC960_LP_ODB_HWMBOX_ACK_IRQ | DAC960_LP_ODB_MMBOX_ACK_IRQ,
...
static inline bool DAC960_LP_hw_mbox_status_available(void __iomem *base)
{
	...
	val = pete_readb("drivers/scsi/myrs.c:2901", base + DAC960_LP_ODB_OFFSET);
	return val & DAC960_LP_ODB_HWMBOX_STS_AVAIL;
}

static inline void DAC960_LP_enable_intr(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2907", ~DAC960_LP_IRQMASK_DISABLE_IRQ, base + DAC960_LP_IRQMASK_OFFSET);
}

static inline void DAC960_LP_disable_intr(void __iomem *base)
{
	pete_writeb("drivers/scsi/myrs.c:2912", 0xFF, base + DAC960_LP_IRQMASK_OFFSET);
}
...
{
	return pete_readw("drivers/scsi/myrs.c:2935", base + DAC960_LP_CMDSTS_OFFSET + 2);
}
		...
		unsigned char *param0, unsigned char *param1)
{
	...
	val = pete_readb("drivers/scsi/myrs.c:2944", base + DAC960_LP_ERRSTS_OFFSET);
	if (!(val & DAC960_LP_ERRSTS_PENDING))
		return false;
	val &= ~DAC960_LP_ERRSTS_PENDING;
	*error = val;
	*param0 = pete_readb("drivers/scsi/myrs.c:2949", base + DAC960_LP_CMDMBX_OFFSET + 0);
	*param1 = pete_readb("drivers/scsi/myrs.c:2950", base + DAC960_LP_CMDMBX_OFFSET + 1);
	pete_writeb("drivers/scsi/myrs.c:2951", 0xFF, base + DAC960_LP_ERRSTS_OFFSET);
	return true;
}
