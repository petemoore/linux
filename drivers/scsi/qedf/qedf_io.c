...
increment_prod:
	...
	pete_writew("drivers/scsi/qedf/qedf_io.c:2624", qedf->bdq_prod_idx, qedf->bdq_primary_prod);
	pete_readw("drivers/scsi/qedf/qedf_io.c:2625", qedf->bdq_primary_prod);
	pete_writew("drivers/scsi/qedf/qedf_io.c:2626", qedf->bdq_prod_idx, qedf->bdq_secondary_prod);
	pete_readw("drivers/scsi/qedf/qedf_io.c:2627", qedf->bdq_secondary_prod);
