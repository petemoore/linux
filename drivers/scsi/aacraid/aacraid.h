...
#define sa_readw(AEP, CSR)		pete_readl("drivers/scsi/aacraid/aacraid.h:1083", &((AEP)->regs.sa->CSR))
#define sa_readl(AEP, CSR)		pete_readl("drivers/scsi/aacraid/aacraid.h:1084", &((AEP)->regs.sa->CSR))
#define sa_writew(AEP, CSR, value)	pete_writew("drivers/scsi/aacraid/aacraid.h:1085", value, &((AEP)->regs.sa->CSR))
#define sa_writel(AEP, CSR, value)	pete_writel("drivers/scsi/aacraid/aacraid.h:1086", value, &((AEP)->regs.sa->CSR))
...
#define rx_readb(AEP, CSR)		pete_readb("drivers/scsi/aacraid/aacraid.h:1145", &((AEP)->regs.rx->CSR))
#define rx_readl(AEP, CSR)		pete_readl("drivers/scsi/aacraid/aacraid.h:1146", &((AEP)->regs.rx->CSR))
#define rx_writeb(AEP, CSR, value)	pete_writeb("drivers/scsi/aacraid/aacraid.h:1147", value, &((AEP)->regs.rx->CSR))
#define rx_writel(AEP, CSR, value)	pete_writel("drivers/scsi/aacraid/aacraid.h:1148", value, &((AEP)->regs.rx->CSR))
...
#define rkt_readb(AEP, CSR)		pete_readb("drivers/scsi/aacraid/aacraid.h:1163", &((AEP)->regs.rkt->CSR))
#define rkt_readl(AEP, CSR)		pete_readl("drivers/scsi/aacraid/aacraid.h:1164", &((AEP)->regs.rkt->CSR))
#define rkt_writeb(AEP, CSR, value)	pete_writeb("drivers/scsi/aacraid/aacraid.h:1165", value, &((AEP)->regs.rkt->CSR))
#define rkt_writel(AEP, CSR, value)	pete_writel("drivers/scsi/aacraid/aacraid.h:1166", value, &((AEP)->regs.rkt->CSR))
...
#define src_readb(AEP, CSR)		pete_readb("drivers/scsi/aacraid/aacraid.h:1211", &((AEP)->regs.src.bar0->CSR))
#define src_readl(AEP, CSR)		pete_readl("drivers/scsi/aacraid/aacraid.h:1212", &((AEP)->regs.src.bar0->CSR))
#define src_writeb(AEP, CSR, value)	pete_writeb("drivers/scsi/aacraid/aacraid.h:1213", value, \
						&((AEP)->regs.src.bar0->CSR))
#define src_writel(AEP, CSR, value)	pete_writel("drivers/scsi/aacraid/aacraid.h:1215", value, \
						&((AEP)->regs.src.bar0->CSR))
#if defined(writeq)
#define	src_writeq(AEP, CSR, value)	pete_writeq("drivers/scsi/aacraid/aacraid.h:1218", value, \
						&((AEP)->regs.src.bar0->CSR))
#endif
