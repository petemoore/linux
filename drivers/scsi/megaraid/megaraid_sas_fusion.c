		    ...
		    struct megasas_irq_context *irq_context)
{
	...
	while (d_val.u.low != cpu_to_le32(UINT_MAX) &&
		...
		if (threshold_reply_count >= instance->threshold_reply_count) {
			if (instance->msix_combined)
				pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:3687", ((MSIxIndex & 0x7) << 24) |
					fusion->last_reply_idx[MSIxIndex],
					instance->reply_post_host_index_addr[MSIxIndex/8]);
			else
				pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:3691", (MSIxIndex << 24) |
					fusion->last_reply_idx[MSIxIndex],
	...
	if (num_completed) {
		wmb();
		if (instance->msix_combined)
			pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:3710", ((MSIxIndex & 0x7) << 24) |
				fusion->last_reply_idx[MSIxIndex],
				instance->reply_post_host_index_addr[MSIxIndex/8]);
		else
			pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:3714", (MSIxIndex << 24) |
				fusion->last_reply_idx[MSIxIndex],
				instance->reply_post_host_index_addr[0]);
			 ...
			 struct megasas_register_set __iomem *regs)
{
	...
	pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4059", MPI2_WRSEQ_FLUSH_KEY_VALUE, &instance->reg_set->fusion_seq_offset);
	pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4060", MPI2_WRSEQ_1ST_KEY_VALUE, &instance->reg_set->fusion_seq_offset);
	pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4061", MPI2_WRSEQ_2ND_KEY_VALUE, &instance->reg_set->fusion_seq_offset);
	pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4062", MPI2_WRSEQ_3RD_KEY_VALUE, &instance->reg_set->fusion_seq_offset);
	pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4063", MPI2_WRSEQ_4TH_KEY_VALUE, &instance->reg_set->fusion_seq_offset);
	pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4064", MPI2_WRSEQ_5TH_KEY_VALUE, &instance->reg_set->fusion_seq_offset);
	pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4065", MPI2_WRSEQ_6TH_KEY_VALUE, &instance->reg_set->fusion_seq_offset);
	...
	pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4085", host_diag | HOST_DIAG_RESET_ADAPTER,
		&instance->reg_set->fusion_host_diag);
	msleep(3000);
...
static inline void megasas_trigger_snap_dump(struct megasas_instance *instance)
{
	...
	if (!instance->disableOnlineCtrlReset) {
		...
		pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4148", MFI_ADP_TRIGGER_SNAP_DUMP,
		       &instance->reg_set->doorbell);
		pete_readl("drivers/scsi/megaraid/megaraid_sas_fusion.c:4150", &instance->reg_set->doorbell);
	}
...
int megasas_reset_fusion(struct Scsi_Host *shost, int reason)
{
	...
	if (abs_state != MFI_STATE_FAULT && instance->crash_dump_buf &&
		...
		pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:4941", status_reg | MFI_STATE_FORCE_OCR,
			&instance->reg_set->doorbell);
		pete_readl("drivers/scsi/megaraid/megaraid_sas_fusion.c:4943", &instance->reg_set->doorbell);
		mutex_unlock(&instance->reset_mutex);
		do {
			ssleep(3);
...
static void  megasas_fusion_crash_dump(struct megasas_instance *instance)
{
	...
	if (instance->drv_buf_index == 0) {
		...
		if (instance->drv_buf_alloc) {
			...
			pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:5218", status_reg,
				&instance->reg_set->outbound_scratch_pad_0);
			pete_readl("drivers/scsi/megaraid/megaraid_sas_fusion.c:5220", &instance->reg_set->outbound_scratch_pad_0);
			return;
		}
	...
	while (!(status_reg & MFI_STATE_CRASH_DUMP_DONE) &&
		...
		pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:5258", status_reg, &instance->reg_set->outbound_scratch_pad_0);
		pete_readl("drivers/scsi/megaraid/megaraid_sas_fusion.c:5259", &instance->reg_set->outbound_scratch_pad_0);
	...
	if (status_reg & MFI_STATE_CRASH_DUMP_DONE) {
		...
		instance->drv_buf_index = 0;
		pete_writel("drivers/scsi/megaraid/megaraid_sas_fusion.c:5271", status_reg, &instance->reg_set->outbound_scratch_pad_0);
		pete_readl("drivers/scsi/megaraid/megaraid_sas_fusion.c:5272", &instance->reg_set->outbound_scratch_pad_0);
		if (!partial_copy)
