...
{
	if (dir) {
		pete_writeb("drivers/comedi/drivers/comedi_8255.c:55", data, dev->mmio + regbase + port);
		return 0;
	}
	return pete_readb("drivers/comedi/drivers/comedi_8255.c:58", dev->mmio + regbase + port);
}
