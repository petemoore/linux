			   ...
			   unsigned int cmd, unsigned int reg)
{
	...
	pete_writel("drivers/comedi/drivers/s626.c:110", val, dev->mmio + reg);
}

static void s626_mc_disable(struct comedi_device *dev,
			    unsigned int cmd, unsigned int reg)
{
	pete_writel("drivers/comedi/drivers/s626.c:116", cmd << 16, dev->mmio + reg);
}
			 ...
			 unsigned int cmd, unsigned int reg)
{
	...
	val = pete_readl("drivers/comedi/drivers/s626.c:124", dev->mmio + reg);
...
static void s626_debi_transfer(struct comedi_device *dev)
{
	...
	for (i = 0; i < timeout; i++) {
		if (!(pete_readl("drivers/comedi/drivers/s626.c:167", dev->mmio + S626_P_PSR) & S626_PSR_DEBI_S))
			break;
		udelay(1);
	}
	if (i == timeout)
...
static u16 s626_debi_read(struct comedi_device *dev, u16 addr)
{
	...
	pete_writel("drivers/comedi/drivers/s626.c:181", S626_DEBI_CMD_RDWORD | addr, dev->mmio + S626_P_DEBICMD);

	/*  Execute the DEBI transfer. */
	s626_debi_transfer(dev);

	return pete_readl("drivers/comedi/drivers/s626.c:186", dev->mmio + S626_P_DEBIAD);
}
...
{
	/* Set up DEBI control register value in shadow RAM */
	pete_writel("drivers/comedi/drivers/s626.c:196", S626_DEBI_CMD_WRWORD | addr, dev->mmio + S626_P_DEBICMD);
	pete_writel("drivers/comedi/drivers/s626.c:197", wdata, dev->mmio + S626_P_DEBIAD);
			      ...
			      unsigned int mask, unsigned int wdata)
{
	...
	addr &= 0xffff;
	pete_writel("drivers/comedi/drivers/s626.c:214", S626_DEBI_CMD_RDWORD | addr, dev->mmio + S626_P_DEBICMD);
	s626_debi_transfer(dev);

	pete_writel("drivers/comedi/drivers/s626.c:217", S626_DEBI_CMD_WRWORD | addr, dev->mmio + S626_P_DEBICMD);
	val = pete_readl("drivers/comedi/drivers/s626.c:218", dev->mmio + S626_P_DEBIAD);
	val &= mask;
	val |= wdata;
	pete_writel("drivers/comedi/drivers/s626.c:221", val & 0xffff, dev->mmio + S626_P_DEBIAD);
	s626_debi_transfer(dev);
}
...
static int s626_i2c_handshake(struct comedi_device *dev, u32 val)
{
	...
	pete_writel("drivers/comedi/drivers/s626.c:246", val, dev->mmio + S626_P_I2CCTRL);
	...
	do {
		ctrl = pete_readl("drivers/comedi/drivers/s626.c:259", dev->mmio + S626_P_I2CCTRL);
...
static u8 s626_i2c_read(struct comedi_device *dev, u8 addr)
{
	...
	return (pete_readl("drivers/comedi/drivers/s626.c:297", dev->mmio + S626_P_I2CCTRL) >> 16) & 0xff;
}
			     ...
			     unsigned long context)
{
	...
	case s626_send_dac_wait_not_mc1_a2out:
		status = pete_readl("drivers/comedi/drivers/s626.c:326", dev->mmio + S626_P_MC1);
		if (!(status & S626_MC1_A2OUT))
			return 0;
		break;
	case s626_send_dac_wait_ssr_af2_out:
		status = pete_readl("drivers/comedi/drivers/s626.c:331", dev->mmio + S626_P_SSR);
		if (status & S626_SSR_AF2_OUT)
			return 0;
		break;
	case s626_send_dac_wait_fb_buffer2_msb_00:
		status = pete_readl("drivers/comedi/drivers/s626.c:336", dev->mmio + S626_P_FB_BUFFER2);
		if (!(status & 0xff000000))
			return 0;
		break;
	case s626_send_dac_wait_fb_buffer2_msb_ff:
		status = pete_readl("drivers/comedi/drivers/s626.c:341", dev->mmio + S626_P_FB_BUFFER2);
		if (status & 0xff000000)
			return 0;
		break;
	default:
...
static int s626_send_dac(struct comedi_device *dev, u32 val)
{
	...
	/* pete_writel("drivers/comedi/drivers/s626.c:378", val, dev->mmio + (uint32_t)devpriv->dac_wbuf); */
	*devpriv->dac_wbuf = val;
	 ...
	 */
	pete_writel("drivers/comedi/drivers/s626.c:396", S626_ISR_AFOU, dev->mmio + S626_P_ISR);
	 ...
	 * detection.
	 */
	pete_writel("drivers/comedi/drivers/s626.c:420", S626_XSD2 | S626_RSD3 | S626_SIB_A2,
	 ...
	 * buffer register.
	 */
	pete_writel("drivers/comedi/drivers/s626.c:445", S626_XSD2 | S626_XFIFO_2 | S626_RSD2 | S626_SIB_A2 | S626_EOS,
	       dev->mmio + S626_VECTPORT(0));
	 ...
	 */
	if (pete_readl("drivers/comedi/drivers/s626.c:468", dev->mmio + S626_P_FB_BUFFER2) & 0xff000000) {
		/*
	 ...
	 */
	pete_writel("drivers/comedi/drivers/s626.c:493", S626_RSD3 | S626_SIB_A2 | S626_EOS,
	       dev->mmio + S626_VECTPORT(0));
			...
			u16 chan, int16_t dacdata)
{
	...
	pete_writel("drivers/comedi/drivers/s626.c:551", S626_XSD2 | S626_XFIFO_1 | ws_image,
	       dev->mmio + S626_VECTPORT(2));
	/* Slot 3: Transmit low data byte to target DAC */
	pete_writel("drivers/comedi/drivers/s626.c:554", S626_XSD2 | S626_XFIFO_0 | ws_image,
	       dev->mmio + S626_VECTPORT(3));
	/* Slot 4: Transmit to non-existent TrimDac channel to keep clock */
	pete_writel("drivers/comedi/drivers/s626.c:557", S626_XSD2 | S626_XFIFO_3 | S626_WS3,
	       dev->mmio + S626_VECTPORT(4));
	/* Slot 5: running after writing target DAC's low data byte */
	pete_writel("drivers/comedi/drivers/s626.c:560", S626_XSD2 | S626_XFIFO_2 | S626_WS3 | S626_EOS,
			       ...
			       u8 logical_chan, u8 dac_data)
{
	...
	pete_writel("drivers/comedi/drivers/s626.c:605", S626_XSD2 | S626_XFIFO_1 | S626_WS3,
	       dev->mmio + S626_VECTPORT(2));
	/* Slot 3: Send low uint8_t to target TrimDac */
	pete_writel("drivers/comedi/drivers/s626.c:608", S626_XSD2 | S626_XFIFO_0 | S626_WS3,
	       dev->mmio + S626_VECTPORT(3));
	/* Slot 4: Send NOP high uint8_t to DAC0 to keep clock running */
	pete_writel("drivers/comedi/drivers/s626.c:611", S626_XSD2 | S626_XFIFO_3 | S626_WS1,
	       dev->mmio + S626_VECTPORT(4));
	/* Slot 5: Send NOP low  uint8_t to DAC0 */
	pete_writel("drivers/comedi/drivers/s626.c:614", S626_XSD2 | S626_XFIFO_2 | S626_WS1 | S626_EOS,
	       dev->mmio + S626_VECTPORT(5));
...
static irqreturn_t s626_irq_handler(int irq, void *d)
{
	...
	irqstatus = pete_readl("drivers/comedi/drivers/s626.c:1241", dev->mmio + S626_P_IER);

	/* read interrupt type */
	irqtype = pete_readl("drivers/comedi/drivers/s626.c:1244", dev->mmio + S626_P_ISR);

	/* disable master interrupt */
	pete_writel("drivers/comedi/drivers/s626.c:1247", 0, dev->mmio + S626_P_IER);

	/* clear interrupt */
	pete_writel("drivers/comedi/drivers/s626.c:1250", irqtype, dev->mmio + S626_P_ISR);
	...
	/* enable interrupt */
	pete_writel("drivers/comedi/drivers/s626.c:1265", irqstatus, dev->mmio + S626_P_IER);
...
static void s626_reset_adc(struct comedi_device *dev, u8 *ppl)
{
	...
	pete_writel("drivers/comedi/drivers/s626.c:1292", (u32)devpriv->rps_buf.physical_base,
		       ...
		       unsigned long context)
{
	...
	status = pete_readl("drivers/comedi/drivers/s626.c:1478", dev->mmio + S626_P_PSR);
			     ...
			     unsigned int *data)
{
	...
	for (n = 0; n < insn->n; n++) {
		...
		gpio_image = pete_readl("drivers/comedi/drivers/s626.c:1517", dev->mmio + S626_P_GPIO);
		/* Assert ADC Start command */
		pete_writel("drivers/comedi/drivers/s626.c:1519", gpio_image & ~S626_GPIO1_HI, dev->mmio + S626_P_GPIO);
		/* and stretch it out */
		pete_writel("drivers/comedi/drivers/s626.c:1521", gpio_image & ~S626_GPIO1_HI, dev->mmio + S626_P_GPIO);
		pete_writel("drivers/comedi/drivers/s626.c:1522", gpio_image & ~S626_GPIO1_HI, dev->mmio + S626_P_GPIO);
		/* Negate ADC Start command */
		pete_writel("drivers/comedi/drivers/s626.c:1524", gpio_image | S626_GPIO1_HI, dev->mmio + S626_P_GPIO);
		...
		/* Fetch ADC data */
		if (n != 0) {
			tmp = pete_readl("drivers/comedi/drivers/s626.c:1539", dev->mmio + S626_P_FB_BUFFER1);
	 ...
	 */
	gpio_image = pete_readl("drivers/comedi/drivers/s626.c:1559", dev->mmio + S626_P_GPIO);
	/* Assert ADC Start command */
	pete_writel("drivers/comedi/drivers/s626.c:1561", gpio_image & ~S626_GPIO1_HI, dev->mmio + S626_P_GPIO);
	/* and stretch it out */
	pete_writel("drivers/comedi/drivers/s626.c:1563", gpio_image & ~S626_GPIO1_HI, dev->mmio + S626_P_GPIO);
	pete_writel("drivers/comedi/drivers/s626.c:1564", gpio_image & ~S626_GPIO1_HI, dev->mmio + S626_P_GPIO);
	/* Negate ADC Start command */
	pete_writel("drivers/comedi/drivers/s626.c:1566", gpio_image | S626_GPIO1_HI, dev->mmio + S626_P_GPIO);
	...
	/* Fetch ADC data */
	if (n != 0) {
		tmp = pete_readl("drivers/comedi/drivers/s626.c:1579", dev->mmio + S626_P_FB_BUFFER1);
		data[n - 1] = s626_ai_reg_to_uint(tmp);
	}
...
static int s626_ai_cmd(struct comedi_device *dev, struct comedi_subdevice *s)
{
	...
	/* disable interrupt */
	pete_writel("drivers/comedi/drivers/s626.c:1704", 0, dev->mmio + S626_P_IER);

	/* clear interrupt request */
	pete_writel("drivers/comedi/drivers/s626.c:1707", S626_IRQ_RPS1 | S626_IRQ_GPIO3, dev->mmio + S626_P_ISR);
	...
	/* enable interrupt */
	pete_writel("drivers/comedi/drivers/s626.c:1785", S626_IRQ_GPIO3 | S626_IRQ_RPS1, dev->mmio + S626_P_IER);
...
static int s626_ai_cancel(struct comedi_device *dev, struct comedi_subdevice *s)
{
	...
	/* disable master interrupt */
	pete_writel("drivers/comedi/drivers/s626.c:1912", 0, dev->mmio + S626_P_IER);
...
static int s626_initialize(struct comedi_device *dev)
{
	 ...
	 */
	pete_writel("drivers/comedi/drivers/s626.c:2187", S626_DEBI_CFG_SLAVE16 |
	       (S626_DEBI_TOUT << S626_DEBI_CFG_TOUT_BIT) | S626_DEBI_SWAP |
	       S626_DEBI_CFG_INTEL, dev->mmio + S626_P_DEBICFG);

	/* Disable MMU paging */
	pete_writel("drivers/comedi/drivers/s626.c:2192", S626_DEBI_PAGE_DISABLE, dev->mmio + S626_P_DEBIPAGE);

	/* Init GPIO so that ADC Start* is negated */
	pete_writel("drivers/comedi/drivers/s626.c:2195", S626_GPIO_BASE | S626_GPIO1_HI, dev->mmio + S626_P_GPIO);
	 ...
	 */
	pete_writel("drivers/comedi/drivers/s626.c:2204", S626_I2C_CLKSEL | S626_I2C_ABORT,
	 ...
	 */
	for (i = 0; i < 2; i++) {
		pete_writel("drivers/comedi/drivers/s626.c:2216", S626_I2C_CLKSEL, dev->mmio + S626_P_I2CSTAT);
		s626_mc_enable(dev, S626_MC2_UPLD_IIC, S626_P_MC2);
	 ...
	 * clock out.
	 */
	pete_writel("drivers/comedi/drivers/s626.c:2230", S626_ACON2_INIT, dev->mmio + S626_P_ACON2);
	 ...
	 */
	pete_writel("drivers/comedi/drivers/s626.c:2238", S626_RSD1 | S626_SIB_A1, dev->mmio + S626_P_TSL1);
	pete_writel("drivers/comedi/drivers/s626.c:2239", S626_RSD1 | S626_SIB_A1 | S626_EOS,
	       dev->mmio + S626_P_TSL1 + 4);

	/* Enable TSL1 slot list so that it executes all the time */
	pete_writel("drivers/comedi/drivers/s626.c:2243", S626_ACON1_ADCSTART, dev->mmio + S626_P_ACON1);
	...
	pete_writel("drivers/comedi/drivers/s626.c:2250", (u32)devpriv->rps_buf.physical_base,
	       dev->mmio + S626_P_RPSADDR1);
	/* RPS program performs no explicit mem writes */
	pete_writel("drivers/comedi/drivers/s626.c:2253", 0, dev->mmio + S626_P_RPSPAGE1);
	/* Disable RPS timeouts */
	pete_writel("drivers/comedi/drivers/s626.c:2255", 0, dev->mmio + S626_P_RPS1_TOUT);
	 ...
	 *   threshold = 1 DWORD.
	 */
	pete_writel("drivers/comedi/drivers/s626.c:2311", 0, dev->mmio + S626_P_PCI_BT_A);
	...
	pete_writel("drivers/comedi/drivers/s626.c:2321", (u32)phys_buf, dev->mmio + S626_P_BASEA2_OUT);
	pete_writel("drivers/comedi/drivers/s626.c:2322", (u32)(phys_buf + sizeof(u32)),
	 ...
	 */
	pete_writel("drivers/comedi/drivers/s626.c:2338", 8, dev->mmio + S626_P_PAGEA2_OUT);
	...
	pete_writel("drivers/comedi/drivers/s626.c:2353", S626_XSD2 | S626_RSD3 | S626_SIB_A2 | S626_EOS,
	       dev->mmio + S626_VECTPORT(0));
	...
	pete_writel("drivers/comedi/drivers/s626.c:2366", S626_LF_A2, dev->mmio + S626_VECTPORT(1));

	/* Start DAC's audio interface (TSL2) running */
	pete_writel("drivers/comedi/drivers/s626.c:2369", S626_ACON1_DACSTART, dev->mmio + S626_P_ACON1);
			    ...
			    unsigned long context_unused)
{
	...
	/* disable master interrupt */
	pete_writel("drivers/comedi/drivers/s626.c:2438", 0, dev->mmio + S626_P_IER);

	/* soft reset */
	pete_writel("drivers/comedi/drivers/s626.c:2441", S626_MC1_SOFT_RESET, dev->mmio + S626_P_MC1);
...
static void s626_detach(struct comedi_device *dev)
{
	...
	if (devpriv) {
		...
		if (dev->mmio) {
			/* interrupt mask */
			/* Disable master interrupt */
			pete_writel("drivers/comedi/drivers/s626.c:2552", 0, dev->mmio + S626_P_IER);
			/* Clear board's IRQ status flag */
			pete_writel("drivers/comedi/drivers/s626.c:2554", S626_IRQ_GPIO3 | S626_IRQ_RPS1,
			       dev->mmio + S626_P_ISR);
			...
			pete_writel("drivers/comedi/drivers/s626.c:2561", S626_MC1_SHUTDOWN, dev->mmio + S626_P_MC1);
			pete_writel("drivers/comedi/drivers/s626.c:2562", S626_ACON1_BASE, dev->mmio + S626_P_ACON1);
		}
	}
