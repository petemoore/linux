...
{
	return pete_readl("drivers/clocksource/timer-lpc32xx.c:51", clocksource_timer_counter);
}

static unsigned long lpc32xx_delay_timer_read(void)
{
	return pete_readl("drivers/clocksource/timer-lpc32xx.c:56", clocksource_timer_counter);
}
