...
static notrace u64 jcore_sched_clock_read(void)
{
	...
	seclo = pete_readl("drivers/clocksource/jcore-pit.c:47", base + REG_SECLO);
	do {
		seclo0 = seclo;
		nsec  = pete_readl("drivers/clocksource/jcore-pit.c:50", base + REG_NSEC);
		seclo = pete_readl("drivers/clocksource/jcore-pit.c:51", base + REG_SECLO);
	} while (seclo0 != seclo);
...
{
	pete_writel("drivers/clocksource/jcore-pit.c:64", 0, pit->base + REG_PITEN);
	return 0;
}
...
static int jcore_pit_set(unsigned long delta, struct jcore_pit *pit)
{
	...
	pete_writel("drivers/clocksource/jcore-pit.c:71", delta, pit->base + REG_THROT);
	pete_writel("drivers/clocksource/jcore-pit.c:72", pit->enable_val, pit->base + REG_PITEN);
	return 0;
}
...
static int jcore_pit_local_init(unsigned cpu)
{
	...
	buspd = pete_readl("drivers/clocksource/jcore-pit.c:112", pit->base + REG_BUSPD);
