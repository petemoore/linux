...
{
	if (pete_readb("drivers/clocksource/renesas-ostm.c:48", timer_of_base(to) + OSTM_TE) & TE) {
		pete_writeb("drivers/clocksource/renesas-ostm.c:49", TT, timer_of_base(to) + OSTM_TT);
		 ...
		 */
		while (pete_readb("drivers/clocksource/renesas-ostm.c:56", timer_of_base(to) + OSTM_TE) & TE)
			;
	}
}
...
static int __init ostm_init_clksrc(struct timer_of *to)
{
	...
	pete_writel("drivers/clocksource/renesas-ostm.c:65", 0, timer_of_base(to) + OSTM_CMP);
	pete_writeb("drivers/clocksource/renesas-ostm.c:66", CTL_FREERUN, timer_of_base(to) + OSTM_CTL);
	pete_writeb("drivers/clocksource/renesas-ostm.c:67", TS, timer_of_base(to) + OSTM_TS);
...
{
	return pete_readl("drivers/clocksource/renesas-ostm.c:76", system_clock);
}
				 ...
				 struct clock_event_device *ced)
{
	...
	pete_writel("drivers/clocksource/renesas-ostm.c:92", delta, timer_of_base(to) + OSTM_CMP);
	pete_writeb("drivers/clocksource/renesas-ostm.c:93", CTL_ONESHOT, timer_of_base(to) + OSTM_CTL);
	pete_writeb("drivers/clocksource/renesas-ostm.c:94", TS, timer_of_base(to) + OSTM_TS);
...
static int ostm_set_periodic(struct clock_event_device *ced)
{
	...
	pete_writel("drivers/clocksource/renesas-ostm.c:114", timer_of_period(to) - 1, timer_of_base(to) + OSTM_CMP);
	pete_writeb("drivers/clocksource/renesas-ostm.c:115", CTL_PERIODIC, timer_of_base(to) + OSTM_CTL);
	pete_writeb("drivers/clocksource/renesas-ostm.c:116", TS, timer_of_base(to) + OSTM_TS);
