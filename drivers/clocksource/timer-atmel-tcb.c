...
static void __init tcb_setup_dual_chan(struct atmel_tc *tc, int mck_divisor_idx)
{
	...
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:322", 0x0000, tcaddr + ATMEL_TC_REG(0, RA));
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:323", 0x8000, tcaddr + ATMEL_TC_REG(0, RC));
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:324", 0xff, tcaddr + ATMEL_TC_REG(0, IDR));	/* no irqs */
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:325", ATMEL_TC_CLKEN, tcaddr + ATMEL_TC_REG(0, CCR));

	/* channel 1:  waveform mode, input TIOA0 */
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:328", ATMEL_TC_XC1			/* input: TIOA0 */
			| ATMEL_TC_WAVE
			| ATMEL_TC_WAVESEL_UP,		/* free-run */
			tcaddr + ATMEL_TC_REG(1, CMR));
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:332", 0xff, tcaddr + ATMEL_TC_REG(1, IDR));	/* no irqs */
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:333", ATMEL_TC_CLKEN, tcaddr + ATMEL_TC_REG(1, CCR));

	/* chain channel 0 to channel 1*/
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:336", ATMEL_TC_TC1XC1S_TIOA0, tcaddr + ATMEL_TC_BMR);
	/* then reset all the timers */
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:338", ATMEL_TC_SYNC, tcaddr + ATMEL_TC_BCR);
}

static void __init tcb_setup_single_chan(struct atmel_tc *tc, int mck_divisor_idx)
{
	/* channel 0:  waveform mode, input mclk/8 */
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:344", mck_divisor_idx			/* likely divide-by-8 */
			| ATMEL_TC_WAVE
			| ATMEL_TC_WAVESEL_UP,		/* free-run */
			tcaddr + ATMEL_TC_REG(0, CMR));
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:348", 0xff, tcaddr + ATMEL_TC_REG(0, IDR));	/* no irqs */
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:349", ATMEL_TC_CLKEN, tcaddr + ATMEL_TC_REG(0, CCR));

	/* then reset all the timers */
	pete_writel("drivers/clocksource/timer-atmel-tcb.c:352", ATMEL_TC_SYNC, tcaddr + ATMEL_TC_BCR);
}
...
static int __init tcb_clksrc_init(struct device_node *node)
{
	...
	for (i = 0; i < ARRAY_SIZE(tc.irq); i++)
		pete_writel("drivers/clocksource/timer-atmel-tcb.c:426", ATMEL_TC_ALL_IRQ, tc.regs + ATMEL_TC_REG(i, IDR));
