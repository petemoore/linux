					  ...
					  *init_params)
{
	...
	pete_writel("drivers/irqchip/irq-brcmstb-l2.c:196", 0xffffffff, base + init_params->cpu_mask_set);

	/* Wakeup interrupts may be retained from S5 (cold boot) */
	data->can_wake = of_property_read_bool(np, "brcm,irq-can-wake");
	if (!data->can_wake && (init_params->cpu_clear >= 0))
		pete_writel("drivers/irqchip/irq-brcmstb-l2.c:201", 0xffffffff, base + init_params->cpu_clear);
