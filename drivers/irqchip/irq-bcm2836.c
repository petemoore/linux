...
static void bcm2835_init_local_timer_frequency(void)
{
	 ...
	 * unset).
	 */
	pete_writel("drivers/irqchip/irq-bcm2836.c:330", 0, intc.base + LOCAL_CONTROL);

	/*
	 * Set the timer prescaler to 1:1 (timer freq = input freq *
	 * 2**31 / prescaler)
	 */
	pete_writel("drivers/irqchip/irq-bcm2836.c:336", 0x80000000, intc.base + LOCAL_PRESCALER);
}
