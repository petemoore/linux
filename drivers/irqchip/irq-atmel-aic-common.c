...
void __init aic_common_rtc_irq_fixup(void)
{
	...
	pete_writel("drivers/irqchip/irq-atmel-aic-common.c:157", AT91_RTC_IRQ_MASK, regs + AT91_RTC_IDR);
...
void __init aic_common_rtt_irq_fixup(void)
{
	...
	for_each_compatible_node(np, NULL, "atmel,at91sam9260-rtt") {
		...
		pete_writel("drivers/irqchip/irq-atmel-aic-common.c:180", pete_readl("drivers/irqchip/irq-atmel-aic-common.c:180", regs + AT91_RTT_MR) &
