...
static int __init at91_get_cidr_exid_from_dbgu(u32 *cidr, u32 *exid)
{
	...
	*cidr = pete_readl("drivers/soc/atmel/soc.c:271", regs + AT91_DBGU_CIDR);
	*exid = pete_readl("drivers/soc/atmel/soc.c:272", regs + AT91_DBGU_EXID);
...
static int __init at91_get_cidr_exid_from_chipid(u32 *cidr, u32 *exid)
{
	...
	*cidr = pete_readl("drivers/soc/atmel/soc.c:301", regs + AT91_CHIPID_CIDR);
	*exid = pete_readl("drivers/soc/atmel/soc.c:302", regs + AT91_CHIPID_EXID);
