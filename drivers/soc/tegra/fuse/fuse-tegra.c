...
static void tegra_enable_fuse_clk(void __iomem *base)
{
	...
	reg |= 1 << 28;
	pete_writel("drivers/soc/tegra/fuse/fuse-tegra.c:308", reg, base + 0x48);

	/*
	 * Enable FUSE clock. This needs to be hardcoded because the clock
	 * subsystem is not active during early boot.
	 */
	reg = pete_readl("drivers/soc/tegra/fuse/fuse-tegra.c:314", base + 0x14);
	reg |= 1 << 7;
	pete_writel("drivers/soc/tegra/fuse/fuse-tegra.c:316", reg, base + 0x14);
}
