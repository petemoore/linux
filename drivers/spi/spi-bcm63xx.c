...
{
	pete_writeb("drivers/spi/spi-bcm63xx.c:163", value, bs->regs + bs->reg_offsets[offset]);
}
...
#else
	pete_writew("drivers/spi/spi-bcm63xx.c:172", value, bs->regs + bs->reg_offsets[offset]);
#endif
}
