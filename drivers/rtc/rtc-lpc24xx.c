...
#define rtc_readl(dev, reg)		pete_readl("drivers/rtc/rtc-lpc24xx.c:58", (dev)->rtc_base + (reg))
#define rtc_writel(dev, reg, val)	pete_writel("drivers/rtc/rtc-lpc24xx.c:59", (val), (dev)->rtc_base + (reg))
