...
static unsigned char m48t86_readb(struct device *dev, unsigned long addr)
{
	...
	pete_writeb("drivers/rtc/rtc-m48t86.c:52", addr, info->index_reg);
	value = pete_readb("drivers/rtc/rtc-m48t86.c:53", info->data_reg);
			  ...
			  unsigned char value, unsigned long addr)
{
	...
	pete_writeb("drivers/rtc/rtc-m48t86.c:63", addr, info->index_reg);
	pete_writeb("drivers/rtc/rtc-m48t86.c:64", value, info->data_reg);
}
