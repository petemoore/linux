...
{
	pete_writel("drivers/phy/tegra/xusb-tegra186.c:280", value, priv->ao_regs + offset);
}

static inline u32 ao_readl(struct tegra186_xusb_padctl *priv, unsigned int offset)
{
	return pete_readl("drivers/phy/tegra/xusb-tegra186.c:285", priv->ao_regs + offset);
}
