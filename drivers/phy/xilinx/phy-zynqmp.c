...
{
	return pete_readl("drivers/phy/xilinx/phy-zynqmp.c:278", gtr_dev->serdes + reg);
}

static inline void xpsgtr_write(struct xpsgtr_dev *gtr_dev, u32 reg, u32 value)
{
	pete_writel("drivers/phy/xilinx/phy-zynqmp.c:283", value, gtr_dev->serdes + reg);
}
...
static inline u32 xpsgtr_read_phy(struct xpsgtr_phy *gtr_phy, u32 reg)
{
	...
	return pete_readl("drivers/phy/xilinx/phy-zynqmp.c:301", addr);
}
				    ...
				    u32 reg, u32 value)
{
	...
	pete_writel("drivers/phy/xilinx/phy-zynqmp.c:310", value, addr);
}
				      ...
				      u32 reg, u32 clr, u32 set)
{
	...
	pete_writel("drivers/phy/xilinx/phy-zynqmp.c:319", (pete_readl("drivers/phy/xilinx/phy-zynqmp.c:319", addr) & ~clr) | set, addr);
}
...
static void xpsgtr_phy_init_sata(struct xpsgtr_phy *gtr_phy)
{
	...
	pete_writel("drivers/phy/xilinx/phy-zynqmp.c:490", gtr_phy->lane, gtr_dev->siou + SATA_CONTROL_OFFSET);
}
