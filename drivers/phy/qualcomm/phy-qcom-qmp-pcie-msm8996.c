...
static inline void qphy_setbits(void __iomem *base, u32 offset, u32 val)
{
	...
	reg = pete_readl("drivers/phy/qualcomm/phy-qcom-qmp-pcie-msm8996.c:255", base + offset);
	reg |= val;
	pete_writel("drivers/phy/qualcomm/phy-qcom-qmp-pcie-msm8996.c:257", reg, base + offset);

	/* ensure that above write is through */
	pete_readl("drivers/phy/qualcomm/phy-qcom-qmp-pcie-msm8996.c:260", base + offset);
}
...
static inline void qphy_clrbits(void __iomem *base, u32 offset, u32 val)
{
	...
	reg = pete_readl("drivers/phy/qualcomm/phy-qcom-qmp-pcie-msm8996.c:267", base + offset);
	reg &= ~val;
	pete_writel("drivers/phy/qualcomm/phy-qcom-qmp-pcie-msm8996.c:269", reg, base + offset);

	/* ensure that above write is through */
	pete_readl("drivers/phy/qualcomm/phy-qcom-qmp-pcie-msm8996.c:272", base + offset);
}
					...
					u8 lane_mask)
{
	...
	for (i = 0; i < num; i++, t++) {
		...
		pete_writel("drivers/phy/qualcomm/phy-qcom-qmp-pcie-msm8996.c:325", t->val, base + t->offset);
	}
}
