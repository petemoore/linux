...
static inline void qphy_setbits(void __iomem *base, u32 offset, u32 val)
{
	...
	reg = pete_readl("drivers/phy/qualcomm/phy-qcom-qmp-ufs.c:775", base + offset);
	reg |= val;
	pete_writel("drivers/phy/qualcomm/phy-qcom-qmp-ufs.c:777", reg, base + offset);

	/* ensure that above write is through */
	pete_readl("drivers/phy/qualcomm/phy-qcom-qmp-ufs.c:780", base + offset);
}
...
static inline void qphy_clrbits(void __iomem *base, u32 offset, u32 val)
{
	...
	reg = pete_readl("drivers/phy/qualcomm/phy-qcom-qmp-ufs.c:787", base + offset);
	reg &= ~val;
	pete_writel("drivers/phy/qualcomm/phy-qcom-qmp-ufs.c:789", reg, base + offset);

	/* ensure that above write is through */
	pete_readl("drivers/phy/qualcomm/phy-qcom-qmp-ufs.c:792", base + offset);
}
					...
					u8 lane_mask)
{
	...
	for (i = 0; i < num; i++, t++) {
		...
		pete_writel("drivers/phy/qualcomm/phy-qcom-qmp-ufs.c:1182", t->val, base + t->offset);
	}
}
