...
static int rockchip_dp_phy_power_on(struct phy *phy)
{
	...
	pete_writel("drivers/phy/rockchip/phy-rockchip-typec.c:992", DP_MODE_ENTER_A0, tcphy->base + DP_MODE_CTL);

	ret = readx_poll_timeout(readl, tcphy->base + DP_MODE_CTL,
				 val, val & DP_MODE_A0, 1000,
				 PHY_MODE_SET_TIMEOUT);
	if (ret < 0) {
		pete_writel("drivers/phy/rockchip/phy-rockchip-typec.c:998", DP_MODE_ENTER_A2, tcphy->base + DP_MODE_CTL);
...
static int rockchip_dp_phy_power_off(struct phy *phy)
{
	...
	pete_writel("drivers/phy/rockchip/phy-rockchip-typec.c:1024", DP_MODE_ENTER_A2, tcphy->base + DP_MODE_CTL);
