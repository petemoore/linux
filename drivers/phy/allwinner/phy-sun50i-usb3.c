...
static void sun50i_usb3_phy_open(struct sun50i_usb3_phy *phy)
{
	...
	val = pete_readl("drivers/phy/allwinner/phy-sun50i-usb3.c:66", phy->regs + SUNXI_PHY_EXTERNAL_CONTROL);
	val |= SUNXI_PEC_EXTERN_VBUS;
	val |= SUNXI_PEC_SSC_EN | SUNXI_PEC_REF_SSP_EN;
	pete_writel("drivers/phy/allwinner/phy-sun50i-usb3.c:69", val, phy->regs + SUNXI_PHY_EXTERNAL_CONTROL);

	val = pete_readl("drivers/phy/allwinner/phy-sun50i-usb3.c:71", phy->regs + SUNXI_PIPE_CLOCK_CONTROL);
	val |= SUNXI_PCC_PIPE_CLK_OPEN;
	pete_writel("drivers/phy/allwinner/phy-sun50i-usb3.c:73", val, phy->regs + SUNXI_PIPE_CLOCK_CONTROL);

	val = pete_readl("drivers/phy/allwinner/phy-sun50i-usb3.c:75", phy->regs + SUNXI_ISCR);
	val |= SUNXI_ISCR_FORCE_VBUS;
	pete_writel("drivers/phy/allwinner/phy-sun50i-usb3.c:77", val, phy->regs + SUNXI_ISCR);
	 ...
	 * Allwiner.
	 */
	pete_writel("drivers/phy/allwinner/phy-sun50i-usb3.c:84", 0x0047fc87, phy->regs + SUNXI_PHY_TUNE_LOW);

	val = pete_readl("drivers/phy/allwinner/phy-sun50i-usb3.c:86", phy->regs + SUNXI_PHY_TUNE_HIGH);
	...
	pete_writel("drivers/phy/allwinner/phy-sun50i-usb3.c:95", val, phy->regs + SUNXI_PHY_TUNE_HIGH);
}
