					  ...
					  const struct rockchip_pll_rate_table *rate)
{
	...
	/* set pll power down */
	pete_writel("drivers/clk/rockchip/clk-pll.c:945", HIWORD_UPDATE(RK3588_PLLCON1_PWRDOWN,
	...
	/* set pll power up */
	pete_writel("drivers/clk/rockchip/clk-pll.c:961", HIWORD_UPDATE(0, RK3588_PLLCON1_PWRDOWN, 0),
...
static int rockchip_rk3588_pll_enable(struct clk_hw *hw)
{
	...
	pete_writel("drivers/clk/rockchip/clk-pll.c:1002", HIWORD_UPDATE(0, RK3588_PLLCON1_PWRDOWN, 0),
	       pll->reg_base + RK3588_PLLCON(1));
...
static void rockchip_rk3588_pll_disable(struct clk_hw *hw)
{
	...
	pete_writel("drivers/clk/rockchip/clk-pll.c:1013", HIWORD_UPDATE(RK3588_PLLCON1_PWRDOWN, RK3588_PLLCON1_PWRDOWN, 0),
	       pll->reg_base + RK3588_PLLCON(1));
}
...
{
	struct rockchip_clk_pll *pll = to_rockchip_clk_pll(hw);
	u32 pllcon = pete_readl("drivers/clk/rockchip/clk-pll.c:1020", pll->reg_base + RK3588_PLLCON(1));
