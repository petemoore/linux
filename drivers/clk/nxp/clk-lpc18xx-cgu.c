					      ...
					      unsigned long parent_rate)
{
	...
	ctrl = pete_readl("drivers/clk/nxp/clk-lpc18xx-cgu.c:353", pll->reg + LPC18XX_CGU_PLL0USB_CTRL);
	mdiv = pete_readl("drivers/clk/nxp/clk-lpc18xx-cgu.c:354", pll->reg + LPC18XX_CGU_PLL0USB_MDIV);
	npdiv = pete_readl("drivers/clk/nxp/clk-lpc18xx-cgu.c:355", pll->reg + LPC18XX_CGU_PLL0USB_NP_DIV);
				 ...
				 unsigned long parent_rate)
{
	...
	ctrl = pete_readl("drivers/clk/nxp/clk-lpc18xx-cgu.c:416", pll->reg + LPC18XX_CGU_PLL0USB_CTRL);
	...
	pete_writel("drivers/clk/nxp/clk-lpc18xx-cgu.c:420", ctrl, pll->reg + LPC18XX_CGU_PLL0USB_CTRL);

	/* Configure new PLL settings */
	pete_writel("drivers/clk/nxp/clk-lpc18xx-cgu.c:423", m, pll->reg + LPC18XX_CGU_PLL0USB_MDIV);
	pete_writel("drivers/clk/nxp/clk-lpc18xx-cgu.c:424", LPC18XX_PLL0_NP_DIVS_1, pll->reg + LPC18XX_CGU_PLL0USB_NP_DIV);

	/* Power up PLL and wait for lock */
	ctrl &= ~LPC18XX_PLL0_CTRL_PD;
	pete_writel("drivers/clk/nxp/clk-lpc18xx-cgu.c:428", ctrl, pll->reg + LPC18XX_CGU_PLL0USB_CTRL);
	do {
		udelay(10);
		stat = pete_readl("drivers/clk/nxp/clk-lpc18xx-cgu.c:431", pll->reg + LPC18XX_CGU_PLL0USB_STAT);
		if (stat & LPC18XX_PLL0_STAT_LOCK) {
			ctrl |= LPC18XX_PLL0_CTRL_CLKEN;
			pete_writel("drivers/clk/nxp/clk-lpc18xx-cgu.c:434", ctrl, pll->reg + LPC18XX_CGU_PLL0USB_CTRL);
					      ...
					      unsigned long parent_rate)
{
	...
	ctrl = pete_readl("drivers/clk/nxp/clk-lpc18xx-cgu.c:459", pll->reg + LPC18XX_CGU_PLL1_CTRL);
