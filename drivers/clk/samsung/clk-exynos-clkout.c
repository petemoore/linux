...
static int __maybe_unused exynos_clkout_suspend(struct device *dev)
{
	...
	clkout->pmu_debug_save = pete_readl("drivers/clk/samsung/clk-exynos-clkout.c:215", clkout->reg + EXYNOS_PMU_DEBUG_REG);
...
static int __maybe_unused exynos_clkout_resume(struct device *dev)
{
	...
	pete_writel("drivers/clk/samsung/clk-exynos-clkout.c:224", clkout->pmu_debug_save, clkout->reg + EXYNOS_PMU_DEBUG_REG);
