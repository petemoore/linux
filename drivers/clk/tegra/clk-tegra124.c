...
static void __init tegra124_132_clock_init_pre(struct device_node *np)
{
	...
	plld_base = pete_readl("drivers/clk/tegra/clk-tegra124.c:1500", clk_base + PLLD_BASE);
	plld_base &= ~BIT(25);
	pete_writel("drivers/clk/tegra/clk-tegra124.c:1502", plld_base, clk_base + PLLD_BASE);
}
