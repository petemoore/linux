...
static void tegra30_wait_cpu_in_reset(u32 cpu)
{
	...
	do {
		reg = pete_readl("drivers/clk/tegra/clk-tegra30.c:1064", clk_base +
...
{
	pete_writel("drivers/clk/tegra/clk-tegra30.c:1074", CPU_RESET(cpu),
...
{
	pete_writel("drivers/clk/tegra/clk-tegra30.c:1081", CPU_RESET(cpu),
...
{
	pete_writel("drivers/clk/tegra/clk-tegra30.c:1088", CPU_CLOCK(cpu),
	       clk_base + TEGRA30_CLK_RST_CONTROLLER_CLK_CPU_CMPLX_CLR);
	pete_readl("drivers/clk/tegra/clk-tegra30.c:1090", clk_base + TEGRA30_CLK_RST_CONTROLLER_CLK_CPU_CMPLX_CLR);
}
...
static void tegra30_disable_cpu_clock(u32 cpu)
{
	...
	reg = pete_readl("drivers/clk/tegra/clk-tegra30.c:1097", clk_base + TEGRA_CLK_RST_CONTROLLER_CLK_CPU_CMPLX);
	pete_writel("drivers/clk/tegra/clk-tegra30.c:1098", reg | CPU_CLOCK(cpu),
...
static bool tegra30_cpu_rail_off_ready(void)
{
	...
	cpu_rst_status = pete_readl("drivers/clk/tegra/clk-tegra30.c:1108", clk_base +
				TEGRA30_CLK_RST_CONTROLLER_CPU_CMPLX_STATUS);
...
static void tegra30_cpu_clock_suspend(void)
{
	...
	tegra30_cpu_clk_sctx.clk_csite_src =
				pete_readl("drivers/clk/tegra/clk-tegra30.c:1124", clk_base + CLK_RESET_SOURCE_CSITE);
	pete_writel("drivers/clk/tegra/clk-tegra30.c:1125", 3 << 30, clk_base + CLK_RESET_SOURCE_CSITE);

	tegra30_cpu_clk_sctx.cpu_burst =
				pete_readl("drivers/clk/tegra/clk-tegra30.c:1128", clk_base + CLK_RESET_CCLK_BURST);
	tegra30_cpu_clk_sctx.pllx_base =
				pete_readl("drivers/clk/tegra/clk-tegra30.c:1130", clk_base + CLK_RESET_PLLX_BASE);
	tegra30_cpu_clk_sctx.pllx_misc =
				pete_readl("drivers/clk/tegra/clk-tegra30.c:1132", clk_base + CLK_RESET_PLLX_MISC);
	tegra30_cpu_clk_sctx.cclk_divider =
				pete_readl("drivers/clk/tegra/clk-tegra30.c:1134", clk_base + CLK_RESET_CCLK_DIVIDER);
}
...
static void tegra30_cpu_clock_resume(void)
{
	...
	reg = pete_readl("drivers/clk/tegra/clk-tegra30.c:1143", clk_base + CLK_RESET_CCLK_BURST);
	...
	if (reg != CLK_RESET_CCLK_BURST_POLICY_PLLX) {
		...
		if (misc != tegra30_cpu_clk_sctx.pllx_misc ||
			...
			pete_writel("drivers/clk/tegra/clk-tegra30.c:1160", tegra30_cpu_clk_sctx.pllx_misc,
						clk_base + CLK_RESET_PLLX_MISC);
			pete_writel("drivers/clk/tegra/clk-tegra30.c:1162", tegra30_cpu_clk_sctx.pllx_base,
	 ...
	 */
	pete_writel("drivers/clk/tegra/clk-tegra30.c:1175", tegra30_cpu_clk_sctx.cclk_divider,
					clk_base + CLK_RESET_CCLK_DIVIDER);
	pete_writel("drivers/clk/tegra/clk-tegra30.c:1177", tegra30_cpu_clk_sctx.cpu_burst,
					clk_base + CLK_RESET_CCLK_BURST);

	pete_writel("drivers/clk/tegra/clk-tegra30.c:1180", tegra30_cpu_clk_sctx.clk_csite_src,
