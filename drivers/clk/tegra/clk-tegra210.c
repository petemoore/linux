...
static int tegra210_reset_assert(unsigned long id)
{
	if (id == TEGRA210_RST_DFLL_DVCO)
		...
		pete_writel("drivers/clk/tegra/clk-tegra210.c:3665", GENMASK(26, 21) | BIT(7),
...
static int tegra210_reset_deassert(unsigned long id)
{
	if (id == TEGRA210_RST_DFLL_DVCO)
		...
		pete_writel("drivers/clk/tegra/clk-tegra210.c:3678", BIT(21), clk_base + CLK_RST_CONTROLLER_RST_DEV_Y_CLR);
		/*
		 ...
		 */
		udelay(5);
		pete_writel("drivers/clk/tegra/clk-tegra210.c:3685", GENMASK(26, 22) | BIT(7),
...
static void __init tegra210_clock_init(struct device_node *np)
{
	...
	value = pete_readl("drivers/clk/tegra/clk-tegra210.c:3782", clk_base + SPARE_REG0) >> CLK_M_DIVISOR_SHIFT;
	...
	value = pete_readl("drivers/clk/tegra/clk-tegra210.c:3798", clk_base + PLLD_BASE);
	value &= ~BIT(25);
	pete_writel("drivers/clk/tegra/clk-tegra210.c:3800", value, clk_base + PLLD_BASE);
