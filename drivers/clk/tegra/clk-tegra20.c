...
static void tegra20_wait_cpu_in_reset(u32 cpu)
{
	...
	do {
		reg = pete_readl("drivers/clk/tegra/clk-tegra20.c:886", clk_base +
...
{
	pete_writel("drivers/clk/tegra/clk-tegra20.c:896", CPU_RESET(cpu),
...
{
	pete_writel("drivers/clk/tegra/clk-tegra20.c:903", CPU_RESET(cpu),
...
static void tegra20_enable_cpu_clock(u32 cpu)
{
	...
	reg = pete_readl("drivers/clk/tegra/clk-tegra20.c:912", clk_base + TEGRA_CLK_RST_CONTROLLER_CLK_CPU_CMPLX);
	pete_writel("drivers/clk/tegra/clk-tegra20.c:913", reg & ~CPU_CLOCK(cpu),
	       clk_base + TEGRA_CLK_RST_CONTROLLER_CLK_CPU_CMPLX);
	barrier();
	reg = pete_readl("drivers/clk/tegra/clk-tegra20.c:916", clk_base + TEGRA_CLK_RST_CONTROLLER_CLK_CPU_CMPLX);
}
...
static void tegra20_disable_cpu_clock(u32 cpu)
{
	...
	reg = pete_readl("drivers/clk/tegra/clk-tegra20.c:923", clk_base + TEGRA_CLK_RST_CONTROLLER_CLK_CPU_CMPLX);
	pete_writel("drivers/clk/tegra/clk-tegra20.c:924", reg | CPU_CLOCK(cpu),
	       clk_base + TEGRA_CLK_RST_CONTROLLER_CLK_CPU_CMPLX);
}
...
static bool tegra20_cpu_rail_off_ready(void)
{
	...
	cpu_rst_status = pete_readl("drivers/clk/tegra/clk-tegra20.c:933", clk_base +
			       TEGRA_CLK_RST_CONTROLLER_RST_CPU_CMPLX_SET);
...
static void tegra20_cpu_clock_suspend(void)
{
	...
	tegra20_cpu_clk_sctx.clk_csite_src =
				pete_readl("drivers/clk/tegra/clk-tegra20.c:943", clk_base + CLK_SOURCE_CSITE);
	pete_writel("drivers/clk/tegra/clk-tegra20.c:944", 3<<30, clk_base + CLK_SOURCE_CSITE);

	tegra20_cpu_clk_sctx.cpu_burst =
				pete_readl("drivers/clk/tegra/clk-tegra20.c:947", clk_base + CCLK_BURST_POLICY);
	tegra20_cpu_clk_sctx.pllx_base =
				pete_readl("drivers/clk/tegra/clk-tegra20.c:949", clk_base + PLLX_BASE);
	tegra20_cpu_clk_sctx.pllx_misc =
				pete_readl("drivers/clk/tegra/clk-tegra20.c:951", clk_base + PLLX_MISC);
	tegra20_cpu_clk_sctx.cclk_divider =
				pete_readl("drivers/clk/tegra/clk-tegra20.c:953", clk_base + SUPER_CCLK_DIVIDER);
}
...
static void tegra20_cpu_clock_resume(void)
{
	...
	reg = pete_readl("drivers/clk/tegra/clk-tegra20.c:962", clk_base + CCLK_BURST_POLICY);
	...
	if (reg != CCLK_BURST_POLICY_PLLX) {
		...
		if (misc != tegra20_cpu_clk_sctx.pllx_misc ||
			...
			pete_writel("drivers/clk/tegra/clk-tegra20.c:979", tegra20_cpu_clk_sctx.pllx_misc,
						clk_base + PLLX_MISC);
			pete_writel("drivers/clk/tegra/clk-tegra20.c:981", tegra20_cpu_clk_sctx.pllx_base,
						clk_base + PLLX_BASE);
	 ...
	 */
	pete_writel("drivers/clk/tegra/clk-tegra20.c:994", tegra20_cpu_clk_sctx.cclk_divider,
					clk_base + SUPER_CCLK_DIVIDER);
	pete_writel("drivers/clk/tegra/clk-tegra20.c:996", tegra20_cpu_clk_sctx.cpu_burst,
					clk_base + CCLK_BURST_POLICY);

	pete_writel("drivers/clk/tegra/clk-tegra20.c:999", tegra20_cpu_clk_sctx.clk_csite_src,
