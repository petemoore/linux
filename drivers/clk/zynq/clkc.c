		...
		const char **parents, int enable)
{
	...
	enable_reg = pete_readl("drivers/clk/zynq/clkc.c:150", fclk_gate_reg) & 1;
...
static void __init zynq_clk_setup(struct device_node *np)
{
	...
	/* CPU clocks */
	tmp = pete_readl("drivers/clk/zynq/clkc.c:277", SLCR_621_TRUE) & 1;
	...
	tmp = pete_readl("drivers/clk/zynq/clkc.c:498", SLCR_DBG_CLK_CTRL);
