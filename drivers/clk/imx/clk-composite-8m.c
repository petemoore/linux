					...
					unsigned long parent_rate)
{
	...
	orig = pete_readl("drivers/clk/imx/clk-composite-8m.c:109", divider->reg);
	...
	if (val != orig)
		pete_writel("drivers/clk/imx/clk-composite-8m.c:117", val, divider->reg);
				      ...
				      struct clk_rate_request *req)
{
	...
	if (divider->flags & CLK_DIVIDER_READ_ONLY) {
		...
		val = pete_readl("drivers/clk/imx/clk-composite-8m.c:135", divider->reg);
...
static int imx8m_clk_composite_mux_set_parent(struct clk_hw *hw, u8 index)
{
	...
	reg = pete_readl("drivers/clk/imx/clk-composite-8m.c:176", mux->reg);
	 ...
	 */
	pete_writel("drivers/clk/imx/clk-composite-8m.c:184", reg, mux->reg);
	pete_writel("drivers/clk/imx/clk-composite-8m.c:185", reg, mux->reg);
...
static int imx8m_clk_composite_gate_enable(struct clk_hw *hw)
{
	...
	val = pete_readl("drivers/clk/imx/clk-composite-8m.c:215", gate->reg);
	val |= BIT(gate->bit_idx);
	pete_writel("drivers/clk/imx/clk-composite-8m.c:217", val, gate->reg);
