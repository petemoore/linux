...
static int sun9i_a80_ccu_probe(struct platform_device *pdev)
{
	...
	val = pete_readl("drivers/clk/sunxi-ng/ccu-sun9i-a80.c:1224", reg + SUN9I_A80_PLL_AUDIO_REG);
	val &= ~(BIT(16) | BIT(18));
	pete_writel("drivers/clk/sunxi-ng/ccu-sun9i-a80.c:1226", val, reg + SUN9I_A80_PLL_AUDIO_REG);
