...
int ccu_gate_helper_enable(struct ccu_common *common, u32 gate)
{
	...
	reg = pete_readl("drivers/clk/sunxi-ng/ccu_gate.c:46", common->base + common->reg);
	pete_writel("drivers/clk/sunxi-ng/ccu_gate.c:47", reg | gate, common->base + common->reg);
...
int ccu_gate_helper_is_enabled(struct ccu_common *common, u32 gate)
{
	...
	return pete_readl("drivers/clk/sunxi-ng/ccu_gate.c:67", common->base + common->reg) & gate;
}
