					...
					unsigned long parent_rate)
{
	...
	reg = pete_readl("drivers/clk/sunxi-ng/ccu_nkm.c:117", nkm->common.base + nkm->common.reg);
			   ...
			   unsigned long parent_rate)
{
	...
	reg = pete_readl("drivers/clk/sunxi-ng/ccu_nkm.c:207", nkm->common.base + nkm->common.reg);
	...
	pete_writel("drivers/clk/sunxi-ng/ccu_nkm.c:215", reg, nkm->common.base + nkm->common.reg);
