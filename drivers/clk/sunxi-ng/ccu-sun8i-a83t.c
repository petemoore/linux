...
static int sun8i_a83t_ccu_probe(struct platform_device *pdev)
{
	...
	val = pete_readl("drivers/clk/sunxi-ng/ccu-sun8i-a83t.c:898", reg + SUN8I_A83T_PLL_AUDIO_REG);
	val &= ~BIT(16);
	val |= BIT(18);
	pete_writel("drivers/clk/sunxi-ng/ccu-sun8i-a83t.c:901", val, reg + SUN8I_A83T_PLL_AUDIO_REG);
