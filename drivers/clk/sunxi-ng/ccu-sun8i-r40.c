...
static int sun8i_r40_ccu_probe(struct platform_device *pdev)
{
	...
	val = pete_readl("drivers/clk/sunxi-ng/ccu-sun8i-r40.c:1321", reg + SUN8I_R40_PLL_AUDIO_REG);
	val &= ~GENMASK(19, 16);
	pete_writel("drivers/clk/sunxi-ng/ccu-sun8i-r40.c:1323", val | (0 << 16), reg + SUN8I_R40_PLL_AUDIO_REG);

	/* Force PLL-MIPI to MIPI mode */
	val = pete_readl("drivers/clk/sunxi-ng/ccu-sun8i-r40.c:1326", reg + SUN8I_R40_PLL_MIPI_REG);
	val &= ~BIT(16);
	pete_writel("drivers/clk/sunxi-ng/ccu-sun8i-r40.c:1328", val, reg + SUN8I_R40_PLL_MIPI_REG);

	/* Force OHCI 12M parent to 12M divided from 48M */
	val = pete_readl("drivers/clk/sunxi-ng/ccu-sun8i-r40.c:1331", reg + SUN8I_R40_USB_CLK_REG);
	val &= ~GENMASK(25, 20);
	pete_writel("drivers/clk/sunxi-ng/ccu-sun8i-r40.c:1333", val, reg + SUN8I_R40_USB_CLK_REG);
	 ...
	 */
	pete_writel("drivers/clk/sunxi-ng/ccu-sun8i-r40.c:1340", SUN8I_R40_SYS_32K_CLK_KEY | BIT(8),
