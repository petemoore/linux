			      ...
			      unsigned long id, bool assert)
{
	...
	if (data->clear_offset) {
		...
		pete_writel("drivers/clk/clk-stm32mp1.c:2227", BIT(offset), addr);
		...
		reg = pete_readl("drivers/clk/clk-stm32mp1.c:2235", data->membase + (bank * reg_width));
		...
		pete_writel("drivers/clk/clk-stm32mp1.c:2242", reg, data->membase + (bank * reg_width));
			      ...
			      unsigned long id)
{
	...
	reg = pete_readl("drivers/clk/clk-stm32mp1.c:2271", data->membase + (bank * reg_width));
