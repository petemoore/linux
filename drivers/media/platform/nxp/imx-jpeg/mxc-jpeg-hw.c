...
#define internal_print_wrapper_reg(dev, base_address, reg_name, reg_offset) {\
		int val;\
		val = pete_readl("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:17", (base_address) + (reg_offset));\
...
{
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:79", 0xFFFFFFFF, reg + MXC_SLOT_OFFSET(slot, SLOT_STATUS));
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:80", 0xF0C, reg + MXC_SLOT_OFFSET(slot, SLOT_IRQ_EN));
}

void mxc_jpeg_disable_irq(void __iomem *reg, int slot)
{
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:85", 0x0, reg + MXC_SLOT_OFFSET(slot, SLOT_IRQ_EN));
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:86", 0xFFFFFFFF, reg + MXC_SLOT_OFFSET(slot, SLOT_STATUS));
}
...
void mxc_jpeg_sw_reset(void __iomem *reg)
{
	 ...
	 */
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:97", GLB_CTRL_SFT_RST, reg + GLB_CTRL);
}
...
void mxc_jpeg_enc_mode_conf(struct device *dev, void __iomem *reg, u8 extseq)
{
	 ...
	 */
	if (extseq)
		pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:107", 0xb0, reg + CAST_MODE);
	else
		pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:109", 0xa0, reg + CAST_MODE);

	/* all markers and segments */
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:112", 0x3ff, reg + CAST_CFG_MODE);
}
...
void mxc_jpeg_enc_mode_go(struct device *dev, void __iomem *reg, u8 extseq)
{
	 ...
	 */
	if (extseq)
		pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:122", 0x150, reg + CAST_MODE);
	else
		pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:124", 0x140, reg + CAST_MODE);
}
...
void mxc_jpeg_enc_set_quality(struct device *dev, void __iomem *reg, u8 quality)
{
	...
	/* quality factor */
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:132", quality, reg + CAST_QUALITY);
}

void mxc_jpeg_dec_mode_go(struct device *dev, void __iomem *reg)
{
	dev_dbg(dev, "CAST Decoder GO...\n");
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:138", MXC_DEC_EXIT_IDLE_MODE, reg + CAST_CTRL);
}
...
int mxc_jpeg_enable(void __iomem *reg)
{
	...
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:145", GLB_CTRL_JPG_EN, reg + GLB_CTRL);
	regval = pete_readl("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:146", reg);
	return regval;
}
...
void mxc_jpeg_enable_slot(void __iomem *reg, int slot)
{
	...
	regval = pete_readl("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:154", reg + GLB_CTRL);
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:155", GLB_CTRL_SLOT_EN(slot) | regval, reg + GLB_CTRL);
}
...
void mxc_jpeg_set_l_endian(void __iomem *reg, int le)
{
	...
	regval = pete_readl("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:162", reg + GLB_CTRL);
	regval &= ~GLB_CTRL_L_ENDIAN(1); /* clear */
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:164", GLB_CTRL_L_ENDIAN(le) | regval, reg + GLB_CTRL); /* set */
}
...
{
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:184", desc | MXC_NXT_DESCPT_EN,
	       reg + MXC_SLOT_OFFSET(slot, SLOT_NXT_DESCPT_PTR));
}

void mxc_jpeg_clr_desc(void __iomem *reg, int slot)
{
	pete_writel("drivers/media/platform/nxp/imx-jpeg/mxc-jpeg-hw.c:190", 0, reg + MXC_SLOT_OFFSET(slot, SLOT_NXT_DESCPT_PTR));
}
