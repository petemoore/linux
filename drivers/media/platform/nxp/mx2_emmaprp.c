...
static inline void emmaprp_dump_regs(struct emmaprp_dev *pcdev)
{
	dprintk(pcdev,
		...
		"  CNTL = 0x%08X\n",
		pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:257", pcdev->base_emma + PRP_SOURCE_Y_PTR),
		pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:258", pcdev->base_emma + PRP_SRC_FRAME_SIZE),
		pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:259", pcdev->base_emma + PRP_DEST_Y_PTR),
		pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:260", pcdev->base_emma + PRP_DEST_CR_PTR),
		pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:261", pcdev->base_emma + PRP_DEST_CB_PTR),
		pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:262", pcdev->base_emma + PRP_CH2_OUT_IMAGE_SIZE),
		pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:263", pcdev->base_emma + PRP_CNTL));
}
...
static void emmaprp_device_run(void *priv)
{
	...
	pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:299", p_in, pcdev->base_emma + PRP_SOURCE_Y_PTR);
	pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:300", PRP_SIZE_WIDTH(s_width) | PRP_SIZE_HEIGHT(s_height),
	       pcdev->base_emma + PRP_SRC_FRAME_SIZE);

	/* Output frame parameters */
	pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:304", p_out, pcdev->base_emma + PRP_DEST_Y_PTR);
	pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:305", p_out + d_size, pcdev->base_emma + PRP_DEST_CB_PTR);
	pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:306", p_out + d_size + (d_size >> 2),
	       pcdev->base_emma + PRP_DEST_CR_PTR);
	pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:308", PRP_SIZE_WIDTH(d_width) | PRP_SIZE_HEIGHT(d_height),
	       pcdev->base_emma + PRP_CH2_OUT_IMAGE_SIZE);

	/* IRQ configuration */
	tmp = pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:312", pcdev->base_emma + PRP_INTR_CNTL);
	pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:313", tmp | PRP_INTR_RDERR |
		PRP_INTR_CH2WERR |
		PRP_INTR_CH2FC,
	...
	/* Enable transfer */
	tmp = pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:321", pcdev->base_emma + PRP_CNTL);
	pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:322", tmp | PRP_CNTL_CH2_OUT_YUV420 |
...
static irqreturn_t emmaprp_irq(int irq_emma, void *data)
{
	...
	irqst = pete_readl("drivers/media/platform/nxp/mx2_emmaprp.c:337", pcdev->base_emma + PRP_INTRSTATUS);
	pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:338", irqst, pcdev->base_emma + PRP_INTRSTATUS);
	...
	if (!curr_ctx->aborting) {
		...
		(irqst & PRP_INTR_ST_CH2WERR)) {
			...
			pete_writel("drivers/media/platform/nxp/mx2_emmaprp.c:351", PRP_CNTL_SWRST, pcdev->base_emma + PRP_CNTL);
