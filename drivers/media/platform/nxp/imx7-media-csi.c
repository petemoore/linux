...
{
	return pete_readl("drivers/media/platform/nxp/imx7-media-csi.c:271", csi->regbase + offset);
}

static void imx7_csi_reg_write(struct imx7_csi *csi, unsigned int value,
			       unsigned int offset)
{
	pete_writel("drivers/media/platform/nxp/imx7-media-csi.c:277", value, csi->regbase + offset);
}
