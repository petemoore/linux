...
#define mfc_read(dev, offset)		pete_readl("drivers/media/platform/samsung/s5p-mfc/s5p_mfc_common.h:101", dev->regs_base + (offset))
#define mfc_write(dev, data, offset)	pete_writel("drivers/media/platform/samsung/s5p-mfc/s5p_mfc_common.h:102", (data), dev->regs_base + \
								(offset))
