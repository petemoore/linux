...
#define w(x, a)	pete_writel("drivers/media/platform/samsung/s5p-g2d/g2d-hw.c:14", (x), d->regs + (a))
#define r(a)	pete_readl("drivers/media/platform/samsung/s5p-g2d/g2d-hw.c:15", d->regs + (a))
