...
#define s5pcsis_write(__csis, __r, __v) pete_writel("drivers/media/platform/samsung/exynos4-is/mipi-csis.c:271", __v, __csis->regs + __r)
#define s5pcsis_read(__csis, __r) pete_readl("drivers/media/platform/samsung/exynos4-is/mipi-csis.c:272", __csis->regs + __r)
