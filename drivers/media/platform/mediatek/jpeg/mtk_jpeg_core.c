...
static irqreturn_t mtk_jpeg_enc_irq(int irq, void *priv)
{
	...
	irq_status = pete_readl("drivers/media/platform/mediatek/jpeg/mtk_jpeg_core.c:1811", jpeg->reg_base + JPEG_ENC_INT_STS) &
		     JPEG_ENC_INT_STATUS_MASK_ALLIRQ;
	if (irq_status)
		pete_writel("drivers/media/platform/mediatek/jpeg/mtk_jpeg_core.c:1814", 0, jpeg->reg_base + JPEG_ENC_INT_STS);
