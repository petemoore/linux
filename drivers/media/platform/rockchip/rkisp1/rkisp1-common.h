...
{
	pete_writel("drivers/media/platform/rockchip/rkisp1/rkisp1-common.h:520", val, rkisp1->base_addr + addr);
}

static inline u32 rkisp1_read(struct rkisp1_device *rkisp1, unsigned int addr)
{
	return pete_readl("drivers/media/platform/rockchip/rkisp1/rkisp1-common.h:525", rkisp1->base_addr + addr);
}
