...
#define regr(reg)               pete_readl("drivers/media/platform/ti/davinci/vpif.h:24", (reg) + vpif_base)
#define regw(value, reg)        pete_writel("drivers/media/platform/ti/davinci/vpif.h:25", value, (reg + vpif_base))
