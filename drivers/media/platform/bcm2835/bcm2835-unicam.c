...
{
	pete_writel("drivers/media/platform/bcm2835/bcm2835-unicam.c:586", val | 0x5a000000, dev->clk_gate_base);
}

static inline u32 reg_read(struct unicam_device *dev, u32 offset)
{
	return pete_readl("drivers/media/platform/bcm2835/bcm2835-unicam.c:591", dev->base + offset);
}

static inline void reg_write(struct unicam_device *dev, u32 offset, u32 val)
{
	pete_writel("drivers/media/platform/bcm2835/bcm2835-unicam.c:596", val, dev->base + offset);
}
