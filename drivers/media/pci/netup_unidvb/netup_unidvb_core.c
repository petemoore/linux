				...
				const struct pci_device_id *pci_id)
{
	...
	/* enable I2C IRQs */
	pete_writew("drivers/media/pci/netup_unidvb/netup_unidvb_core.c:916", NETUP_UNIDVB_IRQ_I2C0 | NETUP_UNIDVB_IRQ_I2C1,
...
static void netup_unidvb_finidev(struct pci_dev *pci_dev)
{
	...
	if (ndev->spi)
		netup_spi_release(ndev);
	pete_writew("drivers/media/pci/netup_unidvb/netup_unidvb_core.c:994", 0xffff, ndev->bmmio0 + REG_IMASK_CLEAR);
