...
static int cio2_hw_init(struct cio2_device *cio2, struct cio2_queue *q)
{
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:372", timing.clk_termen, q->csi_rx_base +
		CIO2_REG_CSIRX_DLY_CNT_TERMEN(CIO2_CSIRX_DLY_CNT_CLANE_IDX));
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:374", timing.clk_settle, q->csi_rx_base +
		CIO2_REG_CSIRX_DLY_CNT_SETTLE(CIO2_CSIRX_DLY_CNT_CLANE_IDX));

	for (i = 0; i < lanes; i++) {
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:378", timing.dat_termen, q->csi_rx_base +
			CIO2_REG_CSIRX_DLY_CNT_TERMEN(i));
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:380", timing.dat_settle, q->csi_rx_base +
			CIO2_REG_CSIRX_DLY_CNT_SETTLE(i));
	}

	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:384", CIO2_PBM_WMCTRL1_MIN_2CK |
	       CIO2_PBM_WMCTRL1_MID1_2CK |
	       CIO2_PBM_WMCTRL1_MID2_2CK, base + CIO2_REG_PBM_WMCTRL1);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:387", CIO2_PBM_WMCTRL2_HWM_2CK << CIO2_PBM_WMCTRL2_HWM_2CK_SHIFT |
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:393", CIO2_PBM_ARB_CTRL_LANES_DIV <<
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:401", CIO2_CSIRX_STATUS_DLANE_HS_MASK,
	       q->csi_rx_base + CIO2_REG_CSIRX_STATUS_DLANE_HS);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:403", CIO2_CSIRX_STATUS_DLANE_LP_MASK,
	       q->csi_rx_base + CIO2_REG_CSIRX_STATUS_DLANE_LP);

	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:406", CIO2_FB_HPLL_FREQ, base + CIO2_REG_FB_HPLL_FREQ);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:407", CIO2_ISCLK_RATIO, base + CIO2_REG_ISCLK_RATIO);

	/* Configure MIPI backend */
	for (i = 0; i < NUM_VCS; i++)
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:411", 1, q->csi_rx_base + CIO2_REG_MIPIBE_SP_LUT_ENTRY(i));

	/* There are 16 short packet LUT entry */
	for (i = 0; i < 16; i++)
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:415", CIO2_MIPIBE_LP_LUT_ENTRY_DISREGARD,
		       q->csi_rx_base + CIO2_REG_MIPIBE_LP_LUT_ENTRY(i));
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:417", CIO2_MIPIBE_GLOBAL_LUT_DISREGARD,
	       q->csi_rx_base + CIO2_REG_MIPIBE_GLOBAL_LUT_DISREGARD);

	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:420", CIO2_INT_EN_EXT_IE_MASK, base + CIO2_REG_INT_EN_EXT_IE);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:421", CIO2_IRQCTRL_MASK, q->csi_rx_base + CIO2_REG_IRQCTRL_MASK);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:422", CIO2_IRQCTRL_MASK, q->csi_rx_base + CIO2_REG_IRQCTRL_ENABLE);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:423", 0, q->csi_rx_base + CIO2_REG_IRQCTRL_EDGE);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:424", 0, q->csi_rx_base + CIO2_REG_IRQCTRL_LEVEL_NOT_PULSE);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:425", CIO2_INT_EN_EXT_OE_MASK, base + CIO2_REG_INT_EN_EXT_OE);

	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:427", CIO2_REG_INT_EN_IRQ | CIO2_INT_IOC(CIO2_DMA_CHAN) |
	       CIO2_REG_INT_EN_IOS(CIO2_DMA_CHAN),
	       base + CIO2_REG_INT_EN);

	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:431", (CIO2_PXM_PXF_FMT_CFG_BPP_10 | CIO2_PXM_PXF_FMT_CFG_PCK_64B)
	       << CIO2_PXM_PXF_FMT_CFG_SID0_SHIFT,
	       base + CIO2_REG_PXM_PXF_FMT_CFG0(csi2bus));
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:434", SID << CIO2_MIPIBE_LP_LUT_ENTRY_SID_SHIFT |
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:438", 0, q->csi_rx_base + CIO2_REG_MIPIBE_COMP_FORMAT(sensor_vc));
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:439", 0, q->csi_rx_base + CIO2_REG_MIPIBE_FORCE_RAW8);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:440", 0, base + CIO2_REG_PXM_SID2BID0(csi2bus));

	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:442", lanes, q->csi_rx_base + CIO2_REG_CSIRX_NOF_ENABLED_LANES);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:443", CIO2_CGC_PRIM_TGE |
	       CIO2_CGC_SIDE_TGE |
	       CIO2_CGC_XOSC_TGE |
	       CIO2_CGC_D3I3_TGE |
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:456", CIO2_LTRCTRL_LTRDYNEN, base + CIO2_REG_LTRCTRL);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:457", CIO2_LTRVAL0_VAL << CIO2_LTRVAL02_VAL_SHIFT |
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:462", CIO2_LTRVAL2_VAL << CIO2_LTRVAL02_VAL_SHIFT |
	...
	for (i = 0; i < CIO2_NUM_DMA_CHAN; i++) {
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:469", 0, base + CIO2_REG_CDMABA(i));
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:470", 0, base + CIO2_REG_CDMAC0(i));
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:471", 0, base + CIO2_REG_CDMAC1(i));
	}

	/* Enable DMA */
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:475", PFN_DOWN(q->fbpt_bus_addr), base + CIO2_REG_CDMABA(CIO2_DMA_CHAN));

	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:477", num_buffers1 << CIO2_CDMAC0_FBPT_LEN_SHIFT |
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:485", 1 << CIO2_CDMAC1_LINENUMUPDATE_SHIFT,
	       base + CIO2_REG_CDMAC1(CIO2_DMA_CHAN));

	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:488", 0, base + CIO2_REG_PBM_FOPN_ABORT);

	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:490", CIO2_PXM_FRF_CFG_CRC_TH << CIO2_PXM_FRF_CFG_CRC_TH_SHIFT |
	...
	/* Clear interrupts */
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:497", CIO2_IRQCTRL_MASK, q->csi_rx_base + CIO2_REG_IRQCTRL_CLEAR);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:498", ~0, base + CIO2_REG_INT_STS_EXT_OE);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:499", ~0, base + CIO2_REG_INT_STS_EXT_IE);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:500", ~0, base + CIO2_REG_INT_STS);

	/* Enable devices, starting from the last device in the pipe */
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:503", 1, q->csi_rx_base + CIO2_REG_MIPIBE_ENABLE);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:504", 1, q->csi_rx_base + CIO2_REG_CSIRX_ENABLE);
...
static void cio2_hw_exit(struct cio2_device *cio2, struct cio2_queue *q)
{
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:518", 0, q->csi_rx_base + CIO2_REG_IRQCTRL_MASK);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:519", 0, q->csi_rx_base + CIO2_REG_IRQCTRL_ENABLE);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:520", 0, q->csi_rx_base + CIO2_REG_CSIRX_ENABLE);
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:521", 0, q->csi_rx_base + CIO2_REG_MIPIBE_ENABLE);

	/* Halt DMA */
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:524", 0, base + CIO2_REG_CDMAC0(CIO2_DMA_CHAN));
	...
	for (i = 0; i < CIO2_NUM_PORTS; i++) {
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:532", pete_readl("drivers/media/pci/intel/ipu3/ipu3-cio2.c:532", base + CIO2_REG_PXM_FRF_CFG(i)) |
		       CIO2_PXM_FRF_CFG_ABORT, base + CIO2_REG_PXM_FRF_CFG(i));
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:534", pete_readl("drivers/media/pci/intel/ipu3/ipu3-cio2.c:534", base + CIO2_REG_PBM_FOPN_ABORT) |
...
static void cio2_irq_handle_once(struct cio2_device *cio2, u32 int_status)
{
	...
	if (int_status & CIO2_INT_IOOE) {
		...
		oe_clear = pete_readl("drivers/media/pci/intel/ipu3/ipu3-cio2.c:670", base + CIO2_REG_INT_STS_EXT_OE);
		oe_status = oe_clear;
		...
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:685", oe_clear, base + CIO2_REG_INT_STS_EXT_OE);
		if (oe_status)
	...
	if (int_status & (CIO2_INT_IOIE | CIO2_INT_IOIRQ)) {
		...
		ie_status = pete_readl("drivers/media/pci/intel/ipu3/ipu3-cio2.c:725", base + CIO2_REG_INT_STS_EXT_IE);
		...
		for (port = 0; port < CIO2_NUM_PORTS; port++) {
			...
			if (ie_status & CIO2_INT_EXT_IE_IRQ(port)) {
				...
				csi2_status = pete_readl("drivers/media/pci/intel/ipu3/ipu3-cio2.c:737", csi_rx_base +
						CIO2_REG_IRQCTRL_STATUS);

				cio2_irq_log_irq_errs(dev, port, csi2_status);

				pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:742", csi2_status,
				       csi_rx_base + CIO2_REG_IRQCTRL_CLEAR);
			}
		}

		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:747", ie_status, base + CIO2_REG_INT_STS_EXT_IE);
...
static irqreturn_t cio2_irq(int irq, void *cio2_ptr)
{
	...
	int_status = pete_readl("drivers/media/pci/intel/ipu3/ipu3-cio2.c:763", base + CIO2_REG_INT_STS);
	dev_dbg(dev, "isr enter - interrupt status 0x%x\n", int_status);
	if (!int_status)
		return IRQ_NONE;

	do {
		pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:769", int_status, base + CIO2_REG_INT_STS);
		cio2_irq_handle_once(cio2, int_status);
		int_status = pete_readl("drivers/media/pci/intel/ipu3/ipu3-cio2.c:771", base + CIO2_REG_INT_STS);
		if (int_status)
...
static void cio2_vb2_buf_queue(struct vb2_buffer *vb)
{
	...
	fbpt_rp = (pete_readl("drivers/media/pci/intel/ipu3/ipu3-cio2.c:918", cio2->base + CIO2_REG_CDMARI(CIO2_DMA_CHAN))
...
static int __maybe_unused cio2_runtime_suspend(struct device *dev)
{
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:1863", CIO2_D0I3C_I3, base + CIO2_REG_D0I3C);
...
static int __maybe_unused cio2_runtime_resume(struct device *dev)
{
	...
	pete_writel("drivers/media/pci/intel/ipu3/ipu3-cio2.c:1881", CIO2_D0I3C_RR, base + CIO2_REG_D0I3C);
