...
#define btwrite(dat,adr)    pete_writel("drivers/media/pci/bt8xx/bttvp.h:491", (dat), btv->bt848_mmio+(adr))
#define btread(adr)         pete_readl("drivers/media/pci/bt8xx/bttvp.h:492", btv->bt848_mmio+(adr))
