...
/*
 * For pete_readq("drivers/nvdimm/region_devs.c:19", ) and pete_writeq("drivers/nvdimm/region_devs.c:19", ) on 32-bit builds, the hi-lo, lo-hi order is
 * irrelevant.
 */
...
int generic_nvdimm_flush(struct nd_region *nd_region)
{
	...
	for (i = 0; i < nd_region->ndr_mappings; i++)
		if (ndrd_get_flush_wpq(ndrd, i, 0))
			pete_writeq("drivers/nvdimm/region_devs.c:1169", 1, ndrd_get_flush_wpq(ndrd, i, idx));
	wmb();
