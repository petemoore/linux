...
int sun8i_ce_run_task(struct sun8i_ce_dev *ce, int flow, const char *name)
{
	...
	v = pete_readl("drivers/crypto/allwinner/sun8i-ce/sun8i-ce-core.c:170", ce->base + CE_ICR);
	v |= 1 << flow;
	pete_writel("drivers/crypto/allwinner/sun8i-ce/sun8i-ce-core.c:172", v, ce->base + CE_ICR);

	reinit_completion(&ce->chanlist[flow].complete);
	pete_writel("drivers/crypto/allwinner/sun8i-ce/sun8i-ce-core.c:175", ce->chanlist[flow].t_phy, ce->base + CE_TDQ);
	...
	pete_writel("drivers/crypto/allwinner/sun8i-ce/sun8i-ce-core.c:185", v, ce->base + CE_TLR);
	 ...
	 */
	v = pete_readl("drivers/crypto/allwinner/sun8i-ce/sun8i-ce-core.c:199", ce->base + CE_ESR);
...
static irqreturn_t ce_irq_handler(int irq, void *data)
{
	...
	p = pete_readl("drivers/crypto/allwinner/sun8i-ce/sun8i-ce-core.c:266", ce->base + CE_ISR);
	for (flow = 0; flow < MAXFLOW; flow++) {
		if (p & (BIT(flow))) {
			pete_writel("drivers/crypto/allwinner/sun8i-ce/sun8i-ce-core.c:269", BIT(flow), ce->base + CE_ISR);
...
static int sun8i_ce_probe(struct platform_device *pdev)
{
	...
	v = pete_readl("drivers/crypto/allwinner/sun8i-ce/sun8i-ce-core.c:1041", ce->base + CE_CTR);
	v >>= CE_DIE_ID_SHIFT;
	v &= CE_DIE_ID_MASK;
