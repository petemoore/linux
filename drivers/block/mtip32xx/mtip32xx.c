...
static int mtip_hba_reset(struct driver_data *dd)
{
	...
	/* Set the reset bit */
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:172", HOST_RESET, dd->mmio + HOST_CTL);

	/* Flush */
	pete_readl("drivers/block/mtip32xx/mtip32xx.c:175", dd->mmio + HOST_CTL);
	...
	} while ((pete_readl("drivers/block/mtip32xx/mtip32xx.c:187", dd->mmio + HOST_CTL) & HOST_RESET)
		 && time_before(jiffies, timeout));

	if (pete_readl("drivers/block/mtip32xx/mtip32xx.c:190", dd->mmio + HOST_CTL) & HOST_RESET)
		return -1;
...
static inline void mtip_issue_ncq_command(struct mtip_port *port, int tag)
{
	...
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:214", (1 << MTIP_TAG_BIT(tag)),
			port->s_active[MTIP_TAG_INDEX(tag)]);
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:216", (1 << MTIP_TAG_BIT(tag)),
...
static int mtip_enable_fis(struct mtip_port *port, int enable)
{
	...
	tmp = pete_readl("drivers/block/mtip32xx/mtip32xx.c:235", port->mmio + PORT_CMD);
	if (enable)
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:237", tmp | PORT_CMD_FIS_RX, port->mmio + PORT_CMD);
	else
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:239", tmp & ~PORT_CMD_FIS_RX, port->mmio + PORT_CMD);

	/* Flush */
	pete_readl("drivers/block/mtip32xx/mtip32xx.c:242", port->mmio + PORT_CMD);
...
static int mtip_enable_engine(struct mtip_port *port, int enable)
{
	...
	/* enable FIS reception */
	tmp = pete_readl("drivers/block/mtip32xx/mtip32xx.c:261", port->mmio + PORT_CMD);
	if (enable)
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:263", tmp | PORT_CMD_START, port->mmio + PORT_CMD);
	else
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:265", tmp & ~PORT_CMD_START, port->mmio + PORT_CMD);

	pete_readl("drivers/block/mtip32xx/mtip32xx.c:267", port->mmio + PORT_CMD);
...
static inline void mtip_deinit_port(struct mtip_port *port)
{
	...
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:298", 0, port->mmio + PORT_IRQ_MASK);
...
static void mtip_init_port(struct mtip_port *port)
{
	...
	if (pete_readl("drivers/block/mtip32xx/mtip32xx.c:326", port->dd->mmio + HOST_CAP) & HOST_CAP_64) {
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:327", (port->command_list_dma >> 16) >> 16,
			 port->mmio + PORT_LST_ADDR_HI);
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:329", (port->rxfis_dma >> 16) >> 16,
			 port->mmio + PORT_FIS_ADDR_HI);
		set_bit(MTIP_PF_HOST_CAP_64, &port->flags);
	}

	pete_writel("drivers/block/mtip32xx/mtip32xx.c:334", port->command_list_dma & 0xFFFFFFFF,
			port->mmio + PORT_LST_ADDR);
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:336", port->rxfis_dma & 0xFFFFFFFF, port->mmio + PORT_FIS_ADDR);

	/* Clear SError */
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:339", pete_readl("drivers/block/mtip32xx/mtip32xx.c:339", port->mmio + PORT_SCR_ERR), port->mmio + PORT_SCR_ERR);

	/* reset the completed registers.*/
	for (i = 0; i < port->dd->slot_groups; i++)
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:343", 0xFFFFFFFF, port->completed[i]);

	/* Clear any pending interrupts for this port */
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:346", pete_readl("drivers/block/mtip32xx/mtip32xx.c:346", port->mmio + PORT_IRQ_STAT), port->mmio + PORT_IRQ_STAT);

	/* Clear any pending interrupts on the HBA. */
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:349", pete_readl("drivers/block/mtip32xx/mtip32xx.c:349", port->dd->mmio + HOST_IRQ_STAT),
					port->dd->mmio + HOST_IRQ_STAT);

	/* Enable port interrupts */
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:353", DEF_PORT_IRQ, port->mmio + PORT_IRQ_MASK);
}
...
static void mtip_restart_port(struct mtip_port *port)
{
	...
	while ((pete_readl("drivers/block/mtip32xx/mtip32xx.c:373", port->mmio + PORT_CMD) & PORT_CMD_LIST_ON)
		 && time_before(jiffies, timeout))
		;
	 ...
	 */
	if (pete_readl("drivers/block/mtip32xx/mtip32xx.c:384", port->mmio + PORT_CMD) & PORT_CMD_LIST_ON) {
	...
	/* Set PxSCTL.DET */
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:399", pete_readl("drivers/block/mtip32xx/mtip32xx.c:399", port->mmio + PORT_SCR_CTL) |
			 1, port->mmio + PORT_SCR_CTL);
	pete_readl("drivers/block/mtip32xx/mtip32xx.c:401", port->mmio + PORT_SCR_CTL);
	...
	/* Clear PxSCTL.DET */
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:412", pete_readl("drivers/block/mtip32xx/mtip32xx.c:412", port->mmio + PORT_SCR_CTL) & ~1,
			 port->mmio + PORT_SCR_CTL);
	pete_readl("drivers/block/mtip32xx/mtip32xx.c:414", port->mmio + PORT_SCR_CTL);

	/* Wait 500 ms for bit 0 of PORT_SCR_STS to be set */
	timeout = jiffies + msecs_to_jiffies(500);
	while (((pete_readl("drivers/block/mtip32xx/mtip32xx.c:418", port->mmio + PORT_SCR_STAT) & 0x01) == 0)
			 && time_before(jiffies, timeout))
		;
	...
	if ((pete_readl("drivers/block/mtip32xx/mtip32xx.c:425", port->mmio + PORT_SCR_STAT) & 0x01) == 0)
		dev_warn(&port->dd->pdev->dev,
			"COM reset failed\n");
...
static int mtip_device_reset(struct driver_data *dd)
{
	...
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:449", pete_readl("drivers/block/mtip32xx/mtip32xx.c:449", dd->mmio + HOST_CTL) | HOST_IRQ_EN,
					dd->mmio + HOST_CTL);
	return rv;
}
...
static void mtip_handle_tfe(struct driver_data *dd)
{
	...
	for (group = 0; group < dd->slot_groups; group++) {
		completed = pete_readl("drivers/block/mtip32xx/mtip32xx.c:524", port->completed[group]);

		dev_warn(&dd->pdev->dev, "g=%u, comp=%x\n", group, completed);

		/* clear completed status register in the hardware.*/
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:529", completed, port->completed[group]);
							...
							u32 completed)
{
	...
	/* clear completed status register in the hardware.*/
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:658", completed, port->completed[group]);
	...
	if (atomic_dec_return(&dd->irq_workers_active) == 0)
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:677", 0xffffffff, dd->mmio + HOST_IRQ_STAT);
}
...
static inline void mtip_process_legacy(struct driver_data *dd, u32 port_stat)
{
	...
	if (test_bit(MTIP_PF_IC_ACTIVE_BIT, &port->flags) && cmd) {
		...
		int status = pete_readl("drivers/block/mtip32xx/mtip32xx.c:690", port->cmd_issue[group]);
...
static inline void mtip_process_errors(struct driver_data *dd, u32 port_stat)
{
	if (unlikely(port_stat & PORT_IRQ_CONNECT)) {
		...
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:705", (1 << 26), dd->port->mmio + PORT_SCR_ERR);
	}

	if (unlikely(port_stat & PORT_IRQ_PHYRDY)) {
		dev_warn(&dd->pdev->dev,
			"Clearing PxSERR.DIAG.n\n");
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:711", (1 << 16), dd->port->mmio + PORT_SCR_ERR);
	}
...
static inline irqreturn_t mtip_handle_irq(struct driver_data *data)
{
	...
	hba_stat = pete_readl("drivers/block/mtip32xx/mtip32xx.c:736", dd->mmio + HOST_IRQ_STAT);
	if (hba_stat) {
		rv = IRQ_HANDLED;

		/* Acknowledge the interrupt status on the port.*/
		port_stat = pete_readl("drivers/block/mtip32xx/mtip32xx.c:741", port->mmio + PORT_IRQ_STAT);
		if (unlikely(port_stat == 0xFFFFFFFF)) {
			mtip_check_surprise_removal(dd);
			return IRQ_HANDLED;
		}
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:746", port_stat, port->mmio + PORT_IRQ_STAT);
		...
		if (likely(port_stat & PORT_IRQ_SDB_FIS)) {
			...
			for (i = 0, workers = 0; i < MTIP_MAX_SLOT_GROUPS;
									i++) {
				twork = &dd->work[i];
				twork->completed = pete_readl("drivers/block/mtip32xx/mtip32xx.c:757", port->completed[i]);
				if (twork->completed)
					workers++;
			}
	...
	if (unlikely(do_irq_enable))
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:804", hba_stat, dd->mmio + HOST_IRQ_STAT);
...
{
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:828", 1 << MTIP_TAG_BIT(tag), port->cmd_issue[MTIP_TAG_INDEX(tag)]);
}
				...
				struct host_to_dev_fis *fis)
{
	...
	task_file_data = pete_readl("drivers/block/mtip32xx/mtip32xx.c:836", port->mmio+PORT_TFDATA);
	if ((task_file_data & 1))
		return false;
...
static bool mtip_commands_active(struct mtip_port *port)
{
	 ...
	 */
	active = pete_readl("drivers/block/mtip32xx/mtip32xx.c:872", port->s_active[0]) & 0xFFFFFFFE;
	for (n = 1; n < port->dd->slot_groups; n++)
		active |= pete_readl("drivers/block/mtip32xx/mtip32xx.c:874", port->s_active[n]);
					...
					unsigned long timeout)
{
	...
	if (pete_readl("drivers/block/mtip32xx/mtip32xx.c:1027", port->cmd_issue[MTIP_TAG_INDEX(MTIP_TAG_INTERNAL)])
			       ...
			       int outtotal)
{
	...
	task_file_data = pete_readl("drivers/block/mtip32xx/mtip32xx.c:1851", dd->port->mmio+PORT_TFDATA);
				  ...
				  size_t len, loff_t *offset)
{
	...
	for (n = dd->slot_groups-1; n >= 0; n--)
		size += sprintf(&buf[size], "%08X ",
					 pete_readl("drivers/block/mtip32xx/mtip32xx.c:2185", dd->port->s_active[n]));
	...
	for (n = dd->slot_groups-1; n >= 0; n--)
		size += sprintf(&buf[size], "%08X ",
					pete_readl("drivers/block/mtip32xx/mtip32xx.c:2192", dd->port->cmd_issue[n]));
	...
	for (n = dd->slot_groups-1; n >= 0; n--)
		size += sprintf(&buf[size], "%08X ",
				pete_readl("drivers/block/mtip32xx/mtip32xx.c:2199", dd->port->completed[n]));

	size += sprintf(&buf[size], "]\n");
	size += sprintf(&buf[size], "H/ PORT IRQ STAT : [ 0x%08X ]\n",
				pete_readl("drivers/block/mtip32xx/mtip32xx.c:2203", dd->port->mmio + PORT_IRQ_STAT));
	size += sprintf(&buf[size], "H/ HOST IRQ STAT : [ 0x%08X ]\n",
				pete_readl("drivers/block/mtip32xx/mtip32xx.c:2205", dd->mmio + HOST_IRQ_STAT));
	size += sprintf(&buf[size], "\n");
...
{
	u32 hwdata;
	hwdata = pete_readl("drivers/block/mtip32xx/mtip32xx.c:2309", dd->mmio + HOST_HSORG);

	/* interrupt bug workaround: use only 1 IS bit.*/
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:2312", hwdata |
...
static void mtip_detect_product(struct driver_data *dd)
{
	 ...
	 */
	hwdata = pete_readl("drivers/block/mtip32xx/mtip32xx.c:2345", dd->mmio + HOST_HSORG);
...
static int mtip_hw_init(struct driver_data *dd)
{
	...
	while (((pete_readl("drivers/block/mtip32xx/mtip32xx.c:2771", dd->port->mmio + PORT_SCR_STAT) & 0x0F) != 0x03) &&
		 time_before(jiffies, timeout)) {
		mdelay(100);
	}
	if (unlikely(mtip_check_surprise_removal(dd))) {
	...
	if (!(pete_readl("drivers/block/mtip32xx/mtip32xx.c:2793", dd->mmio + HOST_CAP) & HOST_CAP_NZDMA)) {
		if (mtip_hba_reset(dd) < 0) {
			dev_err(&dd->pdev->dev,
		...
		/* Clear any pending interrupts on the HBA */
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:2802", pete_readl("drivers/block/mtip32xx/mtip32xx.c:2802", dd->mmio + HOST_IRQ_STAT),
	...
	/* Enable interrupts on the HBA. */
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:2820", pete_readl("drivers/block/mtip32xx/mtip32xx.c:2820", dd->mmio + HOST_CTL) | HOST_IRQ_EN,
					dd->mmio + HOST_CTL);
...
out3:
	...
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:2834", pete_readl("drivers/block/mtip32xx/mtip32xx.c:2834", dd->mmio + HOST_CTL) & ~HOST_IRQ_EN,
			dd->mmio + HOST_CTL);
...
static int mtip_hw_exit(struct driver_data *dd)
{
	if (!dd->sr) {
		...
		/* Disable interrupts on the HBA. */
		pete_writel("drivers/block/mtip32xx/mtip32xx.c:2888", pete_readl("drivers/block/mtip32xx/mtip32xx.c:2888", dd->mmio + HOST_CTL) & ~HOST_IRQ_EN,
				dd->mmio + HOST_CTL);
	}
...
static int mtip_hw_suspend(struct driver_data *dd)
{
	...
	/* Disable interrupts on the HBA.*/
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:2954", pete_readl("drivers/block/mtip32xx/mtip32xx.c:2954", dd->mmio + HOST_CTL) & ~HOST_IRQ_EN,
			dd->mmio + HOST_CTL);
	mtip_deinit_port(dd->port);
...
static int mtip_hw_resume(struct driver_data *dd)
{
	...
	/* Enable interrupts on the HBA.*/
	pete_writel("drivers/block/mtip32xx/mtip32xx.c:2993", pete_readl("drivers/block/mtip32xx/mtip32xx.c:2993", dd->mmio + HOST_CTL) | HOST_IRQ_EN,
			dd->mmio + HOST_CTL);
