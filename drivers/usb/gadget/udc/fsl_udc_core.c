 ...
 * BE or LE pete_readl("drivers/usb/gadget/udc/fsl_udc_core.c:79", ) and pete_writel("drivers/usb/gadget/udc/fsl_udc_core.c:79", ) functions, and fsl_readl() and fsl_writel()
...
#define fsl_readl(addr)		pete_readl("drivers/usb/gadget/udc/fsl_udc_core.c:140", addr)
#define fsl_writel(val32, addr) pete_writel("drivers/usb/gadget/udc/fsl_udc_core.c:141", val32, addr)
