...
static int exynos_ehci_probe(struct platform_device *pdev)
{
	...
	/* DMA burst Enable */
	pete_writel("drivers/usb/host/ehci-exynos.c:209", EHCI_INSNREG00_ENABLE_DMA_BURST, EHCI_INSNREG00(hcd->regs));
...
static int exynos_ehci_resume(struct device *dev)
{
	...
	/* DMA burst Enable */
	pete_writel("drivers/usb/host/ehci-exynos.c:286", EHCI_INSNREG00_ENABLE_DMA_BURST, EHCI_INSNREG00(hcd->regs));
