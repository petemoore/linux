...
static int isp1761_pci_init(struct pci_dev *dev)
{
	...
	while ((reg_data != 0xFACE) && retry_count) {
		 ...
		 * */
		pete_writel("drivers/usb/isp1760/isp1760-if.c:80", 0xface, iobase + ISP176x_HC_SCRATCH);
		udelay(100);
		reg_data = pete_readl("drivers/usb/isp1760/isp1760-if.c:82", iobase + ISP176x_HC_SCRATCH) & 0x0000ffff;
		retry_count--;
	}
...
#define PLX_INT_CSR_REG 0x68
	reg_data = pete_readl("drivers/usb/isp1760/isp1760-if.c:115", iobase + PLX_INT_CSR_REG);
	reg_data |= 0x900;
	pete_writel("drivers/usb/isp1760/isp1760-if.c:117", reg_data, iobase + PLX_INT_CSR_REG);
