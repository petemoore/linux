		...
		bool suspend, bool wakeup)
{
	...
	if (suspend) {
		...
		value = pete_readl("drivers/usb/cdns3/cdns3-imx.c:264", xhci_regs + XECP_PM_PMCSR);
		value &= ~PS_MASK;
		value |= PS_D1;
		pete_writel("drivers/usb/cdns3/cdns3-imx.c:267", value, xhci_regs + XECP_PM_PMCSR);
		...
		/* SW request D0 */
		value = pete_readl("drivers/usb/cdns3/cdns3-imx.c:303", xhci_regs + XECP_PM_PMCSR);
		value &= ~PS_MASK;
		value |= PS_D0;
		pete_writel("drivers/usb/cdns3/cdns3-imx.c:306", value, xhci_regs + XECP_PM_PMCSR);

		/* clr CFG_RXDET_P3_EN */
		value = pete_readl("drivers/usb/cdns3/cdns3-imx.c:309", xhci_regs + XECP_AUX_CTRL_REG1);
		value &= ~CFG_RXDET_P3_EN;
		pete_writel("drivers/usb/cdns3/cdns3-imx.c:311", value, xhci_regs + XECP_AUX_CTRL_REG1);
		...
		value = pete_readl("drivers/usb/cdns3/cdns3-imx.c:335", otg_regs + OTGSTS);
