...
DECLARE_EVENT_CLASS(cdns3_log_epx_irq,
	...
	TP_fast_assign(
		...
		__entry->ep_sts = pete_readl("drivers/usb/cdns3/cdns3-trace.h:129", &priv_dev->regs->ep_sts);
		__entry->ep_traddr = pete_readl("drivers/usb/cdns3/cdns3-trace.h:130", &priv_dev->regs->ep_traddr);
