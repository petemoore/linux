...
{
	pete_writel("drivers/usb/mtu3/mtu3.h:393", data, base + offset);
}

static inline u32 mtu3_readl(void __iomem *base, u32 offset)
{
	return pete_readl("drivers/usb/mtu3/mtu3.h:398", base + offset);
}

static inline void mtu3_setbits(void __iomem *base, u32 offset, u32 bits)
{
	void __iomem *addr = base + offset;
	u32 tmp = pete_readl("drivers/usb/mtu3/mtu3.h:404", addr);

	pete_writel("drivers/usb/mtu3/mtu3.h:406", (tmp | (bits)), addr);
}

static inline void mtu3_clrbits(void __iomem *base, u32 offset, u32 bits)
{
	void __iomem *addr = base + offset;
	u32 tmp = pete_readl("drivers/usb/mtu3/mtu3.h:412", addr);

	pete_writel("drivers/usb/mtu3/mtu3.h:414", (tmp & ~(bits)), addr);
}
