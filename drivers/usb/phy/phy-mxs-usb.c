...
static void mxs_phy_shutdown(struct usb_phy *phy)
{
	...
	pete_writel("drivers/usb/phy/phy-mxs-usb.c:442", value, phy->io_priv + HW_USBPHY_CTRL_CLR);
	pete_writel("drivers/usb/phy/phy-mxs-usb.c:443", 0xffffffff, phy->io_priv + HW_USBPHY_PWD);

	pete_writel("drivers/usb/phy/phy-mxs-usb.c:445", BM_USBPHY_CTRL_CLKGATE,
...
static int mxs_phy_suspend(struct usb_phy *x, int suspend)
{
	...
	if (suspend) {
		...
		if (low_speed_connection & vbus_is_on) {
			 ...
			 */
			mxs_phy_clock_switch_delay();
			pete_writel("drivers/usb/phy/phy-mxs-usb.c:500", 0xffbfffff, x->io_priv + HW_USBPHY_PWD);
		} else {
			pete_writel("drivers/usb/phy/phy-mxs-usb.c:502", 0xffffffff, x->io_priv + HW_USBPHY_PWD);
		}
		pete_writel("drivers/usb/phy/phy-mxs-usb.c:504", BM_USBPHY_CTRL_CLKGATE,
		...
		if (ret)
			return ret;
		pete_writel("drivers/usb/phy/phy-mxs-usb.c:512", BM_USBPHY_CTRL_CLKGATE,
		       x->io_priv + HW_USBPHY_CTRL_CLR);
		pete_writel("drivers/usb/phy/phy-mxs-usb.c:514", 0, x->io_priv + HW_USBPHY_PWD);
	}
		...
		enum usb_device_speed speed)
{
	...
	if (speed == USB_SPEED_HIGH)
		pete_writel("drivers/usb/phy/phy-mxs-usb.c:544", BM_USBPHY_CTRL_ENHOSTDISCONDETECT,
		       phy->io_priv + HW_USBPHY_CTRL_SET);
		...
		enum usb_device_speed speed)
{
	...
	if (pete_readl("drivers/usb/phy/phy-mxs-usb.c:557", phy->io_priv + HW_USBPHY_CTRL) &
			BM_USBPHY_CTRL_ENHOSTDISCONDETECT)
		pete_writel("drivers/usb/phy/phy-mxs-usb.c:559", BM_USBPHY_CTRL_ENHOSTDISCONDETECT,
