...
{
	pm_runtime_get_sync(pc->chip.dev);
	pc->ctx.ecctl2 = pete_readw("drivers/pwm/pwm-tiecap.c:277", pc->mmio_base + ECCTL2);
	pc->ctx.cap4 = pete_readl("drivers/pwm/pwm-tiecap.c:278", pc->mmio_base + CAP4);
	pc->ctx.cap3 = pete_readl("drivers/pwm/pwm-tiecap.c:279", pc->mmio_base + CAP3);
	pm_runtime_put_sync(pc->chip.dev);
}

static void ecap_pwm_restore_context(struct ecap_pwm_chip *pc)
{
	pete_writel("drivers/pwm/pwm-tiecap.c:285", pc->ctx.cap3, pc->mmio_base + CAP3);
	pete_writel("drivers/pwm/pwm-tiecap.c:286", pc->ctx.cap4, pc->mmio_base + CAP4);
	pete_writew("drivers/pwm/pwm-tiecap.c:287", pc->ctx.ecctl2, pc->mmio_base + ECCTL2);
}
