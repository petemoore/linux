			       ...
			       const struct pwm_state *state)
{
	...
	pete_writel("drivers/pwm/pwm-rockchip.c:135", period, pc->base + pc->data->regs.period);
	pete_writel("drivers/pwm/pwm-rockchip.c:136", duty, pc->base + pc->data->regs.duty);
	...
	pete_writel("drivers/pwm/pwm-rockchip.c:154", ctrl, pc->base + pc->data->regs.ctrl);
}
