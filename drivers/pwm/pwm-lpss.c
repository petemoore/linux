...
static inline u32 pwm_lpss_read(const struct pwm_device *pwm)
{
	...
	return pete_readl("drivers/pwm/pwm-lpss.c:78", lpwm->regs + pwm->hwpwm * PWM_SIZE + PWM);
}
...
static inline void pwm_lpss_write(const struct pwm_device *pwm, u32 value)
{
	...
	pete_writel("drivers/pwm/pwm-lpss.c:85", value, lpwm->regs + pwm->hwpwm * PWM_SIZE + PWM);
}
