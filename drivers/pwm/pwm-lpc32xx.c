			      ...
			      int duty_ns, int period_ns)
{
	...
	val = pete_readl("drivers/pwm/pwm-lpc32xx.c:54", lpc32xx->base);
	val &= ~0xFFFF;
	val |= (period_cycles << 8) | duty_cycles;
	pete_writel("drivers/pwm/pwm-lpc32xx.c:57", val, lpc32xx->base);
...
static int lpc32xx_pwm_enable(struct pwm_chip *chip, struct pwm_device *pwm)
{
	...
	val = pete_readl("drivers/pwm/pwm-lpc32xx.c:72", lpc32xx->base);
	val |= PWM_ENABLE;
	pete_writel("drivers/pwm/pwm-lpc32xx.c:74", val, lpc32xx->base);
...
static void lpc32xx_pwm_disable(struct pwm_chip *chip, struct pwm_device *pwm)
{
	...
	val = pete_readl("drivers/pwm/pwm-lpc32xx.c:84", lpc32xx->base);
	val &= ~PWM_ENABLE;
	pete_writel("drivers/pwm/pwm-lpc32xx.c:86", val, lpc32xx->base);
...
static int lpc32xx_pwm_probe(struct platform_device *pdev)
{
	...
	val = pete_readl("drivers/pwm/pwm-lpc32xx.c:144", lpc32xx->base);
	val &= ~PWM_PIN_LEVEL;
	pete_writel("drivers/pwm/pwm-lpc32xx.c:146", val, lpc32xx->base);
