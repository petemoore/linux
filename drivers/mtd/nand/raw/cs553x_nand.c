				  ...
				  u32 ctl, u8 data)
{
	...
	pete_writeb("drivers/mtd/nand/raw/cs553x_nand.c:108", ctl, cs553x->mmio + MM_NAND_CTL);
	pete_writeb("drivers/mtd/nand/raw/cs553x_nand.c:109", data, cs553x->mmio + MM_NAND_IO);
...
static void cs553x_data_in(struct cs553x_nand_controller *cs553x, void *buf,
			   unsigned int len)
{
	pete_writeb("drivers/mtd/nand/raw/cs553x_nand.c:118", 0, cs553x->mmio + MM_NAND_CTL);
...
{
	pete_writeb("drivers/mtd/nand/raw/cs553x_nand.c:130", 0, cs553x->mmio + MM_NAND_CTL);
	while (unlikely(len > 0x800)) {
			  ...
			  bool check_only)
{
	...
	pete_writeb("drivers/mtd/nand/raw/cs553x_nand.c:204", 0, cs553x->mmio + MM_NAND_CTL);
	...
	pete_writeb("drivers/mtd/nand/raw/cs553x_nand.c:212", CS_NAND_CTL_CE, cs553x->mmio + MM_NAND_CTL);
...
static void cs_enable_hwecc(struct nand_chip *this, int mode)
{
	...
	pete_writeb("drivers/mtd/nand/raw/cs553x_nand.c:221", 0x07, cs553x->mmio + MM_NAND_ECC_CTL);
}
			    ...
			    u_char *ecc_code)
{
	...
	ecc = pete_readl("drivers/mtd/nand/raw/cs553x_nand.c:230", cs553x->mmio + MM_NAND_STS);
