...
static int gpmi_init(struct gpmi_nand_data *this)
{
	...
	/* Choose NAND mode. */
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:168", BM_GPMI_CTRL1_GPMI_MODE, r->gpmi_regs + HW_GPMI_CTRL1_CLR);

	/* Set the IRQ polarity. */
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:171", BM_GPMI_CTRL1_ATA_IRQRDY_POLARITY,
				r->gpmi_regs + HW_GPMI_CTRL1_SET);

	/* Disable Write-Protection. */
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:175", BM_GPMI_CTRL1_DEV_RESET, r->gpmi_regs + HW_GPMI_CTRL1_SET);

	/* Select BCH ECC. */
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:178", BM_GPMI_CTRL1_BCH_MODE, r->gpmi_regs + HW_GPMI_CTRL1_SET);
	 ...
	 * RDY_BUSY0.
	 */
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:185", BM_GPMI_CTRL1_DECOUPLE_CS | BM_GPMI_CTRL1_GANGED_RDYBUSY,
	       r->gpmi_regs + HW_GPMI_CTRL1_SET);
...
static void gpmi_dump_info(struct gpmi_nand_data *this)
{
	...
	for (i = 0; i <= HW_GPMI_DEBUG / 0x10 + 1; i++) {
		reg = pete_readl("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:204", r->gpmi_regs + i * 0x10);
	...
	for (i = 0; i <= HW_BCH_VERSION / 0x10 + 1; i++) {
		reg = pete_readl("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:211", r->bch_regs + i * 0x10);
		dev_err(this->dev, "offset 0x%.3x : 0x%.8x\n", i * 0x10, reg);
	}
...
static int bch_set_geometry(struct gpmi_nand_data *this)
{
	...
	*/
	...
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:756", 0, r->bch_regs + HW_BCH_LAYOUTSELECT);
...
static int gpmi_nfc_apply_timings(struct gpmi_nand_data *this)
{
	...
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:952", hw->timing0, gpmi_regs + HW_GPMI_TIMING0);
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:953", hw->timing1, gpmi_regs + HW_GPMI_TIMING1);

	/*
	 * Clear several CTRL1 fields, DLL must be disabled when setting
	 * RDN_DELAY or HALF_PERIOD.
	 */
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:959", BM_GPMI_CTRL1_CLEAR_MASK, gpmi_regs + HW_GPMI_CTRL1_CLR);
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:960", hw->ctrl1n, gpmi_regs + HW_GPMI_CTRL1_SET);
...
{
	struct resources *r = &this->resources;
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:1007", BM_BCH_CTRL_COMPLETE_IRQ, r->bch_regs + HW_BCH_CTRL_CLR);
}
			     ...
			     bool check_only)
{
	...
	if (this->bch) {
		pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:2586", this->bch_flashlayout0,
		       this->resources.bch_regs + HW_BCH_FLASH0LAYOUT0);
		pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:2588", this->bch_flashlayout1,
	...
	if (this->bch && buf_read) {
		pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:2600", BM_BCH_CTRL_COMPLETE_IRQ_EN,
	...
	pete_writel("drivers/mtd/nand/raw/gpmi-nand/gpmi-nand.c:2627", BM_BCH_CTRL_COMPLETE_IRQ_EN,
