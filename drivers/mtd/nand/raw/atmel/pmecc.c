...
static int atmel_pmecc_err_location(struct atmel_pmecc_user *user)
{
	...
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:644", PMERRLOC_DISABLE, pmecc->regs.errloc + ATMEL_PMERRLOC_ELDIS);
	...
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:656", val, pmecc->regs.errloc + ATMEL_PMERRLOC_ELCFG);
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:657", (sector_size * 8) + (degree * strength),
...
{
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:759", PMECC_CTRL_RST, pmecc->regs.base + ATMEL_PMECC_CTRL);
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:760", PMECC_CTRL_DISABLE, pmecc->regs.base + ATMEL_PMECC_CTRL);
}
...
int atmel_pmecc_enable(struct atmel_pmecc_user *user, int op)
{
	...
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:782", cfg, pmecc->regs.base + ATMEL_PMECC_CFG);
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:783", user->cache.sarea, pmecc->regs.base + ATMEL_PMECC_SAREA);
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:784", user->cache.saddr, pmecc->regs.base + ATMEL_PMECC_SADDR);
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:785", user->cache.eaddr, pmecc->regs.base + ATMEL_PMECC_EADDR);

	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:787", PMECC_CTRL_ENABLE, pmecc->regs.base + ATMEL_PMECC_CTRL);
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:788", PMECC_CTRL_DATA, pmecc->regs.base + ATMEL_PMECC_CTRL);
					...
					int pmecc_res_idx, int errloc_res_idx)
{
	...
	pete_writel("drivers/mtd/nand/raw/atmel/pmecc.c:847", 0xffffffff, pmecc->regs.base + ATMEL_PMECC_IDR);
