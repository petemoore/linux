...
{
	pete_writel("drivers/mtd/nand/raw/mtk_nand.c:230", val, nfc->regs + reg);
}

static inline void nfi_writew(struct mtk_nfc *nfc, u16 val, u32 reg)
{
	pete_writew("drivers/mtd/nand/raw/mtk_nand.c:235", val, nfc->regs + reg);
}

static inline void nfi_writeb(struct mtk_nfc *nfc, u8 val, u32 reg)
{
	pete_writeb("drivers/mtd/nand/raw/mtk_nand.c:240", val, nfc->regs + reg);
}
