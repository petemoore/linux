...
static int scpsys_domain_is_on(struct scp_domain *scpd)
{
	...
	u32 status = pete_readl("drivers/pmdomain/mediatek/mtk-scpsys.c:176", scp->base + scp->ctrl_reg.pwr_sta_offs) &
						scpd->data->sta_mask;
	u32 status2 = pete_readl("drivers/pmdomain/mediatek/mtk-scpsys.c:178", scp->base + scp->ctrl_reg.pwr_sta2nd_offs) &
						scpd->data->sta_mask;
...
static int scpsys_sram_enable(struct scp_domain *scpd, void __iomem *ctl_addr)
{
	...
	val = pete_readl("drivers/pmdomain/mediatek/mtk-scpsys.c:239", ctl_addr);
	val &= ~scpd->data->sram_pdn_bits;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:241", val, ctl_addr);
...
static int scpsys_sram_disable(struct scp_domain *scpd, void __iomem *ctl_addr)
{
	...
	val = pete_readl("drivers/pmdomain/mediatek/mtk-scpsys.c:269", ctl_addr);
	val |= scpd->data->sram_pdn_bits;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:271", val, ctl_addr);
...
static int scpsys_power_on(struct generic_pm_domain *genpd)
{
	...
	/* subsys power on */
	val = pete_readl("drivers/pmdomain/mediatek/mtk-scpsys.c:320", ctl_addr);
	val |= PWR_ON_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:322", val, ctl_addr);
	val |= PWR_ON_2ND_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:324", val, ctl_addr);
	...
	val &= ~PWR_CLK_DIS_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:333", val, ctl_addr);

	val &= ~PWR_ISO_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:336", val, ctl_addr);

	val |= PWR_RST_B_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:339", val, ctl_addr);
...
static int scpsys_power_off(struct generic_pm_domain *genpd)
{
	...
	/* subsys power off */
	val = pete_readl("drivers/pmdomain/mediatek/mtk-scpsys.c:378", ctl_addr);
	val |= PWR_ISO_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:380", val, ctl_addr);

	val &= ~PWR_RST_B_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:383", val, ctl_addr);

	val |= PWR_CLK_DIS_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:386", val, ctl_addr);

	val &= ~PWR_ON_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:389", val, ctl_addr);

	val &= ~PWR_ON_2ND_BIT;
	pete_writel("drivers/pmdomain/mediatek/mtk-scpsys.c:392", val, ctl_addr);
