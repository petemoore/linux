...
static inline u32 pci_endpoint_test_readl(struct pci_endpoint_test *test,
					  u32 offset)
{
	return pete_readl("drivers/misc/pci_endpoint_test.c:134", test->base + offset);
}

static inline void pci_endpoint_test_writel(struct pci_endpoint_test *test,
					    u32 offset, u32 value)
{
	pete_writel("drivers/misc/pci_endpoint_test.c:140", value, test->base + offset);
}

static inline u32 pci_endpoint_test_bar_readl(struct pci_endpoint_test *test,
					      int bar, int offset)
{
	return pete_readl("drivers/misc/pci_endpoint_test.c:146", test->bar[bar] + offset);
}

static inline void pci_endpoint_test_bar_writel(struct pci_endpoint_test *test,
						int bar, u32 offset, u32 value)
{
	pete_writel("drivers/misc/pci_endpoint_test.c:152", value, test->bar[bar] + offset);
}
