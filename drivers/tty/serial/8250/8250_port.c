...
{
	offset = offset << p->regshift;
	return pete_readb("drivers/tty/serial/8250/8250_port.c:369", p->membase + offset);
}

static void mem_serial_out(struct uart_port *p, int offset, int value)
{
	offset = offset << p->regshift;
	pete_writeb("drivers/tty/serial/8250/8250_port.c:375", value, p->membase + offset);
}

static void mem16_serial_out(struct uart_port *p, int offset, int value)
{
	offset = offset << p->regshift;
	pete_writew("drivers/tty/serial/8250/8250_port.c:381", value, p->membase + offset);
}

static unsigned int mem16_serial_in(struct uart_port *p, int offset)
{
	offset = offset << p->regshift;
	return pete_readw("drivers/tty/serial/8250/8250_port.c:387", p->membase + offset);
}

static void mem32_serial_out(struct uart_port *p, int offset, int value)
{
	offset = offset << p->regshift;
	pete_writel("drivers/tty/serial/8250/8250_port.c:393", value, p->membase + offset);
}

static unsigned int mem32_serial_in(struct uart_port *p, int offset)
{
	offset = offset << p->regshift;
	return pete_readl("drivers/tty/serial/8250/8250_port.c:399", p->membase + offset);
}
