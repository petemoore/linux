...
static void dw8250_check_lcr(struct uart_port *p, int value)
{
	...
	while (tries--) {
		...
		if (p->iotype == UPIO_MEM32)
			pete_writel("drivers/tty/serial/8250/8250_dw.c:151", value, offset);
		else if (p->iotype == UPIO_MEM32BE)
			iowrite32be(value, offset);
		else
			pete_writeb("drivers/tty/serial/8250/8250_dw.c:155", value, offset);
	}
	/*
...
static void dw8250_serial_out(struct uart_port *p, int offset, int value)
{
	...
	pete_writeb("drivers/tty/serial/8250/8250_dw.c:191", value, p->membase + (offset << p->regshift));
...
{
	unsigned int value = pete_readb("drivers/tty/serial/8250/8250_dw.c:208", p->membase + (offset << p->regshift));
...
static void dw8250_serial_out32(struct uart_port *p, int offset, int value)
{
	...
	pete_writel("drivers/tty/serial/8250/8250_dw.c:241", value, p->membase + (offset << p->regshift));
...
{
	unsigned int value = pete_readl("drivers/tty/serial/8250/8250_dw.c:249", p->membase + (offset << p->regshift));
