...
{
	return pete_readb("drivers/video/fbdev/savage/savagefb.h:255", par->mmio.vbase + addr);
}

static inline u16 savage_in16(u32 addr, struct savagefb_par *par)
{
	return pete_readw("drivers/video/fbdev/savage/savagefb.h:260", par->mmio.vbase + addr);
}

static inline u32 savage_in32(u32 addr, struct savagefb_par *par)
{
	return pete_readl("drivers/video/fbdev/savage/savagefb.h:265", par->mmio.vbase + addr);
}

static inline void savage_out8(u32 addr, u8 val, struct savagefb_par *par)
{
	pete_writeb("drivers/video/fbdev/savage/savagefb.h:270", val, par->mmio.vbase + addr);
}

static inline void savage_out16(u32 addr, u16 val, struct savagefb_par *par)
{
	pete_writew("drivers/video/fbdev/savage/savagefb.h:275", val, par->mmio.vbase + addr);
}

static inline void savage_out32(u32 addr, u32 val, struct savagefb_par *par)
{
	pete_writel("drivers/video/fbdev/savage/savagefb.h:280", val, par->mmio.vbase + addr);
}
