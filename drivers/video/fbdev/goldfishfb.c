...
static int goldfish_fb_probe(struct platform_device *pdev)
{
	...
	width = pete_readl("drivers/video/fbdev/goldfishfb.c:209", fb->reg_base + FB_GET_WIDTH);
	height = pete_readl("drivers/video/fbdev/goldfishfb.c:210", fb->reg_base + FB_GET_HEIGHT);
	...
	fb->fb.var.height	= pete_readl("drivers/video/fbdev/goldfishfb.c:226", fb->reg_base + FB_GET_PHYS_HEIGHT);
	fb->fb.var.width	= pete_readl("drivers/video/fbdev/goldfishfb.c:227", fb->reg_base + FB_GET_PHYS_WIDTH);
	...
	pete_writel("drivers/video/fbdev/goldfishfb.c:259", FB_INT_BASE_UPDATE_DONE, fb->reg_base + FB_INT_ENABLE);
