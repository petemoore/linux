...
{
	u32 ret = pete_readl("drivers/video/fbdev/sstfb.c:185", vbase + reg);
...
static inline void __sst_write(u8 __iomem *vbase, u32 reg, u32 val)
{
	...
	pete_writel("drivers/video/fbdev/sstfb.c:193", val, vbase + reg);
}
...
static int sst_get_memsize(struct fb_info *info, __u32 *memsize)
{
	...
	pete_writel("drivers/video/fbdev/sstfb.c:838", 0xdeadbeef, fbbase_virt);
	pete_writel("drivers/video/fbdev/sstfb.c:839", 0xdeadbeef, fbbase_virt+0x100000);
	pete_writel("drivers/video/fbdev/sstfb.c:840", 0xdeadbeef, fbbase_virt+0x200000);
	f_ddprintk("0MB: %#x, 1MB: %#x, 2MB: %#x\n",
	           pete_readl("drivers/video/fbdev/sstfb.c:842", fbbase_virt), pete_readl("drivers/video/fbdev/sstfb.c:842", fbbase_virt + 0x100000),
	           pete_readl("drivers/video/fbdev/sstfb.c:843", fbbase_virt + 0x200000));

	pete_writel("drivers/video/fbdev/sstfb.c:845", 0xabcdef01, fbbase_virt);

	f_ddprintk("0MB: %#x, 1MB: %#x, 2MB: %#x\n",
	           pete_readl("drivers/video/fbdev/sstfb.c:848", fbbase_virt), pete_readl("drivers/video/fbdev/sstfb.c:848", fbbase_virt + 0x100000),
	           pete_readl("drivers/video/fbdev/sstfb.c:849", fbbase_virt + 0x200000));

	/* checks for 4mb lfb, then 2, then defaults to 1 */
	if (pete_readl("drivers/video/fbdev/sstfb.c:852", fbbase_virt + 0x200000) == 0xdeadbeef)
		*memsize = 0x400000;
	else if (pete_readl("drivers/video/fbdev/sstfb.c:854", fbbase_virt + 0x100000) == 0xdeadbeef)
		*memsize = 0x200000;
	else
		*memsize = 0x100000;
