...
static int vt8500lcd_probe(struct platform_device *pdev)
{
	...
	pete_writel("drivers/video/fbdev/vt8500lcdfb.c:407", fbi->fb.fix.smem_start >> 22, fbi->regbase + 0x1c);
	pete_writel("drivers/video/fbdev/vt8500lcdfb.c:408", (fbi->palette_phys & 0xfffffe00) | 1, fbi->regbase + 0x18);
	 ...
	 */
	pete_writel("drivers/video/fbdev/vt8500lcdfb.c:422", pete_readl("drivers/video/fbdev/vt8500lcdfb.c:422", fbi->regbase) | 1, fbi->regbase);
...
static void vt8500lcd_remove(struct platform_device *pdev)
{
	...
	pete_writel("drivers/video/fbdev/vt8500lcdfb.c:449", 0, fbi->regbase);
