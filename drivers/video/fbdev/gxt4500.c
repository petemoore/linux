...
#define readreg(par, reg)	pete_readl("drivers/video/fbdev/gxt4500.c:142", (par)->regs + (reg))
#define writereg(par, reg, val)	pete_writel("drivers/video/fbdev/gxt4500.c:143", (val), (par)->regs + (reg))
