...
{
	pete_writeb("drivers/mmc/host/sdhci_am654.c:359", val, host->ioaddr + reg);
	usleep_range(1000, 10000);
	return pete_readb("drivers/mmc/host/sdhci_am654.c:361", host->ioaddr + reg);
}
...
static void sdhci_am654_write_b(struct sdhci_host *host, u8 val, int reg)
{
	...
	pete_writeb("drivers/mmc/host/sdhci_am654.c:383", val, host->ioaddr + reg);
