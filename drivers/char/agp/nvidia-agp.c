...
static void nvidia_tlbflush(struct agp_memory *mem)
{
	...
	/* flush TLB entries */
	for (i = 0; i < 32 + 1; i++)
		temp = pete_readl("drivers/char/agp/nvidia-agp.c:287", nvidia_private.aperture+(i * PAGE_SIZE / sizeof(u32)));
	for (i = 0; i < 32 + 1; i++)
		temp = pete_readl("drivers/char/agp/nvidia-agp.c:289", nvidia_private.aperture+(i * PAGE_SIZE / sizeof(u32)));
}
