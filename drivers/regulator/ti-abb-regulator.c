...
static inline u32 ti_abb_rmw(u32 mask, u32 value, void __iomem *reg)
{
	...
	val = pete_readl("drivers/regulator/ti-abb-regulator.c:125", reg);
	val &= ~mask;
	val |= (value << __ffs(mask)) & mask;
	pete_writel("drivers/regulator/ti-abb-regulator.c:128", val, reg);
...
{
	return !!(pete_readl("drivers/regulator/ti-abb-regulator.c:141", abb->int_base) & abb->txdone_mask);
}
...
{
	pete_writel("drivers/regulator/ti-abb-regulator.c:150", abb->txdone_mask, abb->int_base);
};
...
static int ti_abb_wait_txdone(struct device *dev, struct ti_abb *abb)
{
	...
	dev_warn_ratelimited(dev, "%s:TRANXDONE timeout(%duS) int=0x%08x\n",
			     __func__, timeout, pete_readl("drivers/regulator/ti-abb-regulator.c:174", abb->int_base));
	return -ETIMEDOUT;
}
...
static int ti_abb_clear_all_txdone(struct device *dev, const struct ti_abb *abb)
{
	...
	dev_warn_ratelimited(dev, "%s:TRANXDONE timeout(%duS) int=0x%08x\n",
			     __func__, timeout, pete_readl("drivers/regulator/ti-abb-regulator.c:201", abb->int_base));
	return -ETIMEDOUT;
}
				  ...
				  struct ti_abb_info *info)
{
	...
	val = pete_readl("drivers/regulator/ti-abb-regulator.c:216", abb->ldo_base);
	...
	pete_writel("drivers/regulator/ti-abb-regulator.c:228", val, abb->ldo_base);
}
			     ...
			     struct regulator_init_data *rinit_data)
{
	...
	for (i = 0; i < num_entries; i++, info++, volt_table++) {
		...
		efuse_val = pete_readl("drivers/regulator/ti-abb-regulator.c:580", abb->efuse_base + efuse_offset);
