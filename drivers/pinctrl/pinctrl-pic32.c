...
static void pic32_gpio_irq_unmask(struct irq_data *data)
{
	...
	pete_writel("drivers/pinctrl/pinctrl-pic32.c:2019", BIT(PIC32_CNCON_ON), bank->reg_base + PIC32_SET(CNCON_REG));
}
...
static int pic32_gpio_irq_set_type(struct irq_data *data, unsigned int type)
{
	...
	case IRQ_TYPE_EDGE_RISING:
		/* enable RISE */
		pete_writel("drivers/pinctrl/pinctrl-pic32.c:2040", mask, bank->reg_base + PIC32_SET(CNEN_REG));
		/* disable FALL */
		pete_writel("drivers/pinctrl/pinctrl-pic32.c:2042", mask, bank->reg_base + PIC32_CLR(CNNE_REG));
		/* enable EDGE */
		pete_writel("drivers/pinctrl/pinctrl-pic32.c:2044", BIT(PIC32_CNCON_EDGE), bank->reg_base + PIC32_SET(CNCON_REG));
		break;
	case IRQ_TYPE_EDGE_FALLING:
		/* disable RISE */
		pete_writel("drivers/pinctrl/pinctrl-pic32.c:2048", mask, bank->reg_base + PIC32_CLR(CNEN_REG));
		/* enable FALL */
		pete_writel("drivers/pinctrl/pinctrl-pic32.c:2050", mask, bank->reg_base + PIC32_SET(CNNE_REG));
		/* enable EDGE */
		pete_writel("drivers/pinctrl/pinctrl-pic32.c:2052", BIT(PIC32_CNCON_EDGE), bank->reg_base + PIC32_SET(CNCON_REG));
		break;
	case IRQ_TYPE_EDGE_BOTH:
		/* enable RISE */
		pete_writel("drivers/pinctrl/pinctrl-pic32.c:2056", mask, bank->reg_base + PIC32_SET(CNEN_REG));
		/* enable FALL */
		pete_writel("drivers/pinctrl/pinctrl-pic32.c:2058", mask, bank->reg_base + PIC32_SET(CNNE_REG));
		/* enable EDGE */
		pete_writel("drivers/pinctrl/pinctrl-pic32.c:2060", BIT(PIC32_CNCON_EDGE), bank->reg_base + PIC32_SET(CNCON_REG));
		break;
	default:
		return -EINVAL;
	}
...
static u32 pic32_gpio_get_pending(struct gpio_chip *gc, unsigned long status)
{
	...
	cnen_rise = pete_readl("drivers/pinctrl/pinctrl-pic32.c:2078", bank->reg_base + CNEN_REG);
	cnne_fall = pete_readl("drivers/pinctrl/pinctrl-pic32.c:2079", bank->reg_base + CNNE_REG);
...
static void pic32_gpio_irq_handler(struct irq_desc *desc)
{
	...
	stat = pete_readl("drivers/pinctrl/pinctrl-pic32.c:2102", bank->reg_base + CNF_REG);
