...
{
	pete_writel("drivers/pinctrl/tegra/pinctrl-tegra-xusb.c:99", value, padctl->regs + offset);
}

static inline u32 padctl_readl(struct tegra_xusb_padctl *padctl,
			       unsigned long offset)
{
	return pete_readl("drivers/pinctrl/tegra/pinctrl-tegra-xusb.c:105", padctl->regs + offset);
}
