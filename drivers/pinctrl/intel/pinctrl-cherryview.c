...
static u32 chv_pctrl_readl(struct intel_pinctrl *pctrl, unsigned int offset)
{
	...
	return pete_readl("drivers/pinctrl/intel/pinctrl-cherryview.c:575", community->regs + offset);
}
...
static void chv_pctrl_writel(struct intel_pinctrl *pctrl, unsigned int offset, u32 value)
{
	...
	pete_writel("drivers/pinctrl/intel/pinctrl-cherryview.c:584", value, reg);
	pete_readl("drivers/pinctrl/intel/pinctrl-cherryview.c:585", reg);
}
...
{
	return pete_readl("drivers/pinctrl/intel/pinctrl-cherryview.c:602", chv_padreg(pctrl, pin, offset));
}
...
static void chv_writel(struct intel_pinctrl *pctrl, unsigned int pin, unsigned int offset, u32 value)
{
	...
	/* Write and simple read back to confirm the bus transferring done */
	pete_writel("drivers/pinctrl/intel/pinctrl-cherryview.c:610", value, reg);
	pete_readl("drivers/pinctrl/intel/pinctrl-cherryview.c:611", reg);
}
