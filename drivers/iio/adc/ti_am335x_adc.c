...
{
	return pete_readl("drivers/iio/adc/ti_am335x_adc.c:56", adc->mfd_tscadc->tscadc_base + reg);
}

static void tiadc_writel(struct tiadc_device *adc, unsigned int reg,
			 unsigned int val)
{
	pete_writel("drivers/iio/adc/ti_am335x_adc.c:62", val, adc->mfd_tscadc->tscadc_base + reg);
}
