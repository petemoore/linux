...
{
	return 0xff & pete_readb("drivers/staging/rtl8192e/rtl8192e/rtl_core.c:75", (u8 __iomem *)dev->mem_start + x);
}

u32 rtl92e_readl(struct net_device *dev, int x)
{
	return pete_readl("drivers/staging/rtl8192e/rtl8192e/rtl_core.c:80", (u8 __iomem *)dev->mem_start + x);
}

u16 rtl92e_readw(struct net_device *dev, int x)
{
	return pete_readw("drivers/staging/rtl8192e/rtl8192e/rtl_core.c:85", (u8 __iomem *)dev->mem_start + x);
}

void rtl92e_writeb(struct net_device *dev, int x, u8 y)
{
	pete_writeb("drivers/staging/rtl8192e/rtl8192e/rtl_core.c:90", y, (u8 __iomem *)dev->mem_start + x);
...
{
	pete_writel("drivers/staging/rtl8192e/rtl8192e/rtl_core.c:97", y, (u8 __iomem *)dev->mem_start + x);
...
{
	pete_writew("drivers/staging/rtl8192e/rtl8192e/rtl_core.c:104", y, (u8 __iomem *)dev->mem_start + x);
