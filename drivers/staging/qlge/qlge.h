...
{
	return pete_readl("drivers/staging/qlge/qlge.h:2183", qdev->reg_base + reg);
}
...
{
	pete_writel("drivers/staging/qlge/qlge.h:2191", val, qdev->reg_base + reg);
}
...
{
	pete_writel("drivers/staging/qlge/qlge.h:2206", val, addr);
}
