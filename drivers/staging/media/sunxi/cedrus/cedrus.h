...
{
	pete_writel("drivers/staging/media/sunxi/cedrus/cedrus.h:207", val, dev->base + reg);
}

static inline u32 cedrus_read(struct cedrus_dev *dev, u32 reg)
{
	return pete_readl("drivers/staging/media/sunxi/cedrus/cedrus.h:212", dev->base + reg);
}
