...
{
	return pete_readl("drivers/pci/controller/dwc/pci-dra7xx.c:107", pcie->base + offset);
}

static inline void dra7xx_pcie_writel(struct dra7xx_pcie *pcie, u32 offset,
				      u32 value)
{
	pete_writel("drivers/pci/controller/dwc/pci-dra7xx.c:113", value, pcie->base + offset);
}
