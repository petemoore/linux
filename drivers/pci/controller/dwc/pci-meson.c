...
{
	return pete_readl("drivers/pci/controller/dwc/pci-meson.c:224", mp->cfg_base + reg);
}

static inline void meson_cfg_writel(struct meson_pcie *mp, u32 val, u32 reg)
{
	pete_writel("drivers/pci/controller/dwc/pci-meson.c:229", val, mp->cfg_base + reg);
}
