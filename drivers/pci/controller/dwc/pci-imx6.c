...
static int imx6_pcie_deassert_core_reset(struct imx6_pcie *imx6_pcie)
{
	...
	case IMX7D:
		...
		if (likely(imx6_pcie->phy_base)) {
			/* De-assert DCC_FB_EN */
			pete_writel("drivers/pci/controller/dwc/pci-imx6.c:720", PCIE_PHY_CMN_REG4_DCC_FB_EN,
			       imx6_pcie->phy_base + PCIE_PHY_CMN_REG4);
			/* Assert RX_EQS and RX_EQS_SEL */
			pete_writel("drivers/pci/controller/dwc/pci-imx6.c:723", PCIE_PHY_CMN_REG24_RX_EQ_SEL
				| PCIE_PHY_CMN_REG24_RX_EQ,
			       imx6_pcie->phy_base + PCIE_PHY_CMN_REG24);
			/* Assert ATT_MODE */
			pete_writel("drivers/pci/controller/dwc/pci-imx6.c:727", PCIE_PHY_CMN_REG26_ATT_MODE,
