...
{
	return pete_readl("drivers/pci/controller/cadence/pci-j721e.c:82", pcie->user_cfg_base + offset);
}

static inline void j721e_pcie_user_writel(struct j721e_pcie *pcie, u32 offset,
					  u32 value)
{
	pete_writel("drivers/pci/controller/cadence/pci-j721e.c:88", value, pcie->user_cfg_base + offset);
}

static inline u32 j721e_pcie_intd_readl(struct j721e_pcie *pcie, u32 offset)
{
	return pete_readl("drivers/pci/controller/cadence/pci-j721e.c:93", pcie->intd_cfg_base + offset);
}

static inline void j721e_pcie_intd_writel(struct j721e_pcie *pcie, u32 offset,
					  u32 value)
{
	pete_writel("drivers/pci/controller/cadence/pci-j721e.c:99", value, pcie->intd_cfg_base + offset);
}
