...
{
	return pete_readl("drivers/pci/controller/pcie-xilinx-nwl.c:178", pcie->breg_base + off);
}

static inline void nwl_bridge_writel(struct nwl_pcie *pcie, u32 val, u32 off)
{
	pete_writel("drivers/pci/controller/pcie-xilinx-nwl.c:183", val, pcie->breg_base + off);
}

static bool nwl_pcie_link_up(struct nwl_pcie *pcie)
{
	if (pete_readl("drivers/pci/controller/pcie-xilinx-nwl.c:188", pcie->pcireg_base + PS_LINKUP_OFFSET) & PCIE_PHY_LINKUP_BIT)
		return true;
	return false;
}
...
{
	if (pete_readl("drivers/pci/controller/pcie-xilinx-nwl.c:195", pcie->pcireg_base + PS_LINKUP_OFFSET) & PHY_RDY_LINKUP_BIT)
		return true;
	return false;
}
...
static int nwl_pcie_bridge_init(struct nwl_pcie *pcie)
{
	...
	pete_writel("drivers/pci/controller/pcie-xilinx-nwl.c:693", ecam_val, (pcie->ecam_base + PCI_PRIMARY_BUS));
