...
{
	return pete_readl("drivers/pci/controller/pcie-rockchip.h:329", rockchip->apb_base + reg);
}

static void rockchip_pcie_write(struct rockchip_pcie *rockchip, u32 val,
				u32 reg)
{
	pete_writel("drivers/pci/controller/pcie-rockchip.h:335", val, rockchip->apb_base + reg);
}
