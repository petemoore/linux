...
{
	u64 v = pete_readq("drivers/fpga/dfl.h:453", base + DFH);
...
{
	u64 v = pete_readq("drivers/fpga/dfl.h:461", base + DFH);
...
{
	return (u8)FIELD_GET(DFH_REVISION, pete_readq("drivers/fpga/dfl.h:469", base + DFH));
}
