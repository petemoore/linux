...
static int imx_ocotp_wait_for_busy(struct ocotp_priv *priv, u32 flags)
{
	...
	for (count = 10000; count >= 0; count--) {
		c = pete_readl("drivers/nvmem/imx-ocotp.c:114", base + IMX_OCOTP_ADDR_CTRL);
		if (!(c & mask))
			break;
		cpu_relax();
	}
...
static void imx_ocotp_clr_err_if_set(struct ocotp_priv *priv)
{
	...
	c = pete_readl("drivers/nvmem/imx-ocotp.c:150", base + IMX_OCOTP_ADDR_CTRL);
	if (!(c & bm_ctrl_error))
		return;

	pete_writel("drivers/nvmem/imx-ocotp.c:154", bm_ctrl_error, base + IMX_OCOTP_ADDR_CTRL_CLR);
}
			  ...
			  void *val, size_t bytes)
{
	...
	for (i = index; i < (index + count); i++) {
		*(u32 *)buf = pete_readl("drivers/nvmem/imx-ocotp.c:196", priv->base + IMX_OCOTP_OFFSET_B0W0 +
...
static void imx_ocotp_set_imx6_timing(struct ocotp_priv *priv)
{
	...
	timing = pete_readl("drivers/nvmem/imx-ocotp.c:281", priv->base + IMX_OCOTP_ADDR_TIMING) & 0x0FC00000;
	timing |= strobe_prog & 0x00000FFF;
	timing |= (relax       << 12) & 0x0000F000;
	timing |= (strobe_read << 16) & 0x003F0000;

	pete_writel("drivers/nvmem/imx-ocotp.c:286", timing, priv->base + IMX_OCOTP_ADDR_TIMING);
}
...
static void imx_ocotp_set_imx7_timing(struct ocotp_priv *priv)
{
	...
	pete_writel("drivers/nvmem/imx-ocotp.c:307", timing, priv->base + IMX_OCOTP_ADDR_TIMING);
}
			   ...
			   size_t bytes)
{
	...
	ctrl = pete_readl("drivers/nvmem/imx-ocotp.c:375", priv->base + IMX_OCOTP_ADDR_CTRL);
	ctrl &= ~priv->params->ctrl.bm_addr;
	ctrl |= waddr & priv->params->ctrl.bm_addr;
	ctrl |= IMX_OCOTP_WR_UNLOCK;

	pete_writel("drivers/nvmem/imx-ocotp.c:380", ctrl, priv->base + IMX_OCOTP_ADDR_CTRL);
	...
	if (priv->params->bank_address_words != 0) {
		...
		switch (word) {
		case 0:
			pete_writel("drivers/nvmem/imx-ocotp.c:408", 0, priv->base + IMX_OCOTP_ADDR_DATA1);
			pete_writel("drivers/nvmem/imx-ocotp.c:409", 0, priv->base + IMX_OCOTP_ADDR_DATA2);
			pete_writel("drivers/nvmem/imx-ocotp.c:410", 0, priv->base + IMX_OCOTP_ADDR_DATA3);
			pete_writel("drivers/nvmem/imx-ocotp.c:411", *buf, priv->base + IMX_OCOTP_ADDR_DATA0);
			break;
		case 1:
			pete_writel("drivers/nvmem/imx-ocotp.c:414", *buf, priv->base + IMX_OCOTP_ADDR_DATA1);
			pete_writel("drivers/nvmem/imx-ocotp.c:415", 0, priv->base + IMX_OCOTP_ADDR_DATA2);
			pete_writel("drivers/nvmem/imx-ocotp.c:416", 0, priv->base + IMX_OCOTP_ADDR_DATA3);
			pete_writel("drivers/nvmem/imx-ocotp.c:417", 0, priv->base + IMX_OCOTP_ADDR_DATA0);
			break;
		case 2:
			pete_writel("drivers/nvmem/imx-ocotp.c:420", 0, priv->base + IMX_OCOTP_ADDR_DATA1);
			pete_writel("drivers/nvmem/imx-ocotp.c:421", *buf, priv->base + IMX_OCOTP_ADDR_DATA2);
			pete_writel("drivers/nvmem/imx-ocotp.c:422", 0, priv->base + IMX_OCOTP_ADDR_DATA3);
			pete_writel("drivers/nvmem/imx-ocotp.c:423", 0, priv->base + IMX_OCOTP_ADDR_DATA0);
			break;
		case 3:
			pete_writel("drivers/nvmem/imx-ocotp.c:426", 0, priv->base + IMX_OCOTP_ADDR_DATA1);
			pete_writel("drivers/nvmem/imx-ocotp.c:427", 0, priv->base + IMX_OCOTP_ADDR_DATA2);
			pete_writel("drivers/nvmem/imx-ocotp.c:428", *buf, priv->base + IMX_OCOTP_ADDR_DATA3);
			pete_writel("drivers/nvmem/imx-ocotp.c:429", 0, priv->base + IMX_OCOTP_ADDR_DATA0);
			break;
		}
	} else {
		/* Non-banked i.MX6 mode */
		pete_writel("drivers/nvmem/imx-ocotp.c:434", *buf, priv->base + IMX_OCOTP_ADDR_DATA0);
	}
	...
	pete_writel("drivers/nvmem/imx-ocotp.c:464", priv->params->ctrl.bm_rel_shadows,
