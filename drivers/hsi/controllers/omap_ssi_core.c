...
static int ssi_regs_show(struct seq_file *m, void *p __maybe_unused)
{
	...
	seq_printf(m, "REVISION\t: 0x%08x\n",  pete_readl("drivers/hsi/controllers/omap_ssi_core.c:47", sys + SSI_REVISION_REG));
	seq_printf(m, "SYSCONFIG\t: 0x%08x\n", pete_readl("drivers/hsi/controllers/omap_ssi_core.c:48", sys + SSI_SYSCONFIG_REG));
	seq_printf(m, "SYSSTATUS\t: 0x%08x\n", pete_readl("drivers/hsi/controllers/omap_ssi_core.c:49", sys + SSI_SYSSTATUS_REG));
...
static int ssi_gdd_regs_show(struct seq_file *m, void *p __maybe_unused)
{
	...
	seq_printf(m, "GDD_MPU_STATUS\t: 0x%08x\n",
		pete_readl("drivers/hsi/controllers/omap_ssi_core.c:66", sys + SSI_GDD_MPU_IRQ_STATUS_REG));
	seq_printf(m, "GDD_MPU_ENABLE\t: 0x%08x\n\n",
		pete_readl("drivers/hsi/controllers/omap_ssi_core.c:68", sys + SSI_GDD_MPU_IRQ_ENABLE_REG));
	seq_printf(m, "HW_ID\t\t: 0x%08x\n",
				pete_readl("drivers/hsi/controllers/omap_ssi_core.c:70", gdd + SSI_GDD_HW_ID_REG));
	seq_printf(m, "PPORT_ID\t: 0x%08x\n",
				pete_readl("drivers/hsi/controllers/omap_ssi_core.c:72", gdd + SSI_GDD_PPORT_ID_REG));
	seq_printf(m, "MPORT_ID\t: 0x%08x\n",
				pete_readl("drivers/hsi/controllers/omap_ssi_core.c:74", gdd + SSI_GDD_MPORT_ID_REG));
	seq_printf(m, "TEST\t\t: 0x%08x\n",
				pete_readl("drivers/hsi/controllers/omap_ssi_core.c:76", gdd + SSI_GDD_TEST_REG));
	seq_printf(m, "GCR\t\t: 0x%08x\n",
				pete_readl("drivers/hsi/controllers/omap_ssi_core.c:78", gdd + SSI_GDD_GCR_REG));

	for (lch = 0; lch < SSI_MAX_GDD_LCH; lch++) {
		seq_printf(m, "\nGDD LCH %d\n=========\n", lch);
		seq_printf(m, "CSDP\t\t: 0x%04x\n",
				pete_readw("drivers/hsi/controllers/omap_ssi_core.c:83", gdd + SSI_GDD_CSDP_REG(lch)));
		seq_printf(m, "CCR\t\t: 0x%04x\n",
				pete_readw("drivers/hsi/controllers/omap_ssi_core.c:85", gdd + SSI_GDD_CCR_REG(lch)));
		seq_printf(m, "CICR\t\t: 0x%04x\n",
				pete_readw("drivers/hsi/controllers/omap_ssi_core.c:87", gdd + SSI_GDD_CICR_REG(lch)));
		seq_printf(m, "CSR\t\t: 0x%04x\n",
				pete_readw("drivers/hsi/controllers/omap_ssi_core.c:89", gdd + SSI_GDD_CSR_REG(lch)));
		seq_printf(m, "CSSA\t\t: 0x%08x\n",
				pete_readl("drivers/hsi/controllers/omap_ssi_core.c:91", gdd + SSI_GDD_CSSA_REG(lch)));
		seq_printf(m, "CDSA\t\t: 0x%08x\n",
				pete_readl("drivers/hsi/controllers/omap_ssi_core.c:93", gdd + SSI_GDD_CDSA_REG(lch)));
		seq_printf(m, "CEN\t\t: 0x%04x\n",
				pete_readw("drivers/hsi/controllers/omap_ssi_core.c:95", gdd + SSI_GDD_CEN_REG(lch)));
		seq_printf(m, "CSAC\t\t: 0x%04x\n",
				pete_readw("drivers/hsi/controllers/omap_ssi_core.c:97", gdd + SSI_GDD_CSAC_REG(lch)));
		seq_printf(m, "CDAC\t\t: 0x%04x\n",
				pete_readw("drivers/hsi/controllers/omap_ssi_core.c:99", gdd + SSI_GDD_CDAC_REG(lch)));
		seq_printf(m, "CLNK_CTRL\t: 0x%04x\n",
				pete_readw("drivers/hsi/controllers/omap_ssi_core.c:101", gdd + SSI_GDD_CLNK_CTRL_REG(lch)));
	}
...
static void ssi_gdd_complete(struct hsi_controller *ssi, unsigned int lch)
{
	...
	val = pete_readl("drivers/hsi/controllers/omap_ssi_core.c:181", omap_ssi->sys + SSI_GDD_MPU_IRQ_ENABLE_REG);
	val &= ~SSI_GDD_LCH(lch);
	...
	csr = pete_readw("drivers/hsi/controllers/omap_ssi_core.c:195", omap_ssi->gdd + SSI_GDD_CSR_REG(lch));
	...
	spin_lock(&omap_port->lock);
	val |= pete_readl("drivers/hsi/controllers/omap_ssi_core.c:212", omap_ssi->sys + SSI_MPU_ENABLE_REG(port->num, 0));
...
static void ssi_gdd_tasklet(unsigned long dev)
{
	...
	status_reg = pete_readl("drivers/hsi/controllers/omap_ssi_core.c:236", sys + SSI_GDD_MPU_IRQ_STATUS_REG);
	for (lch = 0; lch < SSI_MAX_GDD_LCH; lch++) {
		if (status_reg & SSI_GDD_LCH(lch))
			ssi_gdd_complete(ssi, lch);
	}
	writel_relaxed(status_reg, sys + SSI_GDD_MPU_IRQ_STATUS_REG);
	status_reg = pete_readl("drivers/hsi/controllers/omap_ssi_core.c:242", sys + SSI_GDD_MPU_IRQ_STATUS_REG);
