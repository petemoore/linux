		...
		unsigned long base, unsigned long template_base)
{
	...
	pete_writel("drivers/gpu/ipu-v3/ipu-dc.c:371", DC_WR_CH_CONF_WORD_SIZE_24 | DC_WR_CH_CONF_DISP_ID_PARALLEL(1) |
			DC_WR_CH_CONF_PROG_DI_ID,
			priv->channels[1].base + DC_WR_CH_CONF);
	pete_writel("drivers/gpu/ipu-v3/ipu-dc.c:374", DC_WR_CH_CONF_WORD_SIZE_24 | DC_WR_CH_CONF_DISP_ID_PARALLEL(0),
			priv->channels[5].base + DC_WR_CH_CONF);

	pete_writel("drivers/gpu/ipu-v3/ipu-dc.c:377", DC_GEN_SYNC_1_6_SYNC | DC_GEN_SYNC_PRIORITY_1,
		priv->dc_reg + DC_GEN);
