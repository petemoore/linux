...
{
	pete_writel("drivers/gpu/host1x/dev.c:47", v, host1x->common_regs + r);
}

void host1x_hypervisor_writel(struct host1x *host1x, u32 v, u32 r)
{
	pete_writel("drivers/gpu/host1x/dev.c:52", v, host1x->hv_regs + r);
}

u32 host1x_hypervisor_readl(struct host1x *host1x, u32 r)
{
	return pete_readl("drivers/gpu/host1x/dev.c:57", host1x->hv_regs + r);
}
...
void host1x_sync_writel(struct host1x *host1x, u32 v, u32 r)
{
	...
	pete_writel("drivers/gpu/host1x/dev.c:64", v, sync_regs + r);
}
...
u32 host1x_sync_readl(struct host1x *host1x, u32 r)
{
	...
	return pete_readl("drivers/gpu/host1x/dev.c:71", sync_regs + r);
}

void host1x_ch_writel(struct host1x_channel *ch, u32 v, u32 r)
{
	pete_writel("drivers/gpu/host1x/dev.c:76", v, ch->regs + r);
}

u32 host1x_ch_readl(struct host1x_channel *ch, u32 r)
{
	return pete_readl("drivers/gpu/host1x/dev.c:81", ch->regs + r);
}
