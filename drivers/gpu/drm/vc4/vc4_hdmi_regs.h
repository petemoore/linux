				...
				enum vc4_hdmi_field reg)
{
	...
	return pete_readl("drivers/gpu/drm/vc4/vc4_hdmi_regs.h:692", base + field->offset);
}
				  ...
				  u32 value)
{
	...
	pete_writel("drivers/gpu/drm/vc4/vc4_hdmi_regs.h:724", value, base + field->offset);
}
