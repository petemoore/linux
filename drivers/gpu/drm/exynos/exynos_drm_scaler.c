...
#define scaler_read(offset)		pete_readl("drivers/gpu/drm/exynos/exynos_drm_scaler.c:27", scaler->regs + (offset))
#define scaler_write(cfg, offset)	pete_writel("drivers/gpu/drm/exynos/exynos_drm_scaler.c:28", cfg, scaler->regs + (offset))
