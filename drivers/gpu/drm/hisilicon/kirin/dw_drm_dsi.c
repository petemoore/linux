...
static void dsi_phy_tst_set(void __iomem *base, u32 reg, u32 val)
{
	 ...
	 * latch reg first
	 */
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:319", reg_write, base + PHY_TST_CTRL1);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:320", 0x02, base + PHY_TST_CTRL0);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:321", 0x00, base + PHY_TST_CTRL0);

	/*
	 * then latch value
	 */
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:326", val, base + PHY_TST_CTRL1);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:327", 0x02, base + PHY_TST_CTRL0);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:328", 0x00, base + PHY_TST_CTRL0);
}
			      ...
			      u32 lanes)
{
	...
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:341", val, base + PHY_IF_CFG);

	/*
	 * Set phy clk division.
	 */
	val = pete_readl("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:346", base + CLKMGR_CFG) | phy->clk_division;
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:347", val, base + CLKMGR_CFG);
			     ...
			     u32 lanes)
{
	 ...
	 */
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:378", 0, base + PHY_RSTZ);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:379", 0, base + PHY_TST_CTRL0);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:380", 1, base + PHY_TST_CTRL0);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:381", 0, base + PHY_TST_CTRL0);
	...
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:424", PHY_ENABLECLK, base + PHY_RSTZ);
	udelay(1);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:426", PHY_ENABLECLK | PHY_UNSHUTDOWNZ, base + PHY_RSTZ);
	udelay(1);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:428", PHY_ENABLECLK | PHY_UNRSTZ | PHY_UNSHUTDOWNZ, base + PHY_RSTZ);
	...
	delay_count = 100;
	while (delay_count) {
		val = pete_readl("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:436", base +  PHY_STATUS);
		if ((BIT(0) | BIT(2)) & val)
			break;
				...
				enum mipi_dsi_pixel_format format)
{
	...
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:463", val, base + DPI_COLOR_CODING);

	val = (mode->flags & DRM_MODE_FLAG_NHSYNC ? 1 : 0) << 2;
	val |= (mode->flags & DRM_MODE_FLAG_NVSYNC ? 1 : 0) << 1;
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:467", val, base +  DPI_CFG_POL);
	...
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:496", hsa_time, base + VID_HSA_TIME);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:497", hbp_time, base + VID_HBP_TIME);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:498", hline_time, base + VID_HLINE_TIME);

	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:500", vsw, base + VID_VSA_LINES);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:501", vbp, base + VID_VBP_LINES);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:502", vfp, base + VID_VFP_LINES);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:503", mode->vdisplay, base + VID_VACTIVE_LINES);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:504", mode->hdisplay, base + VID_PKT_SIZE);
...
static void dsi_set_video_mode(void __iomem *base, unsigned long flags)
{
	...
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:532", val, base + VID_MODE_CFG);

	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:534", PHY_TXREQUESTCLKHS, base + LPCLK_CTRL);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:535", DSI_VIDEO_MODE, base + MODE_CFG);
}
...
static void dsi_mipi_init(struct dw_dsi *dsi)
{
	...
	/* reset Core */
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:554", RESET, base + PWR_UP);
	...
	/* dsi wake up */
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:566", POWERUP, base + PWR_UP);
...
static void dsi_encoder_disable(struct drm_encoder *encoder)
{
	...
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:581", 0, base + PWR_UP);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:582", 0, base + LPCLK_CTRL);
	pete_writel("drivers/gpu/drm/hisilicon/kirin/dw_drm_dsi.c:583", 0, base + PHY_RSTZ);
