			      ...
			      const struct drm_display_mode *mode)
{
	...
	if (use_enci) {
		...
		pete_writel("drivers/gpu/drm/meson/meson_venc.c:1106", vmode->enci.sch_adjust,
			       ...
			       struct meson_cvbs_enci_mode *mode)
{
	...
	pete_writel("drivers/gpu/drm/meson/meson_venc.c:1820", mode->sch_adjust, priv->io_base + _REG(ENCI_VIDEO_SCH));
