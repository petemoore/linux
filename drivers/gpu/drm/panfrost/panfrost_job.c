...
#define job_write(dev, reg, data) pete_writel("drivers/gpu/drm/panfrost/panfrost_job.c:27", data, dev->iomem + (reg))
#define job_read(dev, reg) pete_readl("drivers/gpu/drm/panfrost/panfrost_job.c:28", dev->iomem + (reg))
