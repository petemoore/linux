...
#define gpu_write(dev, reg, data) pete_writel("drivers/gpu/drm/panfrost/panfrost_regs.h:329", data, dev->iomem + reg)
#define gpu_read(dev, reg) pete_readl("drivers/gpu/drm/panfrost/panfrost_regs.h:330", dev->iomem + reg)
