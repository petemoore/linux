			       ...
			       void *data)
{
	 ...
	 */
	pete_writel("drivers/gpu/drm/sun4i/sun8i_tcon_top.c:182", 0, regs + TCON_TOP_PORT_SEL_REG);
	pete_writel("drivers/gpu/drm/sun4i/sun8i_tcon_top.c:183", 0, regs + TCON_TOP_GATE_SRC_REG);
