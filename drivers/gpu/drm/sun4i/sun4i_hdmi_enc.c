					   ...
					   struct drm_display_mode *mode)
{
	...
	for (i = 0; i < sizeof(buffer); i++)
		pete_writeb("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:68", buffer[i], hdmi->base + SUN4I_HDMI_AVI_INFOFRAME_REG(i));
			       ...
			       struct drm_atomic_state *state)
{
	...
	val = pete_readl("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:93", hdmi->base + SUN4I_HDMI_VID_CTRL_REG);
	val &= ~SUN4I_HDMI_VID_CTRL_ENABLE;
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:95", val, hdmi->base + SUN4I_HDMI_VID_CTRL_REG);
			      ...
			      struct drm_atomic_state *state)
{
	...
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:115", SUN4I_HDMI_UNKNOWN_INPUT_SYNC,
	 ...
	 */
	val = pete_readl("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:128", hdmi->base + SUN4I_HDMI_PAD_CTRL1_REG);
	val &= SUN4I_HDMI_PAD_CTRL1_HALVE_CLK;
	val |= hdmi->variant->pad_ctrl1_init_val;
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:131", val, hdmi->base + SUN4I_HDMI_PAD_CTRL1_REG);
	val = pete_readl("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:132", hdmi->base + SUN4I_HDMI_PAD_CTRL1_REG);

	/* Setup timing registers */
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:135", SUN4I_HDMI_VID_TIMING_X(mode->hdisplay) |
	       SUN4I_HDMI_VID_TIMING_Y(mode->vdisplay),
	       hdmi->base + SUN4I_HDMI_VID_TIMING_ACT_REG);

	x = mode->htotal - mode->hsync_start;
	y = mode->vtotal - mode->vsync_start;
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:141", SUN4I_HDMI_VID_TIMING_X(x) | SUN4I_HDMI_VID_TIMING_Y(y),
	       hdmi->base + SUN4I_HDMI_VID_TIMING_BP_REG);

	x = mode->hsync_start - mode->hdisplay;
	y = mode->vsync_start - mode->vdisplay;
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:146", SUN4I_HDMI_VID_TIMING_X(x) | SUN4I_HDMI_VID_TIMING_Y(y),
	       hdmi->base + SUN4I_HDMI_VID_TIMING_FP_REG);

	x = mode->hsync_end - mode->hsync_start;
	y = mode->vsync_end - mode->vsync_start;
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:151", SUN4I_HDMI_VID_TIMING_X(x) | SUN4I_HDMI_VID_TIMING_Y(y),
	...
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:161", val, hdmi->base + SUN4I_HDMI_VID_TIMING_POL_REG);
	...
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:168", val, hdmi->base + SUN4I_HDMI_PKT_CTRL_REG(0));

	val = SUN4I_HDMI_VID_CTRL_ENABLE;
	if (display->is_hdmi)
		val |= SUN4I_HDMI_VID_CTRL_HDMI_MODE;

	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:174", val, hdmi->base + SUN4I_HDMI_VID_CTRL_REG);
}
...
sun4i_hdmi_connector_detect(struct drm_connector *connector, bool force)
{
	...
	reg = pete_readl("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:256", hdmi->base + SUN4I_HDMI_HPD_REG);
...
static int sun4i_hdmi_cec_pin_read(struct cec_adapter *adap)
{
	...
	return pete_readl("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:279", hdmi->base + SUN4I_HDMI_CEC) & SUN4I_HDMI_CEC_RX;
}
...
static void sun4i_hdmi_cec_pin_low(struct cec_adapter *adap)
{
	...
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:287", SUN4I_HDMI_CEC_ENABLE, hdmi->base + SUN4I_HDMI_CEC);
}
...
static void sun4i_hdmi_cec_pin_high(struct cec_adapter *adap)
{
	 ...
	 */
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:298", 0, hdmi->base + SUN4I_HDMI_CEC);
}
			   ...
			   void *data)
{
	...
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:575", SUN4I_HDMI_CTRL_ENABLE, hdmi->base + SUN4I_HDMI_CTRL_REG);

	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:577", hdmi->variant->pad_ctrl0_init_val,
	       hdmi->base + SUN4I_HDMI_PAD_CTRL0_REG);

	reg = pete_readl("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:580", hdmi->base + SUN4I_HDMI_PLL_CTRL_REG);
	reg &= SUN4I_HDMI_PLL_CTRL_DIV_MASK;
	reg |= hdmi->variant->pll_ctrl_init_val;
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:583", reg, hdmi->base + SUN4I_HDMI_PLL_CTRL_REG);
	...
	pete_writel("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:622", pete_readl("drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c:622", hdmi->base + SUN4I_HDMI_CEC) & ~SUN4I_HDMI_CEC_TX,
