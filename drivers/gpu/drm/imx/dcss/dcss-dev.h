...
#define dcss_writel(v, c)	pete_writel("drivers/gpu/drm/imx/dcss/dcss-dev.h:19", (v), (c))
#define dcss_readl(c)		pete_readl("drivers/gpu/drm/imx/dcss/dcss-dev.h:20", c)
#define dcss_set(v, c)		pete_writel("drivers/gpu/drm/imx/dcss/dcss-dev.h:21", (v), (c) + SET)
#define dcss_clr(v, c)		pete_writel("drivers/gpu/drm/imx/dcss/dcss-dev.h:22", (v), (c) + CLR)
#define dcss_toggle(v, c)	pete_writel("drivers/gpu/drm/imx/dcss/dcss-dev.h:23", (v), (c) + TGL)

static inline void dcss_update(u32 v, u32 m, void __iomem *c)
{
	pete_writel("drivers/gpu/drm/imx/dcss/dcss-dev.h:27", (pete_readl("drivers/gpu/drm/imx/dcss/dcss-dev.h:27", c) & ~(m)) | (v), (c));
}
