...
static int queue_sync_prod_in(struct arm_smmu_queue *q)
{
	 ...
	 */
	prod = pete_readl("drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3.c:177", q->prod_reg);
					       ...
					       struct arm_smmu_ll_queue *llq)
{
	...
	do {
		...
		/*
		 * This needs to be a pete_readl("drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3.c:669", ) so that our subsequent call
		 ...
		 *				poll_valid_map();
		 *				<control dependency>
		 *				pete_writel("drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3.c:689", prod_reg);
		 *
		 *						pete_readl("drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3.c:691", cons_reg);
		 *						tryunlock();
		 *
		 * Requires us to see CPU 0's shared_lock() acquisition.
		 */
		llq->cons = pete_readl("drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3.c:696", cmdq->q.cons_reg);
	} while (!ret);
...
static irqreturn_t arm_smmu_gerror_handler(int irq, void *dev)
{
	...
	pete_writel("drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3.c:1704", gerror, smmu->base + ARM_SMMU_GERRORN);
	return IRQ_HANDLED;
}
			    ...
			    unsigned long iova, size_t size)
{
	 ...
	 *	smp_mb();			[...]
	 *	atomic_read(&nr_ats_masters);	pci_enable_ats() // pete_writel("drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3.c:1829", )
	 *
