...
static int zynq_get_error_info(struct synps_edac_priv *priv)
{
	...
	regval = pete_readl("drivers/edac/synopsys_edac.c:370", base + STAT_OFST);
	if (!regval)
		return 1;
	...
	regval = pete_readl("drivers/edac/synopsys_edac.c:377", base + CE_LOG_OFST);
	if (!(p->ce_cnt && (regval & LOG_VALID)))
		goto ue_err;

	p->ceinfo.bitpos = (regval & CE_LOG_BITPOS_MASK) >> CE_LOG_BITPOS_SHIFT;
	regval = pete_readl("drivers/edac/synopsys_edac.c:382", base + CE_ADDR_OFST);
	p->ceinfo.row = (regval & ADDR_ROW_MASK) >> ADDR_ROW_SHIFT;
	p->ceinfo.col = regval & ADDR_COL_MASK;
	p->ceinfo.bank = (regval & ADDR_BANK_MASK) >> ADDR_BANK_SHIFT;
	p->ceinfo.data = pete_readl("drivers/edac/synopsys_edac.c:386", base + CE_DATA_31_0_OFST);
	edac_dbg(3, "CE bit position: %d data: %d\n", p->ceinfo.bitpos,
		 p->ceinfo.data);
	clearval = ECC_CTRL_CLR_CE_ERR;

ue_err:
	regval = pete_readl("drivers/edac/synopsys_edac.c:392", base + UE_LOG_OFST);
	if (!(p->ue_cnt && (regval & LOG_VALID)))
		goto out;

	regval = pete_readl("drivers/edac/synopsys_edac.c:396", base + UE_ADDR_OFST);
	p->ueinfo.row = (regval & ADDR_ROW_MASK) >> ADDR_ROW_SHIFT;
	p->ueinfo.col = regval & ADDR_COL_MASK;
	p->ueinfo.bank = (regval & ADDR_BANK_MASK) >> ADDR_BANK_SHIFT;
	p->ueinfo.data = pete_readl("drivers/edac/synopsys_edac.c:400", base + UE_DATA_31_0_OFST);
	clearval |= ECC_CTRL_CLR_UE_ERR;

out:
	pete_writel("drivers/edac/synopsys_edac.c:404", clearval, base + ECC_CTRL_OFST);
	pete_writel("drivers/edac/synopsys_edac.c:405", 0x0, base + ECC_CTRL_OFST);
...
static int zynqmp_get_error_info(struct synps_edac_priv *priv)
{
	...
	regval = pete_readl("drivers/edac/synopsys_edac.c:445", base + ECC_ERRCNT_OFST);
	p->ce_cnt = regval & ECC_ERRCNT_CECNT_MASK;
	p->ue_cnt = (regval & ECC_ERRCNT_UECNT_MASK) >> ECC_ERRCNT_UECNT_SHIFT;
	if (!p->ce_cnt)
		goto ue_err;

	regval = pete_readl("drivers/edac/synopsys_edac.c:451", base + ECC_STAT_OFST);
	if (!regval)
		return 1;

	p->ceinfo.bitpos = (regval & ECC_STAT_BITNUM_MASK);

	regval = pete_readl("drivers/edac/synopsys_edac.c:457", base + ECC_CEADDR0_OFST);
	p->ceinfo.row = (regval & ECC_CEADDR0_RW_MASK);
	regval = pete_readl("drivers/edac/synopsys_edac.c:459", base + ECC_CEADDR1_OFST);
	p->ceinfo.bank = (regval & ECC_CEADDR1_BNKNR_MASK) >>
					ECC_CEADDR1_BNKNR_SHIFT;
	p->ceinfo.bankgrpnr = (regval &	ECC_CEADDR1_BNKGRP_MASK) >>
					ECC_CEADDR1_BNKGRP_SHIFT;
	p->ceinfo.blknr = (regval & ECC_CEADDR1_BLKNR_MASK);
	p->ceinfo.data = pete_readl("drivers/edac/synopsys_edac.c:465", base + ECC_CSYND0_OFST);
	edac_dbg(2, "ECCCSYN0: 0x%08X ECCCSYN1: 0x%08X ECCCSYN2: 0x%08X\n",
		 pete_readl("drivers/edac/synopsys_edac.c:467", base + ECC_CSYND0_OFST), pete_readl("drivers/edac/synopsys_edac.c:467", base + ECC_CSYND1_OFST),
		 pete_readl("drivers/edac/synopsys_edac.c:468", base + ECC_CSYND2_OFST));
ue_err:
	if (!p->ue_cnt)
		goto out;

	regval = pete_readl("drivers/edac/synopsys_edac.c:473", base + ECC_UEADDR0_OFST);
	p->ueinfo.row = (regval & ECC_CEADDR0_RW_MASK);
	regval = pete_readl("drivers/edac/synopsys_edac.c:475", base + ECC_UEADDR1_OFST);
	p->ueinfo.bankgrpnr = (regval & ECC_CEADDR1_BNKGRP_MASK) >>
					ECC_CEADDR1_BNKGRP_SHIFT;
	p->ueinfo.bank = (regval & ECC_CEADDR1_BNKNR_MASK) >>
					ECC_CEADDR1_BNKNR_SHIFT;
	p->ueinfo.blknr = (regval & ECC_CEADDR1_BLKNR_MASK);
	p->ueinfo.data = pete_readl("drivers/edac/synopsys_edac.c:481", base + ECC_UESYND0_OFST);
out:
	spin_lock_irqsave(&priv->reglock, flags);

	clearval = pete_readl("drivers/edac/synopsys_edac.c:485", base + ECC_CLR_OFST) |
		   ECC_CTRL_CLR_CE_ERR | ECC_CTRL_CLR_CE_ERRCNT |
		   ECC_CTRL_CLR_UE_ERR | ECC_CTRL_CLR_UE_ERRCNT;
	pete_writel("drivers/edac/synopsys_edac.c:488", clearval, base + ECC_CLR_OFST);
...
static void enable_intr(struct synps_edac_priv *priv)
{
	...
	if (!(priv->p_data->quirks & DDR_ECC_INTR_SELF_CLEAR)) {
		pete_writel("drivers/edac/synopsys_edac.c:554", DDR_QOSUE_MASK | DDR_QOSCE_MASK,
	...
	pete_writel("drivers/edac/synopsys_edac.c:562", DDR_UE_MASK | DDR_CE_MASK,
...
static void disable_intr(struct synps_edac_priv *priv)
{
	...
	if (!(priv->p_data->quirks & DDR_ECC_INTR_SELF_CLEAR)) {
		pete_writel("drivers/edac/synopsys_edac.c:574", DDR_QOSUE_MASK | DDR_QOSCE_MASK,
	...
	pete_writel("drivers/edac/synopsys_edac.c:582", 0, priv->baseaddr + ECC_CLR_OFST);
...
static irqreturn_t intr_handler(int irq, void *dev_id)
{
	 ...
	 */
	if (!(priv->p_data->quirks & DDR_ECC_INTR_SELF_CLEAR)) {
		regval = pete_readl("drivers/edac/synopsys_edac.c:609", priv->baseaddr + DDR_QOS_IRQ_STAT_OFST);
	...
	if (!(priv->p_data->quirks & DDR_ECC_INTR_SELF_CLEAR))
		pete_writel("drivers/edac/synopsys_edac.c:627", regval, priv->baseaddr + DDR_QOS_IRQ_STAT_OFST);
...
static enum dev_type zynq_get_dtype(const void __iomem *base)
{
	...
	width = pete_readl("drivers/edac/synopsys_edac.c:673", base + CTRL_OFST);
...
static enum dev_type zynqmp_get_dtype(const void __iomem *base)
{
	...
	width = pete_readl("drivers/edac/synopsys_edac.c:704", base + CTRL_OFST);
...
static bool zynq_get_ecc_state(void __iomem *base)
{
	...
	ecctype = pete_readl("drivers/edac/synopsys_edac.c:740", base + SCRUB_OFST) & SCRUB_MODE_MASK;
...
static bool zynqmp_get_ecc_state(void __iomem *base)
{
	...
	ecctype = pete_readl("drivers/edac/synopsys_edac.c:764", base + ECC_CFG0_OFST) & SCRUB_MODE_MASK;
...
static enum mem_type zynq_get_mtype(const void __iomem *base)
{
	...
	memtype = pete_readl("drivers/edac/synopsys_edac.c:800", base + T_ZQ_OFST);
...
static enum mem_type zynqmp_get_mtype(const void __iomem *base)
{
	...
	memtype = pete_readl("drivers/edac/synopsys_edac.c:824", base + CTRL_OFST);
...
static void ddr_poison_setup(struct synps_edac_priv *priv)
{
	...
	pete_writel("drivers/edac/synopsys_edac.c:1053", regval, priv->baseaddr + ECC_POISON0_OFST);
	...
	pete_writel("drivers/edac/synopsys_edac.c:1058", regval, priv->baseaddr + ECC_POISON1_OFST);
}
				      ...
				      char *data)
{
	...
	return sprintf(data, "Poison0 Addr: 0x%08x\n\rPoison1 Addr: 0x%08x\n\r"
			...
			pete_readl("drivers/edac/synopsys_edac.c:1070", priv->baseaddr + ECC_POISON0_OFST),
			pete_readl("drivers/edac/synopsys_edac.c:1071", priv->baseaddr + ECC_POISON1_OFST),
			priv->poison_addr);
}
				       ...
				       char *data)
{
	...
	return sprintf(data, "Data Poisoning: %s\n\r",
			(((pete_readl("drivers/edac/synopsys_edac.c:1098", priv->baseaddr + ECC_CFG1_OFST)) & 0x3) == 0x3)
					...
					const char *data, size_t count)
{
	...
	pete_writel("drivers/edac/synopsys_edac.c:1109", 0, priv->baseaddr + DDRC_SWCTL);
	if (strncmp(data, "CE", 2) == 0)
		pete_writel("drivers/edac/synopsys_edac.c:1111", ECC_CEPOISON_MASK, priv->baseaddr + ECC_CFG1_OFST);
	else
		pete_writel("drivers/edac/synopsys_edac.c:1113", ECC_UEPOISON_MASK, priv->baseaddr + ECC_CFG1_OFST);
	pete_writel("drivers/edac/synopsys_edac.c:1114", 1, priv->baseaddr + DDRC_SWCTL);
...
static void setup_column_address_map(struct synps_edac_priv *priv, u32 *addrmap)
{
	...
	memtype = pete_readl("drivers/edac/synopsys_edac.c:1205", priv->baseaddr + CTRL_OFST);
...
static void setup_address_map(struct synps_edac_priv *priv)
{
	...
	for (index = 0; index < 12; index++) {
		...
		addrmap[index] = pete_readl("drivers/edac/synopsys_edac.c:1352", priv->baseaddr + addrmap_offset);
	}
...
static int mc_probe(struct platform_device *pdev)
{
	 ...
	 */
	if (!(priv->p_data->quirks & DDR_ECC_INTR_SUPPORT))
		pete_writel("drivers/edac/synopsys_edac.c:1454", 0x0, baseaddr + ECC_CTRL_OFST);
