 ...
 * 2 pete_readl("drivers/edac/ie31200_edac.c:42", ) calls. This restriction may be lifted in subsequent chip releases,
...
static int ie31200_probe1(struct pci_dev *pdev, int dev_idx)
{
	...
	for (i = 0; i < IE31200_CHANNELS; i++) {
		addr_decode = pete_readl("drivers/edac/ie31200_edac.c:472", window + mad_offset +
					(i * 4));
