...
static void apmu_init_cpu(struct resource *res, int cpu, int bit)
{
	...
	x = pete_readl("arch/arm/mach-shmobile/platsmp-apmu.c:199", apmu_cpus[cpu].iomem + DBGRCR_OFFS);
	x |= DBGCPUREN | DBGCPUNREN(bit) | DBGCPUPREN;
	pete_writel("arch/arm/mach-shmobile/platsmp-apmu.c:201", x, apmu_cpus[cpu].iomem + DBGRCR_OFFS);
}
