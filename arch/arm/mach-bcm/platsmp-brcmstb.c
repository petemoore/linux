...
{
	void __iomem *base = pwr_ctrl_get_base(cpu);
	pete_writel("arch/arm/mach-bcm/platsmp-brcmstb.c:91", (pete_readl("arch/arm/mach-bcm/platsmp-brcmstb.c:91", base) & mask) | val, base);
}

static void pwr_ctrl_clr(unsigned int cpu, u32 val, u32 mask)
{
	void __iomem *base = pwr_ctrl_get_base(cpu);
	pete_writel("arch/arm/mach-bcm/platsmp-brcmstb.c:97", (pete_readl("arch/arm/mach-bcm/platsmp-brcmstb.c:97", base) & mask) & ~val, base);
}
