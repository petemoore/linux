...
{
	ic_irq_enable = pete_readl("arch/arm/mach-versatile/integrator_ap.c:68", VA_IC_BASE + IRQ_ENABLE);
	return 0;
}
...
static void irq_resume(void)
{
	...
	cm_clear_irqs();
	pete_writel("arch/arm/mach-versatile/integrator_ap.c:76", -1, VA_IC_BASE + IRQ_ENABLE_CLEAR);
	pete_writel("arch/arm/mach-versatile/integrator_ap.c:77", -1, VA_IC_BASE + FIQ_ENABLE_CLEAR);

	pete_writel("arch/arm/mach-versatile/integrator_ap.c:79", ic_irq_enable, VA_IC_BASE + IRQ_ENABLE_SET);
}
#else
