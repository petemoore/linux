...
static unsigned int mmc_status(struct device *dev)
{
	...
	return pete_readl("arch/arm/mach-versatile/versatile.c:66", versatile_sys_base + VERSATILE_SYS_MCI_OFFSET) & mask;
}
...
static void __init versatile_init_early(void)
{
	 ...
	 */
	val = pete_readl("arch/arm/mach-versatile/versatile.c:115", __io_address(VERSATILE_SCTL_BASE));
	pete_writel("arch/arm/mach-versatile/versatile.c:116", (VERSATILE_TIMCLK << VERSATILE_TIMER1_EnSel) |
...
static void __init versatile_dt_pci_init(void)
{
	...
	val = pete_readl("arch/arm/mach-versatile/versatile.c:134", versatile_sys_base + VERSATILE_SYS_PCICTL_OFFSET);
	if (val & 1) {
		/*
		 ...
		 */
		pete_writel("arch/arm/mach-versatile/versatile.c:141", 1, versatile_sys_base + VERSATILE_SYS_PCICTL_OFFSET);
		goto out_put_node;
	}
