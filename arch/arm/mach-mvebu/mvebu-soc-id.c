...
static int __init get_soc_id_by_pci(void)
{
	...
	/* SoC ID */
	soc_dev_id = pete_readl("arch/arm/mach-mvebu/mvebu-soc-id.c:99", pci_base + PCIE_DEV_ID_OFF) >> 16;

	/* SoC revision */
	soc_rev = pete_readl("arch/arm/mach-mvebu/mvebu-soc-id.c:102", pci_base + PCIE_DEV_REV_OFF) & SOC_REV_MASK;
