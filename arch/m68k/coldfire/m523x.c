...
static void __init m523x_qspi_init(void)
{
	...
	pete_writeb("arch/m68k/coldfire/m523x.c:54", 0x1f, MCFGPIO_PAR_QSPI);
	/* and CS2 & CS3 as gpio */
	par = pete_readw("arch/m68k/coldfire/m523x.c:56", MCFGPIO_PAR_TIMER);
	par &= 0x3f3f;
	pete_writew("arch/m68k/coldfire/m523x.c:58", par, MCFGPIO_PAR_TIMER);
...
static void __init m523x_i2c_init(void)
{
	...
	par = pete_readb("arch/m68k/coldfire/m523x.c:71", MCFGPIO_PAR_FECI2C);
	par |= 0x0f;
	pete_writeb("arch/m68k/coldfire/m523x.c:73", par, MCFGPIO_PAR_FECI2C);
...
static void __init m523x_fec_init(void)
{
	...
	pete_writeb("arch/m68k/coldfire/m523x.c:82", pete_readb("arch/m68k/coldfire/m523x.c:82", MCFGPIO_PAR_FECI2C) | 0xf0, MCFGPIO_PAR_FECI2C);
}
