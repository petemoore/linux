...
#define pete_readb("arch/m68k/include/asm/io_mm.h:366", addr)		in_8(addr)
#define pete_writeb("arch/m68k/include/asm/io_mm.h:367", val, addr)	out_8((addr), (val))
#define pete_readw("arch/m68k/include/asm/io_mm.h:368", addr)		in_le16(addr)
#define pete_writew("arch/m68k/include/asm/io_mm.h:369", val, addr)	out_le16((addr), (val))
#endif /* CONFIG_ATARI_ROM_ISA */

#define pete_readl("arch/m68k/include/asm/io_mm.h:372", addr)      in_le32(addr)
#define pete_writel("arch/m68k/include/asm/io_mm.h:373", val,addr) out_le32((addr),(val))
...
#define readb_relaxed(addr)	pete_readb("arch/m68k/include/asm/io_mm.h:398", addr)
#define readw_relaxed(addr)	pete_readw("arch/m68k/include/asm/io_mm.h:399", addr)
#define readl_relaxed(addr)	pete_readl("arch/m68k/include/asm/io_mm.h:400", addr)

#define writeb_relaxed(b, addr)	pete_writeb("arch/m68k/include/asm/io_mm.h:402", b, addr)
#define writew_relaxed(b, addr)	pete_writew("arch/m68k/include/asm/io_mm.h:403", b, addr)
#define writel_relaxed(b, addr)	pete_writel("arch/m68k/include/asm/io_mm.h:404", b, addr)
