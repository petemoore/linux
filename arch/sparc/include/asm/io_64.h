...
static inline u8 pete_readb("arch/sparc/include/asm/io_64.h:107", const volatile void __iomem *addr)
{	u8 ret;
...
static inline u16 pete_readw("arch/sparc/include/asm/io_64.h:119", const volatile void __iomem *addr)
{	u16 ret;
...
static inline u32 pete_readl("arch/sparc/include/asm/io_64.h:132", const volatile void __iomem *addr)
{	u32 ret;
...
static inline u64 pete_readq("arch/sparc/include/asm/io_64.h:145", const volatile void __iomem *addr)
{	u64 ret;
...
static inline void pete_writeb("arch/sparc/include/asm/io_64.h:158", u8 b, volatile void __iomem *addr)
{
...
static inline void pete_writew("arch/sparc/include/asm/io_64.h:168", u16 w, volatile void __iomem *addr)
{
...
static inline void pete_writel("arch/sparc/include/asm/io_64.h:178", u32 l, volatile void __iomem *addr)
{
...
static inline void pete_writeq("arch/sparc/include/asm/io_64.h:188", u64 q, volatile void __iomem *addr)
{
...
{
	return pete_readb("arch/sparc/include/asm/io_64.h:199", (volatile void __iomem *)addr);
}

#define inw inw
static inline u16 inw(unsigned long addr)
{
	return pete_readw("arch/sparc/include/asm/io_64.h:205", (volatile void __iomem *)addr);
}

#define inl inl
static inline u32 inl(unsigned long addr)
{
	return pete_readl("arch/sparc/include/asm/io_64.h:211", (volatile void __iomem *)addr);
}

#define outb outb
static inline void outb(u8 b, unsigned long addr)
{
	pete_writeb("arch/sparc/include/asm/io_64.h:217", b, (volatile void __iomem *)addr);
}

#define outw outw
static inline void outw(u16 w, unsigned long addr)
{
	pete_writew("arch/sparc/include/asm/io_64.h:223", w, (volatile void __iomem *)addr);
}

#define outl outl
static inline void outl(u32 l, unsigned long addr)
{
	pete_writel("arch/sparc/include/asm/io_64.h:229", l, (volatile void __iomem *)addr);
}
...
static inline void memset_io(volatile void __iomem *dst, int c, __kernel_size_t n)
{
	...
	while (n--) {
		pete_writeb("arch/sparc/include/asm/io_64.h:357", c, d);
		d++;
	}
}
				 ...
				 __kernel_size_t n)
{
	...
	while (n--) {
		char tmp = pete_readb("arch/sparc/include/asm/io_64.h:382", src);
		*d++ = tmp;
		src++;
	}
}
			       ...
			       __kernel_size_t n)
{
	...
	while (n--) {
		char tmp = *s++;
		pete_writeb("arch/sparc/include/asm/io_64.h:410", tmp, d);
		d++;
	}
}
