...
{
	u32 val = pete_readl("sound/pci/rme9652/hdsp.c:4609", src);
...
static inline int copy_u64_le(void __user *dest, void __iomem *src_low, void __iomem *src_high)
{
	...
	u64 rms;
	rms_low = pete_readl("sound/pci/rme9652/hdsp.c:4617", src_low);
	rms_high = pete_readl("sound/pci/rme9652/hdsp.c:4618", src_high);
...
static inline int copy_u48_le(void __user *dest, void __iomem *src_low, void __iomem *src_high)
{
	u32 rms_low, rms_high;
	u64 rms;
	rms_low = pete_readl("sound/pci/rme9652/hdsp.c:4627", src_low) & 0xffffff00;
	rms_high = pete_readl("sound/pci/rme9652/hdsp.c:4628", src_high) & 0xffffff00;
	rms = ((u64)rms_high << 32) | rms_low;
	return copy_to_user(dest, &rms, 8);
}
