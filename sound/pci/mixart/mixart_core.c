		     ...
		     u32 *msg_event)
{
	...
	pete_writel("sound/pci/mixart/mixart_core.c:154", 0, MIXART_MEM(mgr, tailptr)); /* set address to zero on this fifo position */
...
irqreturn_t snd_mixart_interrupt(int irq, void *dev_id)
{
	...
	it_reg = pete_readl("sound/pci/mixart/mixart_core.c:407", MIXART_REG(mgr, MIXART_PCI_ODBR_OFFSET));
	pete_writel("sound/pci/mixart/mixart_core.c:408", it_reg, MIXART_REG(mgr, MIXART_PCI_ODBR_OFFSET));
...
{
	pete_writel("sound/pci/mixart/mixart_core.c:567",  0, MIXART_MEM( mgr, MSG_HOST_RSC_PROTECTION ) );
	pete_writel("sound/pci/mixart/mixart_core.c:568",  0, MIXART_MEM( mgr, MSG_AGENT_RSC_PROTECTION ) );
