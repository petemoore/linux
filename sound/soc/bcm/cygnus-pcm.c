		...
		u32 bufsize)
{
	...
	pete_writel("sound/soc/bcm/cygnus-pcm.c:239", start, audio_io + p_rbuf->baseaddr);
	pete_writel("sound/soc/bcm/cygnus-pcm.c:240", end, audio_io + p_rbuf->endaddr);
	pete_writel("sound/soc/bcm/cygnus-pcm.c:241", fmark_val, audio_io + p_rbuf->fmark);
	pete_writel("sound/soc/bcm/cygnus-pcm.c:242", initial_rd, audio_io + p_rbuf->rdaddr);
	pete_writel("sound/soc/bcm/cygnus-pcm.c:243", initial_wr, audio_io + p_rbuf->wraddr);
}
...
static void enable_intr(struct snd_pcm_substream *substream)
{
	...
	if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK) {
		...
		pete_writel("sound/soc/bcm/cygnus-pcm.c:322", clear_mask, aio->cygaud->audio + ESR0_STATUS_CLR_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:323", clear_mask, aio->cygaud->audio + ESR1_STATUS_CLR_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:324", clear_mask, aio->cygaud->audio + ESR3_STATUS_CLR_OFFSET);
		/* Unmask the interrupts of the given port*/
		pete_writel("sound/soc/bcm/cygnus-pcm.c:326", clear_mask, aio->cygaud->audio + ESR0_MASK_CLR_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:327", clear_mask, aio->cygaud->audio + ESR1_MASK_CLR_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:328", clear_mask, aio->cygaud->audio + ESR3_MASK_CLR_OFFSET);

		pete_writel("sound/soc/bcm/cygnus-pcm.c:330", ANY_PLAYBACK_IRQ,
			aio->cygaud->audio + INTH_R5F_MASK_CLEAR_OFFSET);
	} else {
		pete_writel("sound/soc/bcm/cygnus-pcm.c:333", clear_mask, aio->cygaud->audio + ESR2_STATUS_CLR_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:334", clear_mask, aio->cygaud->audio + ESR4_STATUS_CLR_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:335", clear_mask, aio->cygaud->audio + ESR2_MASK_CLR_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:336", clear_mask, aio->cygaud->audio + ESR4_MASK_CLR_OFFSET);

		pete_writel("sound/soc/bcm/cygnus-pcm.c:338", ANY_CAPTURE_IRQ,
			aio->cygaud->audio + INTH_R5F_MASK_CLEAR_OFFSET);
	}
...
static void disable_intr(struct snd_pcm_substream *substream)
{
	...
	if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK) {
		...
		pete_writel("sound/soc/bcm/cygnus-pcm.c:359", set_mask, aio->cygaud->audio + ESR0_MASK_SET_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:360", set_mask, aio->cygaud->audio + ESR1_MASK_SET_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:361", set_mask, aio->cygaud->audio + ESR3_MASK_SET_OFFSET);
	} else {
		pete_writel("sound/soc/bcm/cygnus-pcm.c:363", set_mask, aio->cygaud->audio + ESR2_MASK_SET_OFFSET);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:364", set_mask, aio->cygaud->audio + ESR4_MASK_SET_OFFSET);
	}
...
static void cygnus_pcm_period_elapsed(struct snd_pcm_substream *substream)
{
	...
	if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK) {
		...
		regval = pete_readl("sound/soc/bcm/cygnus-pcm.c:409", aio->cygaud->audio + p_rbuf->rdaddr);
		regval = regval ^ BIT(31);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:411", regval, aio->cygaud->audio + p_rbuf->wraddr);
	} else {
		/* Set the ring buffer to empty */
		regval = pete_readl("sound/soc/bcm/cygnus-pcm.c:414", aio->cygaud->audio + p_rbuf->wraddr);
		pete_writel("sound/soc/bcm/cygnus-pcm.c:415", regval, aio->cygaud->audio + p_rbuf->rdaddr);
	}
}
...
static void handle_playback_irq(struct cygnus_audio *cygaud)
{
	 ...
	 * should be serviced.
	 */
	esr_status0 = pete_readl("sound/soc/bcm/cygnus-pcm.c:440", audio_io + ESR0_STATUS_OFFSET);
	esr_status0 &= ~pete_readl("sound/soc/bcm/cygnus-pcm.c:441", audio_io + ESR0_MASK_STATUS_OFFSET);
	esr_status1 = pete_readl("sound/soc/bcm/cygnus-pcm.c:442", audio_io + ESR1_STATUS_OFFSET);
	esr_status1 &= ~pete_readl("sound/soc/bcm/cygnus-pcm.c:443", audio_io + ESR1_MASK_STATUS_OFFSET);
	esr_status3 = pete_readl("sound/soc/bcm/cygnus-pcm.c:444", audio_io + ESR3_STATUS_OFFSET);
	esr_status3 &= ~pete_readl("sound/soc/bcm/cygnus-pcm.c:445", audio_io + ESR3_MASK_STATUS_OFFSET);
	...
	/* Clear ESR interrupt */
	pete_writel("sound/soc/bcm/cygnus-pcm.c:476", esr_status0, audio_io + ESR0_STATUS_CLR_OFFSET);
	pete_writel("sound/soc/bcm/cygnus-pcm.c:477", esr_status1, audio_io + ESR1_STATUS_CLR_OFFSET);
	pete_writel("sound/soc/bcm/cygnus-pcm.c:478", esr_status3, audio_io + ESR3_STATUS_CLR_OFFSET);
	/* Rearm freemark logic by writing 1 to the correct bit */
	pete_writel("sound/soc/bcm/cygnus-pcm.c:480", esr_status3, audio_io + BF_REARM_FREE_MARK_OFFSET);
}
...
static void handle_capture_irq(struct cygnus_audio *cygaud)
{
	 ...
	 * should be serviced.
	 */
	esr_status2 = pete_readl("sound/soc/bcm/cygnus-pcm.c:503", audio_io + ESR2_STATUS_OFFSET);
	esr_status2 &= ~pete_readl("sound/soc/bcm/cygnus-pcm.c:504", audio_io + ESR2_MASK_STATUS_OFFSET);
	esr_status4 = pete_readl("sound/soc/bcm/cygnus-pcm.c:505", audio_io + ESR4_STATUS_OFFSET);
	esr_status4 &= ~pete_readl("sound/soc/bcm/cygnus-pcm.c:506", audio_io + ESR4_MASK_STATUS_OFFSET);
	...
	pete_writel("sound/soc/bcm/cygnus-pcm.c:530", esr_status2, audio_io + ESR2_STATUS_CLR_OFFSET);
	pete_writel("sound/soc/bcm/cygnus-pcm.c:531", esr_status4, audio_io + ESR4_STATUS_CLR_OFFSET);
	/* Rearm fullmark logic by writing 1 to the correct bit */
	pete_writel("sound/soc/bcm/cygnus-pcm.c:533", esr_status4, audio_io + BF_REARM_FULL_MARK_OFFSET);
}
...
static irqreturn_t cygnus_dma_irq(int irq, void *data)
{
	 ...
	 */
	r5_status = pete_readl("sound/soc/bcm/cygnus-pcm.c:549", cygaud->audio + INTH_R5F_STATUS_OFFSET);
	...
	if (ANY_PLAYBACK_IRQ & r5_status) {
		...
		pete_writel("sound/soc/bcm/cygnus-pcm.c:557", ANY_PLAYBACK_IRQ & r5_status,
	...
	if (ANY_CAPTURE_IRQ & r5_status) {
		...
		pete_writel("sound/soc/bcm/cygnus-pcm.c:564", ANY_CAPTURE_IRQ & r5_status,
			cygaud->audio + INTH_R5F_CLEAR_OFFSET);
	}
					    ...
					    struct snd_pcm_substream *substream)
{
	...
	p_rbuf = get_ringbuf(substream);
	if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK)
		cur = pete_readl("sound/soc/bcm/cygnus-pcm.c:678", aio->cygaud->audio + p_rbuf->rdaddr);
	else
		cur = pete_readl("sound/soc/bcm/cygnus-pcm.c:680", aio->cygaud->audio + p_rbuf->wraddr);

	base = pete_readl("sound/soc/bcm/cygnus-pcm.c:682", aio->cygaud->audio + p_rbuf->baseaddr);
