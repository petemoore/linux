...
static irqreturn_t spdif_in_irq(int irq, void *arg)
{
	...
	u32 irq_status = pete_readl("sound/soc/spear/spdif_in.c:183", host->io_base + SPDIF_IN_IRQ);
	...
	pete_writel("sound/soc/spear/spdif_in.c:197", 0, host->io_base + SPDIF_IN_IRQ);
